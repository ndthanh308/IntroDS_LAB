...
\bibitem [{\citenamefont {Tuniz}\ \emph {et~al.}(2023)\citenamefont {Tuniz},
  ...
  {F.}~\bibnamefont {Mazzola}},\ }\bibfield  {title} {\bibinfo {title}
  {Dynamics and resilience of the charge density wave in a bilayer kagome
  metal},\ }\bibfield  {journal} {\bibinfo  {journal} {arXiv 2302.10699}\
  }\href {https://doi.org/https://doi.org/10.48550/arXiv.2302.10699}
  {https://doi.org/10.48550/arXiv.2302.10699} (\bibinfo {year}
  {2023})\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Hu}\ \emph {et~al.}(2023{\natexlab{b}})\citenamefont
  ...
  }\bibfield  {title} {\bibinfo {title} {Phonon promoted charge density wave in
  topological kagome metal \text{ScV$_{6}$Sn$_{6}$}},\ }\href
  {https://doi.org/https://doi.org/10.48550/arXiv.2304.06431} {\bibfield
  {journal} {\bibinfo  {journal} {arXiv}\ ,\ \bibinfo {pages} {2304.06431}}
  (\bibinfo {year} {2023}{\natexlab{b}})}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Cao}\ \emph {et~al.}(2023)\citenamefont {Cao},
  ...
  \bibinfo {author} {\bibfnamefont {Y.}~\bibnamefont {Song}},\ }\bibfield
  {title} {\bibinfo {title} {Competing charge-density wave instabilities in the
  kagome metal \text{ScV$_6$Sn$_6$}},\ }\href
  {https://doi.org/https://doi.org/10.48550/arXiv.2304.08197} {\bibfield
  {journal} {\bibinfo  {journal} {arXiv}\ ,\ \bibinfo {pages} {2304.08197}}
