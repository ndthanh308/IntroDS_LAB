...
\end{align}
%
As the starting point of the calculation for $\sigma_{2}$
...
&\qquad + \frac{F\ud(0)}{2m\up}\Big{[}2\big{(}p^{\mu}\!\!\bk -(p \cdot k)\gamma^{\mu}\big{)}
-(\bk k^{\mu}-k\2\gamma^{\mu})\Big{]}
\bigg{\rbrace} \nn\\
&\qquad \times
(\bp+m\up)\,,\\
\nn\\
