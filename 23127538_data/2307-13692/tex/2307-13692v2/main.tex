...
We facilitate access to the dataset through API calls\footnote{The API can be accessed through the following: \href{https://arb.duckai.org/api/lib}{https://arb.duckai.org/api/lib}. The documentation can be found here: \href{https://app.swaggerhub.com/apis-docs/arb-dataset/arb-api/1.0.5}{https://app.swaggerhub.com/apis-docs/arb-dataset/arb-api/1.0.5}}. 
