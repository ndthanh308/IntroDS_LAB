...
After simplifying and considering marginals, we obtain \cref{thm: PG}. The detailed proof is in \cref{apx: PG}. This estimator assigns a higher weight to policies with high marginal gains and a lower weight to policies with low marginal gains. Our experiments show that this method performs well. 
