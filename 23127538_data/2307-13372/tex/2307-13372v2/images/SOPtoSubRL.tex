...
\draw (248,398) node [anchor=north west][inner sep=0.75pt]  [font=\Large] [align=left] {SOP};
% Text Node
\draw    (451,391) -- (525,391) -- (525,425) -- (451,425) -- cycle  ;
\draw (452,392) node [anchor=north west][inner sep=0.75pt]  [font=\Large] [align=left] {SubRL};
% Text Node
\draw    (461,514) -- (502,514) -- (502,559) -- (461,559) -- cycle  ;
\draw (462,515) node [anchor=north west][inner sep=0.75pt]  [font=\LARGE] [align=left] {$\displaystyle \pi $};
% Text Node
\draw    (257,512) -- (302,512) -- (302,557) -- (257,557) -- cycle  ;
\draw (258,513) node [anchor=north west][inner sep=0.75pt]  [font=\LARGE] [align=left] {$\displaystyle \tau '$};
% Text Node
...
% Text Node
\draw (180,555.98) node [anchor=north west][inner sep=0.75pt]  [font=\large,rotate=90] [align=left] {$\displaystyle \alpha \geq \Omega \left(\log^{1-\gamma } OPT\right)$};
% Text Node
