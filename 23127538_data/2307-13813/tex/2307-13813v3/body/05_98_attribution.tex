...
ResNetv2-50 reproduction (\Cref{tab:sup-r50-recipe}) and baseline momentum identification done by Jason Ramapuram.
...
\paragraph{Numerical stability analysis} Polyak-Ruppert experiment (\Cref{fig:numerics}) using linear regression for various floating point precisions done by Jason Ramapuram.
