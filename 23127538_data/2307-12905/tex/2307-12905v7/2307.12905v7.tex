...
since 
\begin{align}
	\langle m_{1},m_{2}|n_{1},n_{2}\rangle=\frac{1}{\pi^{2}}\int_{\mathbb{C}^{2}}\overline{f_{m_{1}m_{2}}}\; f_{n_{1}n_{2}} \; e^{-|z_{1}|^{2}-|z_{2}|^{2}}\; dz_{1} \; dz_{2}=  \delta_{m_{1},n_{1}} \delta_{m_{2},n_{2}}.
\end{align}
...
\begin{align}
{\bf M}(z_{1},z_{2})f(z_{1},z_{2})= a \;n \;f(z_{1},z_{2})+ d\; m\; f(z_{1},z_{2})\\ \nonumber+ b \;m \; \sum_{n,m=0}^{\infty} C_{nm} z_{1}^{n+1} z_{2}^{m-1} + c\; n \; \sum^{\infty}_{n,m=0} z_{1}^{n-1} z_{2}^{m+1}
\end{align} 
...
\begin{eqnarray}
X f(z_{1},z_{2})= \frac{z_{1}}{2\pi i} \oint_{\Gamma_{2}} \frac{f(z_{1},\xi_{2})}{(\xi_{2}-z_{2})^{2}} d\xi_{2}+\frac{z_{2}}{2\pi i} \oint_{\Gamma_{1}}\frac{f(\xi_{1},z_{2})}{(\xi_{1}-z_{1})^{2}} d\xi_{1}, 
\end{eqnarray}
...
Let $U$ be a non-empty open set in $\mathbb{C}^{d}$ and let $\mathcal{H}(U)$ denote the space of holomorphic functions on $U$. A complex-valued function $f: U\rightarrow \mathbb{C}$ is said to be holomorphic if it is differentiable in a neighborhood of each point in $U$.    Let $\mathcal{H}L^{2}(U,\omega)$ denotes the space of $L^{2}$-holomorphic functions with respect to the weight $\omega$, that is, 
	 ...
	 \end{eqnarray}
 Here $dz$ denotes the $2d$-dimensional Lebesgue measure on $\mathbb{C}^{d}=\mathbb{R}^{2d}$ not a line integral. Some examples of holomorphic function spaces  are the weighted Bergman  and the  Segal-Bargmann spaces \cite{Hall}. In this work, we used the Segal-Bargmann spaces .  \vskip 5mm
