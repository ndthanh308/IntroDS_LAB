...
\end{tabular}
\caption{The results of computing roots of $f_{\rm entire}(z)$ in extended precision, using the adaptive Algorithm~\ref{alg:adap_root} with the polynomial expansion order $n=60$ and $n=30$. }
