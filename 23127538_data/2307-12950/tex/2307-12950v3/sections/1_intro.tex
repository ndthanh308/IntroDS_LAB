...
Reinforcement Learning from Human Feedback (RLHF) has recently been used to great effect to align pretrained large language models (LLMs) toward desirable behaviors like harmlessness and helpfulness~\citep{bai2022training}, achieving state-of-the-art results on a variety of tasks~\citep{openai2023gpt4}. %RLHF approaches fundamentally rely on collecting pairs of LLM outputs $(o_1, o_2)$ from a shared prompt $p$, with a human indicating which output in each pair is better on a specified attribute.
...
Code and simulated preference data are available at \url{https://github.com/facebookresearch/rlcd}.
