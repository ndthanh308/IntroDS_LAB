...
\affiliation{Department of Physics, Engineering Physics, and Astronomy, Queen's University, Kingston, ON, K7N 3N6, Canada}
...
\end{equation}
\begin{equation}
    \rho_{Ein}(r) = \rho_s\, \textrm{exp}\left[-\frac{\alpha}{2}((r/r_s)^{\alpha} - 1)\right]\,.
\end{equation}
...
\begin{equation}
    \chi^2 = \sum_i \frac{(y_{i,fit} - y_i)^2}{\sigma_i^2} + \frac{(D_{fit} - D_{Al})^2}{\sigma_{Al}^2}\Theta(D_{fit} - D_{Al})\,,
\end{equation}
