...
\definecolor{darkgreen}{rgb}{0,0.7,0.3}


\newcommand{\note}[1]{{\color{magenta}\textbf{Comment by F.} #1}}
\newcommand{\todo}[1]{{\color{orange}\textbf{To be done by B.} #1}}
\newcommand{\question}[1]{{\color{red}\textbf{Question for F. and U.} #1}}
\newcommand{\commentB}[1]{{\color{darkgreen}\textbf{Comment by B.} #1}}
\newcommand{\commentU}[1]{{\color{cyan}\textbf{Comment by U.} #1}}
...
\author{\fnms{Umut} \snm{Simsekli}\ead[label=e2]{umut.simsekli@inria.fr}}
\and
\author{\fnms{Francis} \snm{Bach}\ead[label=e3]{francis.bach@inria.fr}}

\address{Inria, PSL Research University\\
2 Rue Simone Iff, Paris, France\\
\printead{e2,e3}}
\runauthor{B. Follain et al.}
