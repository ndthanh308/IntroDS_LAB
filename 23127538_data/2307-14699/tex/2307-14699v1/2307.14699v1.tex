...
Ume{\char229} University, 90736 Ume{\char229}, Sweden}
\email{adrian.llinares@umu.se}
...
\begin{equation}
 ...
 \label{ineq-final}
\end{equation}
In view of our initial assumption on $n$, the right-hand side of \eqref{ineq-final} tends to zero as $\e\to 0^+$. Without using any assumption on continuity of $w$, one can show by elementary calculus that
$$
