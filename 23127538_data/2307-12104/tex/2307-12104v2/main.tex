...
%\author{Nicholas Wu}
\author{Nicholas Wu\thanks{Department of Economics, Yale University, New Haven, CT 06511, nick.wu@yale.edu \\ I am deeply indebted to Johannes H\"orner for invaluable feedback and discussions. I also thank Dirk Bergemann, Mira Frick, Marina Halac, Ryota Iijima, Jonathan Libgober, Bart Lipman, Larry Samuelson, participants at the Yale microeconomic theory lunch seminar, and anonymous referees for helpful comments. All errors are my own. }}
...
In conclusion, this paper shows that very little information is necessary to restore inefficiencies in strategic experimentation. In particular, it is sufficient for sharing contracts to condition on winning/losing or effort at time of breakthrough (but it is not necessary to condition on both or more). 
