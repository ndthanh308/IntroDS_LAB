...
The number of vertices and edges may seem small, but each semantic graph consists of a large number of edges. For example, a two-hop metapath PVP in the DBLP dataset can generate a semantic graph with 20 million edges.
