...
\squishlist
  ...
  Compared to the state-of-the-art software framework running on NVIDIA GPU T4 and GPU A100, HiHGNN achieves an average 40.0$\times$ and 8.3$\times$ speedup as well as 99.59\% and 99.74\% energy reduction, respectively.
