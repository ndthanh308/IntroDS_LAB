...
\begin{document}
%
\title{Introducing CALMED: Multimodal Annotated Dataset for Emotion Detection in Children with Autism\thanks{Supported by organization x.}}
%
...
\email{zarrouk@sorbonne-paris-nord.fr}
\and
ASK - All Special Kids, Geneva, Switzerland\\
\email{\{jennifer.holloway\}@uni-heidelberg.de}}
%
