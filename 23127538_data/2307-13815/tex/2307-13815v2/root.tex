...
\author{\IEEEauthorblockN{Jiajun Zhang, Georgina Cosma\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\textit{Dept of Computer Science, School of Science} \\
\textit{Loughborough University, UK}\\
Email: j.zhang8@lboro.ac.uk; g.cosma@lboro.ac.uk\IEEEauthorrefmark{1}\\
...
The hardware requirements for running the \gls{FM} toolkit include at least 8 gigabytes of RAM and any Intel/AMD CPU; a GPU is not required.
