...
% First, they heavily rely on the quality of unit tests, which is hard to guarantee for non-contest datasets.
...
% Additionally, some works~\cite{coderl,coderl-2,ppocoder,rltf} leverage reinforcement learning techniques to align the model's behavior with humans. 
