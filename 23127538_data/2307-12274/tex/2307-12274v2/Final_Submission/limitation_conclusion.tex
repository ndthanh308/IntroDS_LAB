...
Despite the effectiveness, there are still some
works could be done in the future. For example, the hyperparameter $\delta$ in
Huber loss is
set empirically. It is preferred to automate the hyperparameter search.
