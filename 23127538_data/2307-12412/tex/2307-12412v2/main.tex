...
The authors would like to thank Antal J\'akli, Joseph Maclennan, Michail Osipov and Tommaso Bellini for fruitful discussions. N$_{\textrm{F}}$ and their electromechanical properties were also demonstrated by A. J\'akli at European Liquid Crystal Conference in Rende (Italy)~\cite{JakliECLC2023}.
...
\begin{botherref}
\oauthor{\bsnm{Wang}, \binits{M.-Y.}},
\oauthor{\bsnm{Zhang}, \binits{J.-P.}},
\oauthor{\bsnm{Chen}, \binits{S.-L.}},
\oauthor{\bsnm{Qi}, \binits{B.}},
\oauthor{\bsnm{Yao}, \binits{X.-Y.}},
\oauthor{\bsnm{Zhang}, \binits{X.-H.}},
\oauthor{\bsnm{Li}, \binits{Y.-T.}},
\oauthor{\bsnm{Yang}, \binits{Z.-H.}}:
...
%%% 18
\bibitem[\protect\citeauthoryear{Kamenskii and Kats}{1983}]{Kamenskii:1983uq}
\begin{barticle}
\bauthor{\bsnm{Kamenskii}, \binits{V.G.}},
...
\begin{barticle}
\bauthor{\bsnm{Tamba}, \binits{M.-G.}},
\bauthor{\bsnm{Salili}, \binits{S.M.}},
\bauthor{\bsnm{Zhang}, \binits{C.}},
\bauthor{\bsnm{J\'akli}, \binits{A.}},
\bauthor{\bsnm{Mehl}, \binits{G.H.}},
\bauthor{\bsnm{Stannarius}, \binits{R.}},
\bauthor{\bsnm{Eremin}, \binits{A.}}:
\batitle{{A fibre forming smectic twist-bent liquid crystalline phase}}.
\bjtitle{RSC Advances}
\bvolume{5},
\bfpage{11207}
(\byear{2015})
...
\batitle{{\"Uber anisotrope Fl\"ussigkeiten. Versuch einer Theorie der fl\"ussigen Kristalle und des elektrischen Kerr-Effekts in Fl\"ussigkeiten}}.
...
\begin{barticle}
\bauthor{\bsnm{Mandle}, \binits{R.J.}},
\bauthor{\bsnm{SebastiÃ¡n}, \binits{N.}},
...
%%% 35
\bibitem[\protect\citeauthoryear{Sebasti\'an et~al.}{2020}]{Sebastian.2020}
\begin{barticle}
\bauthor{\bsnm{Sebasti\'an}, \binits{N.}},
\bauthor{\bsnm{Cmok}, \binits{L.}},
\bauthor{\bsnm{Mandle}, \binits{R.J.}},
...
\bauthor{\bsnm{Nava}, \binits{G.}},
\bauthor{\bsnm{Barboza}, \binits{R.}},
\bauthor{\bsnm{Bellini}, \binits{T.G.}},
\bauthor{\bsnm{Lucchetti}, \binits{L.}}:
\batitle{{Walking Ferroelectric Liquid Droplets with Light}}.
\bjtitle{Advanced Materials}
\bvolume{35}(\bissue{22}),
\bfpage{2212067}
(\byear{2023})
...
\begin{barticle}
\bauthor{\bsnm{Folcia}, \binits{C.L.}},
\bauthor{\bsnm{Ortega}, \binits{J.}},
\bauthor{\bsnm{Vidal}, \binits{R.}},
\bauthor{\bsnm{Sierra}, \binits{T.}},
\bauthor{\bsnm{Etxebarria}, \binits{J.}}:
\batitle{{The ferroelectric nematic phase: an optimum liquid crystal candidate
...
\batitle{{Determination of SHG $d_{eff}$ by Maker fringes studies on
  unidirectional grown guanidinium chlorochromate single crystal for NLO device
  applications}}.
...
\batitle{{Precise estimation of nonlinear-optical coefficients for anisotropic
  nonlinear films with $C_{\infty V}$ symmetry}}.
...
%%% 52
\bibitem[\protect\citeauthoryear{Caimi et~al.}{2023}]{Caimi.2023t5j}
\begin{barticle}
\bauthor{\bsnm{Caimi}, \binits{F.}},
\bauthor{\bsnm{Nava}, \binits{G.}},
\bauthor{\bsnm{Fuschetto}, \binits{S.}},
\bauthor{\bsnm{Lucchetti}, \binits{L.}},
\bauthor{\bsnm{Pai\'e}, \binits{P.}},
\bauthor{\bsnm{Osellame}, \binits{R.}},
\bauthor{\bsnm{Chen}, \binits{X.}},
\bauthor{\bsnm{Clark}, \binits{N.A.}},
\bauthor{\bsnm{Glaser}, \binits{M.A.}},
\bauthor{\bsnm{Bellini}, \binits{T.}}:
\batitle{{Fluid superscreening and polarization following in confined
  ferroelectric nematics}}.
\bjtitle{Nature Physics}
\bvolume{19},
\bfpage{1658}--\blpage{1666}
(\byear{2023})
\doiurl{10.1038/s41567-023-02150-z}
\end{barticle}
\endbibitem
