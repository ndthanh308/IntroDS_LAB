...
\begin{abstract}
Observational studies are finding stars believed to be relics of the earliest stages of hierarchical mass assembly of the Galaxy. In this work, we contextualize these findings by studying the masses, ages, spatial distributions, morphology, kinematics, and chemical compositions of proto-galaxy populations from the 13 Milky Way (MW)-mass galaxies from the FIRE-2 cosmological zoom-in simulations. Our findings indicate that proto-Milky Way populations: \textit{i}) are predominantly centrally concentrated, with $\sim50\%$ of the stars contained within 5--10 kpc; \textit{ii}) on average show weak but systematic net rotation in the plane of the host's disc at $z=0$ (i.e., 0.25$\lesssim$$\langle$$\kappa$/$\kappa_{\mathrm{disc}}\rangle\lesssim0.8$); \textit{iii}) present [$\alpha$/Fe]-[Fe/H] compositions that overlap with the metal-poor tail of the host's old disc; \textit{iv}) tend to assemble slightly earlier in Local Group-like environments than in systems in isolation. Interestingly, we find that $\sim$60$\%$ of the proto-Milky Way galaxies are comprised by 1 dominant system (1/5$\lesssim$M$_{\star}$/M$_{\star,\mathrm{proto-Milky Way}}$$\lesssim$4/5) and 4--5 lower mass systems (M$_{\star}$/M$_{\star,\mathrm{proto-Milky Way}}$$\lesssim$1/10); the other $\sim$40$\%$ are comprised by 2 dominant systems and 3--4 lower mass systems. These massive/dominant proto-Milky Way fragments can be distinguished from the lower mass ones in chemical-kinematic samples, but appear (qualitatively) indistinguishable from one another. Our results suggest that large/rich chemical-kinematic-age samples of metal-poor stars in the inner Galaxy should help characterise the different mass fragments of the proto-Milky Way. These data may also help reveal if the Milky Way formed from one or two dominant systems.
\end{abstract}

 % Using the FIRE-2 simulations, we examine the masses, ages, spatial distributions, morphology, kinematics, and chemical compositions of proto-Milky Way (proto-Milky Way) populations. Overall, $\sim$60$\%$ of the proto-Milky Way galaxies are comprised by 1 dominant system (M$_{\star}$/M$_{\star,\mathrm{proto-Milky Way}}$$\gtrsim$1/5) and 4-5 lower mass systems (M$_{\star}$/M$_{\star,\mathrm{proto-Milky Way}}$$\lesssim$1/10); the other $\sim$40$\%$ are comprised by 2 dominant systems and 3-4 lower mass systems. These massive/dominant proto-Milky Way fragments can be distinguished from the lower mass ones in chemical-kinematic samples, but appear indistinguishable from one another. Our findings indicate that: \textit{i}) 50$\%$ of the stellar mass associated with a proto-Milky Way is confined to $r\lesssim$10 kpc, and 95$\%$ within $r\lesssim$40 kpc. These populations present (on average) an oblate profile; \textit{ii}) the majority of proto-Milky Way populations show weak but systematic net rotation in the plane of the host's disc at $z$=0 (i.e., $\kappa_{\mathrm{rot}}$/$\kappa_{\mathrm{tot}}\sim0.2$); \textit{iii}) proto-Milky Way populations present [$\alpha$/Fe]-[Fe/H] compositions that overlap with the metal-poor tail of the host's old disc; \textit{iv}) proto-Milky Way systems in Local Group-like environments tend to assemble slightly earlier than systems in isolation. Our results highlight that large/rich chemical-kinematic-age samples of stars in the inner Galaxy will help characterise the massive components of the proto-Milky Way from the lower mass ones, suggesting that it may be possible to unveil the earliest stages of formation of the Galaxy. These data may also help unveil if the Milky Way formed from one or two dominant systems.
...
\citet{Santistevan2020} set out to investigate the formation times and building blocks of Milky Way-mass galaxies in the FIRE-2 simulations, which is directly related to the formation of proto-Milky Way populations. In their work, the authors traced the origin of star particles formed at all times in different regions of the Milky Way-mass galaxies, and found that: $i$) Milky Way-mass galaxies typically assemble at $z \sim$3--4 (i.e., 11.6--12.2 Gyr ago); $ii$) Milky Way-mass galaxies at $z=0$ are formed typically from $\sim$100 building blocks with M$_{\star} \gtrsim 10^{5}$ M$_{\odot}$; Milky Way-mass galaxies in Local Group environments typically assemble earlier than those in isolation, highlighting the importance of environment.

% In order to try and address these fundamental questions, 
...
Furthermore, in order to track halos with a high enough number of star particles to be resolvable in \textit{Latte}/\textit{ELVIS}, we choose to only track systems with 150 star particles or more, using a similar technique to previous studies (e.g., \citealp{Necib2019,Panithanpaisal2021,Horta2023}). More specifically, we track the evolution of each system (i.e., the star particles) at every snapshot in the simulation over time until $t_{\mathrm{MR}_{3:1}}$ or until the system no longer exists (i.e., it has merged with the main branch system) using the \texttt{halo} catalogues, instead of resorting to the merger trees. This allows us to identify all the star particles in every halo, and to assign star particles to individual building blocks. Our choice to only track systems with 150 star particles or more leads to a minimum stellar mass of M$_{\star}$$\sim$1$\times$10$^{6}$M$_{\odot}$ for subhaloes in \textit{Latte}, and M$_{\star}$$\sim$5$\times$10$^{5}$M$_{\odot}$ for \textit{ELVIS}, given the slight differences in particle resolution between these two sets of simulations. For more information on the limitations of this choice, see Section~\ref{sec_limitations}. 

Lastly, in Fig~\ref{fig_summary_mass} we show the stellar mass ratio between every main branch (diamonds) and building block (circles) with the overall proto-Milky Way population as a function of the stellar mass of each main branch/building block. In this diagram, it is clear that there are two types of proto-Milky Way populations: 1) proto-Milky Way systems formed by one clearly dominant halo (namely, the main branch system. For example m12i). This is the case for $\sim$60$\%$ (8/13) of the Milky Way-mass haloes in our sample; 2) proto-Milky Way populations formed by two main systems (namely, the main branch and a massive building block ---$\gtrsim$1:5 mass ratio, see Fig~\ref{fig_summary_mass}---. For example, m12m). This is the case for $\sim$40$\%$ of our sample (5/13 galaxies). In the following sections we set out to study the chemical-kinematic properties of these systems at $z=0$ to see if the different systems that form proto-Milky Way populations can be distinguished.
...
We begin by examining the stellar mass and the minimum age of a star particle in each main branch and building block separately, shown in Fig~\ref{fig_agemass}. We choose to study the minimum age instead of the mean age as we believe that it is a better constraint for the time in which a system quenches star formation, and thus ceases to evolve. The questions we aim to answer are: \textit{How old are the systems that form a proto-Milky Way?} \textit{How massive are the main branch and building block systems that constitute a proto-Milky Way?}
...
When comparing the main branch populations (red) with their building block counterparts (blue), we see substantial differences in their stellar masses. Specifically, we find that main branch systems tend to be more massive, approximately two orders of magnitude larger (i.e., $\langle$M$_{\star,\mathrm{mb}}$$\rangle$ = 1$\times$10$^{9}$M$_{\odot}$ and $\langle$M$_{\star,\mathrm{bb}}$$\rangle$ = 1$\times$10$^{7}$M$_{\odot}$). However, we note that some building blocks do reach high stellar masses, on the order of M$_{\star}$$\sim$2$\times$10$^{9}$M$_{\odot}$, making the range in the distribution for building blocks much larger than for main branch debris. We see similar differences in the mean and spread of the minimum star particle age between main branch and building blocks debris as we did when comparing environment, on the order of $\sim$0.4 Gyr. 

In the left panel of Fig~\ref{fig_agemass} we show the distribution of minimum star particle age (i.e., the youngest) as a function of stellar mass for each event in each Milky Way-mass halo separately, where here we distinguish main branch populations (diamonds) and building blocks (circles). As can be seen from this illustration, there is a relation between the stellar mass of a system and the minimum star particle age, whereby a system's minimum stellar age decreases with increasing stellar mass. This is likely because those systems that are forming stars for longer are able to build up more mass (a similar argument as for the mass-metallicity relation of galaxies, see also Figure 3 of \citealp{Cunningham2022}). These results from this section are summarised in Table~\ref{tab:age-mass}.

In summary, when examining the stellar masses and minimum star particle ages (a proxy for quenching/accretion time) of the events that comprise proto-galaxy systems, we have found the following:
\begin{itemize}
    \item Overall, proto-Milky Way populations are largely formed from a range of different mass and age systems, but are predominantly comprised by one or two major systems of similar mass to the LMC (i.e., M$_{\star}$$\sim$1$\times$10$^{9}$M$_{\odot}$) and 3--5 smaller mass building blocks (i.e., M$_{\star}$$\sim$4$\times$10$^{7}$M$_{\odot}$), see Fig~\ref{fig_summary_mass} and Fig~\ref{fig_agemass} (see also Fig 4 in \citealp{Santistevan2020}). The massive systems typically arise from the main branch progenitor, and in the case where there are two dominant systems, also from a massive building block. We note that the number of building blocks we find are subject to our choice to only study systems of a minimum stellar mass of M$_{\star}$$\sim$1$\times$10$^{6}$M$_{\odot}$ for \textit{Latte}, and M$_{\star}$$\sim$5$\times$10$^{5}$M$_{\odot}$ for \textit{ELVIS}. \citet{Santistevan2020} showed that when lowering this limit to lower masses ($\sim$10$^{5}$ M$_{\odot}$) and looking at all subhalos that coalesce with the main branch before $z=0$, this number grows significantly to $\sim$100 building blocks.
    % Moreover, these proto-Milky Way populations are largely comprised by $\sim$3-5 systems with a stellar mass of approximately M$_{\star}$$\sim$4$\times$10$^{7}$M$_{\odot}$ and a minimum stellar age of age$_{\mathrm{min}}$$\sim$11.4 Gyr, and one or two dominant subhalos of mass $\sim$1$\times$10$^{9}$M$_{\odot}$ and similar minimum stellar age. 
 \item There is a small difference when comparing the mean values of haloes in pairs and in isolation. Here, pairs tend to be less massive (\textit{med}(M$_{\star}$) $\sim$ 8$\times$10$^{6}$) and older (\textit{med}(age$_{\mathrm{min}}$) $\sim$ 12 Gyr) than systems in isolation (\textit{med}(M$_{\star}$) $\sim$ 3$\times$10$^{7}$ and \textit{med}(age$_{\mathrm{min}}$) $\sim$ 11.5 Gyr). This is likely because systems in pairs assemble earlier \citep{Santistevan2020}.
    \item For this suite of simulations and given our definitions, we find a clear difference in the mean stellar mass value of main branch populations when compared to building blocks. More specifically, main branch populations are typically two orders of magnitude more massive ($\langle$M$_{\star,\mathrm{mb}}$$\rangle$$\sim$1$\times$10$^{9}$M$_{\odot}$) when compared to building blocks ($\langle$M$_{\star,\mathrm{bb}}$$\rangle$$\sim$1$\times$10$^{7}$M$_{\odot}$). Conversely, this difference is less pronounced in the mean values of the minimum star particle age when comparing main branch debris to their counterpart building blocks, showing only a difference of $\sim$0.4 Gyr.
\end{itemize}
...
As is to be expected, there is a range of spatial distributions for all the main branch and building block events. However, the majority of the mass from these systems is predominantly contained within $\sim$10 kpc from the centre of the host halo. This is especially the case when examining either main branch progenitors (dashed lines) and/or more massive building block debris (darker solid lines). For all Milky Way-mass galaxies the main branch system contains $\sim$50$\%$ of its mass within $\sim$10 kpc from the host's centre, and $\sim$95$\%$ within $\sim30-40$ kpc. For the case of the building blocks, the most massive events (M$_{\star}$$\gtrsim$5$\times$10$^{8}$ M$_{\odot}$) typically contain $\sim$50$\%$ of their mass within $\sim5-20$ kpc, and $\sim$95$\%$ of their mass within $\sim20-40$ kpc, in a similar fashion to the main branch population. This is especially the case for m12f, m12m, and Romulus, where the main branch progenitor follows a very similar spatial profile to the most massive building block in that system, making these almost indistinguishable spatially. For the lower mass building blocks (M$_{\star}$$\lesssim$5$\times$10$^{6}$ M$_{\odot}$), we see a wide range of profiles, ranging from $\sim10-50$ kpc for 50$\%$ of their enclosed mass and $\sim20-100$ kpc for 95$\%$ of their enclosed mass. We find a small difference in the spatial distribution of the debris of an event that occurs in a halo that is isolated versus a halo that is in a Local Group environment, whereby the latter tend to present proto-Milky Way populations more concentrated toward the host's centre. These results can be more easily digestible in Fig~\ref{fig_r50r95}, where we show histograms of $r_{50}$ and $r_{95}$ (i.e., the 50$^{th}$ and 95$^{th}$ percentiles of the spherical radii for each system), following the colour coding from Fig~\ref{fig_agemass}. 
...
In summary, our investigation into the spatial distribution and morphology of proto-Milky Way populations and early building blocks have led to the following results:

\begin{itemize}
    \item For all host haloes the main branch debris contain 50$\%$ of their mass within $\sim$10 kpc from the host's centre, and 95$\%$ within $\sim40-60$ kpc (Fig~\ref{radii} and Fig~\ref{fig_r50r95}). This is also the case for the most massive building blocks (M$_{\star}$$>$5$\times$10$^{8}$ M$_{\odot}$). Conversely, for lower mass building blocks, there is a wide range of spatial distributions. The value of 50$\%$ of the total mass can range from $\sim10$ kpc to $\sim100$ kpc. While there are differences in the spatial distribution of main branch debris and building block counterparts, at fixed mass distinguishing these is challenging.
    \item  There is a small difference in the spatial distribution of debris in isolated hosts and haloes in a Local Group-like environments, whereby pairs tend to present proto-Milky Way populations more concentrated towards the host's centre (Fig~\ref{fig_r50r95}). 
    \item There is a relation between an event's stellar mass and present day morphology, whereby more massive systems tend to be more oblate in shape when compared to lower mass counterparts. This is true for both main branch progenitors and massive building blocks. At lower mass, there is a larger spread in $\varepsilon$ values, indicating a wider range of possible present day morphologies, including more spherical distributions.
\end{itemize}
...
To quantify the amount of rotational support in each system, we compute the ratio of the rotational velocity over the total velocity for all star particles in a given population, $\kappa_{\mathrm{rot}}$/$\kappa_{\mathrm{tot}}$. These two velocity quantities are defined in the coordinate system centred on the host Milky Way-mass galaxy at $z=0$, and are computed by finding the centre of the Milky Way-mass host using its baryonic particles at that redshift. This can be estimated by taking the ratio of the kinetic energy in the rotational direction over the total kinetic energy \citep{McCarthy2012}, such that:
\begin{equation}
    \kappa_{\mathrm{rot}} = (L_z/R)^{2}/2, 
\end{equation}
assuming $R$ = $\sqrt{X^2+Y^2}$, $L_z = |\vec{R}\times \vec{v_{\phi}}|$, and
\begin{equation}
...
We find that the majority of the debris from both the main branch and building block systems have a mean $\kappa$/$\kappa_{\mathrm{disc}}$ value between 0.25 and 0.8, indicating not a strong amount of rotational support in the system when compared to the host's young disc. However, their rotational support is not 0, indicating that these systems are not in a purely isotropic distribution \citep{Santistevan2022,Yu2023}. In fact, their mean azimuthal velocities show that the majority of these systems have predominantly prograde orbits ($\langle v_{\phi}$$\rangle>$0 km/s). This means that they are rotating in the same direction as the disc, although at a much slower pace. Our results suggest that all these systems, either defined as main branch progenitor or building block, show weak but systematic net rotation in the plane of the host's disc at $z=0$ despite many of them appearing flattened/oblate in morphology (see Section~\ref{sec_spatial}).


To summarise, our results for the kinematic profiles reveal that:
\begin{itemize}
    \item Despite the range of morphologies, the majority of proto-Milky Way populations show weak but systematic net rotation in the plane of the host's disc at $z=0$ (i.e., 0.25$<$$\kappa$/$\kappa_{\mathrm{disc}}$$<$0.8). This indicates that proto-Milky Way systems are not in a purely isotropic distribution.
    \item The majority of proto-Milky Way populations have prograde orbits ($\langle v_{\phi}$$\rangle>$0).
    \item We find no dependence of the mean $\kappa$/$\kappa_{\mathrm{disc}}$ value of proto-Milky Way populations with environment (see the left panel of Fig~\ref{fig_vratio}).
\end{itemize}
...
% Overall, lower mass and/or older (and thus earlier quenched/accreted) events present a higher median [Mg/Fe] value at fixed [Fe/H] when compared to higher mass and/or younger populations. This is a result of the mass-metallicity relation of galaxies \citep{Kirby2013}, whereby systems that are able to form stars for a longer period and/or are forming stars faster (due to them being more massive) can enrich their populations more in metals (see for example, \citealp{Font2006,Cunningham2022,Horta2023}). Furthermore, an interesting result that emerges from Fig~\ref{alpha-fe} is that, on average, the debris from main branch progenitors are typically more enriched in metals than their building block counterparts. This is somewhat to be expected, as the main branch events are on average more massive and younger (see Section~\ref{sec_massage} and Fig~\ref{fig_agemass}), so they are able to form more stars and for a longer period, enriching their ISM with more metals. However, we do find that there are some more massive and/or younger building blocks that occupy a similar distribution to the main branch debris. This result is bitter-sweet, as on the one hand we find that on average there is a clear distinction in the [Mg/Fe]-[Fe/H] compositions of main branch systems when compared to building block events. On the other, however, our results show that it would be difficult (if not impossible) to distinguish the debris from a main branch progenitors from massive (and young) building block debris if both systems were to occur in the same host halo (which is the case for roughly $\sim$40$\%$ of our Milky Way-mass galaxy sample).

Fig~\ref{alpha-fe} demonstrates that, on average, the main branches are more metal-rich than the building blocks. This is a natural consequence of the mass-metallicity relation (\citealp[e.g.,][]{Kirby2013,Kirby2020}). This fact could be leveraged to disentangle the lower mass building blocks from their main branches using their abundances (e.g., employing methods presented in \citealt{Cunningham2022}, \citealt{Horta2023_abun}, \citealt{Deason2023}, for example). However, some of the more massive building blocks have chemical compositions consistent with the main branches. As a result, it could be challenging to disentangle populations from the main branch from populations from the most massive building block when a proto-Milky Way has two significant contributors (which is the case for roughly $\sim$40$\%$ of our Milky Way-mass galaxy sample). We investigate this further in Fig~\ref{mdf}, in which we compare the metallicity distribution functions (MDFs) for the main branch (dashed) and most massive building block (solid) in both m12f (black) and m12m (red). In the case of m12f, the mean of the main branch MDF is $\sim$0.1--0.2 dex higher compared to the most massive building block. Conversely, the main progenitor in m12m is identical in [Fe/H] when compared to its massive building block counterpart. These results show that, quantitatively, it would be extremely difficult to distinguish massive building blocks from their main branch system counterparts using their MDFs.
...
% Given our intriguing finding that massive building blocks appear, at face value, qualitatively indistinguishable in Fig~\ref{alpha-fe} from the main branch progenitors, we now set out to investigate the metallicity distribution functions (MDF) of some case examples. The aim of this test is to discern if any possible differences in the, mean, width, or skewness of the MDFs can be seen. To do so, we use two of the simulations that have a building block of similar mass to the main branch (namely, m12f and m12m). Fig~\ref{mdf} shows the MDF distribution for the main branch progenitor (dashed) and building block (solid) for m12f (black) and m12m (red). As can be seen from the MDF profiles by eye, the distribution of the main branch system and its massive building block counterpart are quantitatively similar. For m12f, we find a small difference between the main progenitor and its similar (stellar) mass building block, on the order of $\sim$0.1--0.2 dex. Conversely, the main progenitor in m12m appears indistinguishable in [Fe/H] when compared to its massive building block counterpart. These results show that, quantitatively, it would be extremely difficult to distinguish massive building blocks from their main branch system counterparts using their MDFs. 
...
In summary, our findings on the chemical properties of main branch and building block events can be summarised as follows:
\begin{itemize}
\item On average, the [Mg/Fe]-[Fe/H] distribution of main branch and building block events shows a strong dependence on the debris mass and age. On average, the main branch systems tend to show more enriched [Mg/Fe]-[Fe/H] chemistry than the majority of their building block counterparts. Here, main branch progenitors either have a higher [Mg/Fe] value at fixed [Fe/H], or higher [Fe/H] overall. However, we find that this is also the case for the most massive (and youngest) building blocks. As a result, it is difficult to distinguish, qualitatively, these two types of populations based on the average [$\alpha$/Fe]-[Fe/H] abundances alone. More detailed chemical abundance information from elemental species synthesised in more exotic nucleosynthetic channels, which we have not been able to examine in this work (but see \citealp{Horta2023_abun}), may hold the clues to disentangling these dominant proto-Milky Way fragments.
    % \item On average, the [Mg/Fe]-[Fe/H] distribution of main branch and building block events shows a strong dependence on the debris mass and/or age. This is a natural consequence of the mass-metallicity relation of galaxies, whereby systems that are more massive and/or form for a longer period are able to enrich their ISM with more metals, and thus their stellar populations will become more enriched. These findings go hand in hand with other results (\citealp{Font2006,Johnston2008,Kirby2013,Lee2013,Kirby2020,Cunningham2022,Deason2023,Horta2023}).
    % \item Bitter-sweetly, we find that on average the main branch systems tend to show more enriched [Mg/Fe]-[Fe/H] chemistry than the majority of their building block counterparts. Here, main branch progenitors either have a higher [Mg/Fe] value at fixed [Fe/H], or higher [Fe/H] overall. However, we find that this is also the case for the most massive (and youngest) building blocks, making it difficult to be able to distinguish, qualitatively, these two types of populations based on the average [$\alpha$/Fe]-[Fe/H] abundances alone. To try and resolve this conundrum, in Fig~\ref{mdf} we have examined the metallicity distribution function of two example cases where the (stellar) mass ratio between the main branch progenitor and the most massive building block in that simulation is small (namely, m12f and m12m). In doing so, we have found that there are no quantitative differences in the chemical abundance distribution between these two systems. This result highlights that with [Fe/H] alone, it would be extremely difficult to distinguish stellar populations from main branch systems and massive building block events in galaxies hosting both of these systems. However, as recently shown in \citet{Deason2023}, it is possible to use [Fe/H] as a diagnostic to distinguish massive building blocks from the less massive ones. This is also the case in [$\alpha$/Fe]-[Fe/H] space (Fig~\ref{alpha-fe}, but also \citealp[e.g.,][]{Font2006,Johnston2008,Cunningham2022,Horta2023}). Along those lines, more detailed chemical abundance information from elemental species synthesised in more exotic nucleosynthetic channels, which we have not been able to examine in this work (but see \citealp{Lee2013,Horta2023_abun}), may hold the clues to disentangling these dominant proto-Milky Way fragments.
\end{itemize}
...
\label{discussion_massrats}

In this work, we have defined a proto-Milky Way to be comprised by a main branch and building blocks systems (Table~\ref{tab0} and Fig~\ref{formdist}). Given our definitions, our findings suggest that on average the proto-galaxy of a Milky Way-mass halo is comprised of five to six systems with M$_{\star}\gtrsim5\time10^{5}$M$_{\odot}$. \footnote{However, these results are subject to our choice to only study systems with 150 star particles. If one was to lower this mass limit and was to look at all systems that coalesce with the main branch before $z=0$ \citep[e.g.,][]{Santistevan2020}, this number grows significantly, up to $\sim$100 building blocks.}. Although likely insignificant, it is worth noticing that the average number of systems that form a proto-Milky Way is smaller in the Local Group Milky Way-mass galaxy simulations (5) when compared to the isolated haloes (6). This is likely because, as found in Fig~\ref{fig_agemass}, Milky Way-mass galaxies in Local Group environments assemble earlier than those in isolation \citep{Santistevan2020}. 

Given this finding, it is interesting to ask \textit{what fraction of the proto-galaxy's (stellar) mass is contributed by the main branch/building block progenitors?} To answer this question, in Fig~\ref{mass-ratios} we show the mass difference between each main branch progenitor and its counterpart building blocks as a function of the mass of the main branch progenitor. We find that the majority of the building blocks are of lower mass when compared to the main branch progenitor, on the order of one to four orders of magnitude difference, with a stellar mass ranging between $\gtrsim$ 5$\times$10$^{5}$$<$M$_{\star}$$<$1$\times$10$^{8}$ M$_{\odot}$ (see also Fig~\ref{fig_summary_mass}). This is clearly the case for eight out of the thirteen Milky Way-mass haloes (namely, m12b, m12i, m12r, Remus, Thelma, Louise, Romeo, and Juliet), and would indicate that the majority of these proto-Milky Way systems are comprised by one dominant progenitor and several ($\sim4-5$) smaller mass building blocks. Conversely, for the other five proto-Milky Way systems, we find that there is at least one building block that has a mass ratio with the main branch progenitor that is within one order of magnitude (i.e., has a stellar mass greater than $\sim$5$\times$10$^{8}$ M$_{\odot}$). For these haloes (namely m12c, m12f, m12m, m12w, and Romulus), the proto-Milky Way is formed by two dominant systems, and a smaller number ($\sim3-4$) of lower mass building blocks. This result is interesting, as it suggests that proto-galaxy systems in Milky Way-mass galaxies can be formed by either one or two main subhalos at high redshift, in addition to a small number of lower mass building blocks. We find that the mass ratios between main progenitor branches and building blocks does not show a correlation with either the main branch progenitor's stellar mass or environment.

\subsection{When does a proto-Milky Way form?}

Table~\ref{tab1} shows that there is a range of times in which a proto-Milky Way forms, given our definition of when a proto-Milky Way emerges (see Section~\ref{sec_proto_bbs}). These values range from as late as $t_{\mathrm{MR_{3:1}}}$ = 8.05 Gyr ($z$=1.02) to as early as $t_{\mathrm{MR_{3:1}}}$ = 12.9 Gyr ($z$=6.08). We find that overall the proto-Milky Way systems can be grouped into three main camps: an early forming group, an intermediate forming group, a late forming one. In the early forming group we see m12f, m12i, m12w, Thelma, Louise, Romeo, and Juliet, which all reveal a value of $t_{\mathrm{MR_{3:1}}}$ $\gtrsim$ 11.5 Gyr ($z$ $\gtrsim$ 2.8). In the intermediate age forming group we see  m12m, and Romulus, that have 10 $\lesssim$ $t_{\mathrm{MR_{3:1}}}$ $\lesssim$ 11.5 Gyr (1.7 $\lesssim$ $z$ $\lesssim$ 2.8). In the late forming group, we see m12b, m12c, m12r, and Remus, which all show 8 $\lesssim$ $t_{\mathrm{MR_{3:1}}}$ $\lesssim$ 10 Gyr ($z$ $\lesssim$ 1.7). It is interesting to note that the members of the intermediate group (namely, m12m, and Romulus) are the majority of the haloes that have the smallest mass fraction between the main progenitor branch and the most massive building block (see Fig~\ref{mass-ratios}). The difference in formation times of these Milky Way-mass galaxies has also been divided into three similar groups based on the time in which their stellar discs settle \citep{McCluskey2023}, and based on the transition from spheroids to thick and thin discs \citep{Yu2023}.

These results are consistent with the results from \citet{Santistevan2020}) when they use the same definition as used here ($t_{\mathrm{MR_{3:1}}}$); for the emergence of the Milky Way (though we note that they find that Milky Way-mass galaxies emerge around $z\sim$3--4 when using a definition based on in-situ star formation).
...
When comparing the properties of systems in isolation and in pairs, we have found a few subtle differences. For example, the median stellar mass per event is lower for systems in pairs ($\sim$8$\times$10$^{6}$ M$_{\odot}$) when compared to isolated ($\sim$3$\times$10$^{7}$ M$_{\odot}$). Similarly, the minimum star particle age is $\sim$12 Gyr for pairs, and $\sim$11.5 for isolated haloes. This implies that systems in Local Group environments assemble more rapidly and from lower mass events when compared to systems in isolation, as pointed out in previous work (\citealp{Santistevan2020}).

% \citet{Santistevan2020} already tackled this question in great detail using the same simulations as in this work. Their findings suggested that Milky Way-mass galaxies tend to assemble earlier in Local Group-like environments when compared to isolation, highlighting the dependence on environment. This result is in line with our findings from Fig~\ref{fig_agemass}, where we find that the proto-galaxy populations in pairs tend to have an older minimum star particle age than the isolated counterparts (although this difference is subtle, $\sim$11.9 Gyr in contrast to our finding of $\sim$10.7 Gyr). This would imply that systems in pairs tend to assemble earlier.

% Moreover, albeit \citet{Santistevan2020} state a slightly older time ($\sim$11.8-12 Gyr) for the emergence of the main progenitor (i.e., defined here as $t_{\mathrm{MR}_{3:1}}$) than what we find ($\sim$10.7 Gyr), when comparing our values from Table~\ref{tab1} with the $z_{\mathrm{MR,15}}$ values reported in thier work, we find that our results are consistent. 

% Along those lines, when posing the question of how many fragments build-up a Milky Way-ancestor galaxy, we found that on average that number ranges from $\sim$5-6. However, in this work we have only tracked those luminous subhaloes with 150 star particles or more (corresponding to a stellar mass of M$_{\star}$$\sim$
% 1$\times$10$^{6}$M$_{\odot}$ for \textit{Latte}, and M$_{\star}$$\sim$
% 5$\times$10$^{5}$M$_{\odot}$ for \textit{ELVIS}). It is very likely that many more lower-mass building blocks contributed to the build up of these Milky Way-ancestor galaxies. This discrepancy in part explains the differences found in this work with the ones presented in \citet{Santistevan2020}, and is in line with results from other cosmological simulations (). 

% One particularly interesting result from our analysis is that the average stellar mass of an event that goes on to form a Milky Way-ancestor is M$_{\star}$$\sim$4$\times$10$^{7}$M$_{\odot}$, and its minimum star particle age is $\sim$11.4 Gyr. This result implies that the majority of blocks that coalesce at early times to form a Milky Way-ancestor
% system should be small and old, in corcondance with expectations from $\Lambda$-CDM (e.g., ). However, the more massive blocks (primarily the proto-galaxy clumps, but also some massive building blocks) are the ones that dominate in mass, as seen before in cosmological simulations () and observations of the stellar halo of the Milky Way (\citealp{Deason2015}). 

In terms of the spatial, kinematic, and chemical properties, we have found subtle differences with environment. For example, the radial distribution for 50$\%$ of the mass for systems in pairs is more centrally concentrated towards the host's centre than systems in isolation (see Fig~\ref{fig_r50r95}). Another example is that we found that systems in pairs tend to present more enriched [$\alpha$/Fe] and/ or [Fe/H] values than systems in isolation (Fig~\ref{alpha-fe}). 

% Of particular interest, we find that the average stellar mass of an event that goes on to form a Milky Way-ancestor is M$_{\star}$$\sim$4$\times$10$^{7}$M$_{\odot}$. The average minimum stellar age is $\sim$11.4 Gyr. 
% \subsection{Are stellar haloes really dual in nature?}

% Early work suggested a picture where the Milky Way's stellar halo is dual in nature, whereby the inner $\sim$20-30 kpc regions are primarily the result of in situ formation and the outer regions are comprised from the debris of lower-mass accreted satellite galaxies \citep{Chiba2000,Carollo2007,Font2011}. Globally, this hypothesis has been largely accepted both in observations and simulations, largely due to the data of that time. However, new observational data and better cosmological simulations (with better tools for the identification and tracking of haloes) are beginning to poke holes in this scenario. Here, we discuss how our findings rule out the idea of a dual nature of stellar haloes in Milky Way-mass galaxies. 


\subsection{Is it possible to distinguish the different systems that form a proto-Milky Way from one another?}

% Figure environment removed

The main aim of this work was to identify the different systems that comprise proto-Milky Way populations and to compare their observable properties. Specifically, we have examined their masses, ages, spatial distribution, morphology, kinematics, and chemical abundances. In this section, we summarise these findings and put them in context with the latest work. 


In terms of the mass and age, in Section~\ref{sec_massage} we show that overall there are clear differences between the average main branch progenitor and their counterpart building block populations. Main branch systems tend to be two orders of magnitude more massive in stellar mass ($\langle$M$_{\star,\mathrm{mb}}$$\rangle$$\sim$1$\times$10$^{9}$M$_{\odot}$ vs $\langle$M$_{\star,\mathrm{bb}}$$\rangle$$\sim$1$\times$10$^{7}$M$_{\odot}$). However, there is no clear difference between their respective minimum star particle age (i.e., quenching time) distributions. Although the mean values of stellar mass differ between main branch and building block systems overall, for five out of the thirteen Milky Way-mass haloes ($\sim$40$\%$), the mass ratio between the main branch progenitor and the most massive building block is below one order of magnitude (see Section~\ref{discussion_massrats} and Fig~\ref{mass-ratios}). In these cases, the massive building block population contributes between $\sim$1/3 to $\sim$1/5 of the proto-Milky Way stellar mass (see Fig~\ref{fig_summary_mass}). \footnote{We recall that the maximum mass ratio between a building block and a main branch system is limited by our definition of when a proto-Milky Way forms ($t_{\mathrm{MR}_{3:1}}$, see Table~\ref{tab0}), so it is possible that building blocks can reach an even higher mass ratios.}. This implies that for over a third of the Milky Way-mass galaxies, it is two systems that dominate the mass of the resulting proto-Milky Way population. This finding highlights a possible dichotomy in the formation of proto-Milky Way systems. On the one hand, a proto-Milky Way can form from one dominant main branch progenitor plus a handful of additional lower mass building blocks. On the other, a proto-Milky Way can form from two main haloes (i.e., the main branch and a massive building block) and 3--4 lower mass building blocks. 

In Section~\ref{sec_spatial} we set out to examine the radial profiles of main branch progenitors and building blocks (see Fig~\ref{radii} and Fig~\ref{fig_r50r95}). Our results showed that the majority of the mass (95$\%$) of main branch systems is contained within 40--60 kpc from the host's centre at present day, and 50$\%$ of this mass is within $\sim5-10$ kpc. On the other hand, building blocks show wider variety, ranging from 5--50 kpc for $\sim50\%$ of their mass. However, we do note that for the most massive building blocks (M$_{\star}$$\gtrsim$5$\times$10$^{8}$M$_{\odot}$), the spatial distribution is largely similar to the main branch progenitors, especially in the case of m12f, m12m, and Romulus. This result suggests that the innermost regions of the Milky Way-mass galaxies is where you would expect to find the oldest populations in the Galaxy (\citealp{Badry2018,Fragkoudi2020}) that comprise the proto-Milky Way, arising from both a main branch progenitor and (possibly) the most massive building blocks (\citealp{Horta2021,Rix2022}). Due to the strong spatial overlap between main branch systems and massive building blocks, it would be difficult to distinguish these based on spatial distribution information alone. Along those lines, we also found that it would be difficult to distinguish these systems based on their morphology (Fig~\ref{shape_mass}), as we found both main branch systems and massive building blocks to have a similar oblate shape for a given stellar mass. However, distinguishing the dominant fragments of proto-Milky Way systems from their lower mass counterparts, based on their spatial distribution and morphology profiles of full samples, in principle could be possible.

We also set out to examine the kinematics of main branch progenitors and building blocks in Section~\ref{sec_kinematics}. Here, we attempted to see if there were any signatures of rotation in this population (Fig~\ref{fig_vratio}), and to assess if there is a preference for prograde or retrograde orbits. Our results show that both main branch progenitors and building block systems show weak but systematic net rotation in the plane of the host's disc at $z=0$ (i.e., 0.25$\lesssim$$\langle$$\kappa/\kappa_{\mathrm{disc}}$$\rangle$$\lesssim$0.8). This indicates that their distribution is not purely isotropic. Moreover, we also found that the majority of the populations rotate on prograde orbits ($v_{\phi}>0$ km/s). It is important to note that recent studies have reported that Milky Way-mass galaxies in FIRE experience different phases of growth (\citealp{Yu2021,Gurvich2023,Hopkins2023,McCluskey2023,Semenov2023,Yu2023}), which can be characterised based on differences in their stellar kinematics and amount of rotational support. \citet{Yu2023} find that the orbits of star particles formed in the main branch spheroid at early times are more radial than those formed at later times in a more settled disc (see also \citealp{Gurvich2023} and \citealp{McCluskey2023}). This result is related to our finding, and suggests that populations formed at early times are likely to not be on as rotationally supported orbits when compared to populations formed later in settled discs. 


% Conversely, when examining their velocity anisotropy values, we find that main branch debris tend to be on more circular orbits when compared to lower mass building blocks, which typically show radial orbits. However, as noted earlier, the more massive building blocks can also adopt a similar value as the main branch debris, adopting values of $\langle$$\beta$$\rangle$$\lesssim$0. This result is interesting, and suggests that, while there is no strong signature of rotation in main branch systems w.r.t. the disc of the host Milky Way-mass galaxy at $z=$0, the orbits in these events can be circular in another plane. This signature may be useful for picking out lower mass building blocks from the main branch progenitors and/or massive building blocks. However, anisotropy is not a strong diagnostic for separating main branch progenitors from massive building blocks.

Lastly, in Section~\ref{sec_chemistry} we set out to compare the chemical compositions. Fig~\ref{alpha-fe} shows the median [Mg/Fe]-[Fe/H] values for main branch progenitors and building blocks. Overall, we find a similar result as when examining the spatial and kinematic properties. On average, main branch progenitors present a more enriched [Mg/Fe]-[Fe/H] value, either in the form of more [Fe/H] overall or a higher [Mg/Fe] ratio for fixed [Fe/H], when compared to the bulk of building block populations. As argued in previous studies (\citealp[e.g.,][]{Cunningham2022,Horta2023}), this is caused by the effect of the mass-metallicity relation of galaxies. More massive systems that are able to form stars for longer enrich their interstellar medium with more metals and evolve chemically faster than lower mass systems that quench star formation earlier \citep{Kirby2013}. This is the reason why the bulk of the main branch systems (that are more massive and evolve for longer) sit towards the metal-rich end of Fig~\ref{alpha-fe} when compared to lower mass building blocks. However, as discussed at the end of Section~\ref{sec_chemistry}, the more massive building blocks resemble qualitatively main branch progenitors in the [Mg/Fe]-[Fe/H] plane. To further analyse these specific cases, we took two case examples (m12f and m12m) where the most massive building block is of similar mass to the main branch progenitor (see Fig~\ref{mass-ratios}) and examined their metallicity distribution functions (MDF; Fig~\ref{mdf}). In doing so, we found a similar result. We find that their MDF profiles are qualitatively, and quantitatively, similar. This result stresses how difficult it is to distinguish, on the basis of [Fe/H] information alone, main branch populations from its corresponding massive building block counterparts. However, distinguishing the dominant fragments from lower mass ones is likely possible \citep{Deason2023}. 

In summary, our results reveal that it is likely possible to distinguish smaller mass building blocks from the more massive main branch progenitor systems in chemical-kinematic samples. However, when attempting to distinguish main branch progenitors from the more massive building blocks, this task will likely result rather complicated, as they appear indistinguishable in almost every chemical and kinematic plane studied. Despite this challenging task, we argue that obtaining detailed elemental abundance ratios for a wide spectrum of elements (probing different nucleosynthetic channels) for large samples of metal-poor stars in the inner Galactic regions of the Milky Way may result profitable \citep[e.g.,][]{kollmeier2017sdssv}, as it is likely that these stellar tags are the only possible diagnostic to distinguish such populations. 
...
Given all our findings, we now provide a list of ideas/pointers we suggest one to follow if aiming to identify the majority of the populations belonging to the proto-Milky Way:\\
    ...
    \textit{i}) \textit{Mass and age}: we suggest that the best possible way to find the proto-Galaxy in the Milky Way would be to identify stellar populations older than $\tau$$\gtrsim$10 Gyr, that amount to a mass smaller than M$_{\star}$$\lesssim$10$^{9}$--10$^{10}$M$_{\odot}$.\\
...
\begin{itemize}
    ...
    \item \textbf{What shape do debris from the proto-Milky Way have?} Although different main branch/building blocks adopt a range of morphologies, the dominant components of proto-Milky Way systems adopt an oblate shape ($\varepsilon$$\sim$0.7, see Fig~\ref{shape_mass}).
    ...
    % , but on more circular orbits. However, smaller mass contributors to proto-Milky Way systems can adopt radial orbits.
...
\appendix
% \section{Vertical distribution of proto-galaxy components}
% We repeat the illustration from Fig~\ref{radii} in Fig~\ref{vheight}, but now examine the vertical height distribution (i.e., the distance from the plane of the disc of the host galaxy defined at $z$=0) for every event. As seen for the radii, the majority of the star particles belonging to main branch progenitors and/or higher mass building block debris are contained within a small range of vertical heights. Specifically, we find that building blocks with a mass of M$_{\star}$$\gtrsim$5$\times$10$^{8}$ M$_{\odot}$, as well as the main branch debris, deposit $\sim$90$\%$ of their stellar mass within just a few kpc from the midplane. This leads to the conclusion that these systems are tightly concentrated towards the innermost regions of their respective hosts, and that the majority of their mass is contained within a volume with radius of $\sim$5-8 kpc. Conversely, we find that the lower mass building blocks (M$_{\star}$$\lesssim$5$\times$10$^{6}$ M$_{\odot}$) range in their vertical distribution, but typically occupy a distribution with much greater vertical height of the plane. This can range anywhere from 20-70 kpc for $\sim$50$\%$ of their stellar mass. As before, we find no difference on the vertical distribution of the debris of an event that occurs in a halo that is isolated versus a halo that is in a Local Group environment. 
% % Figure environment removed
