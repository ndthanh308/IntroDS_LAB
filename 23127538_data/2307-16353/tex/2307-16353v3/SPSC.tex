...
\newtheorem{GREG}{\textit{Regularity Condition}}
...
\newcommand{\bsY}{\bm{\mathcal{Y}}}
\newcommand{\bsL}{\bm{\mathcal{L}}}
...
\title{\vspace*{-1cm}Single Proxy Synthetic Control}
 \author{
  Chan Park$^{1}$ and Eric J. Tchetgen Tchetgen$^{2}$ 
  \\[0.2cm]
  {\small 1: Department of Statistics, University of Illinois, Urbana-Champaign}\\
  {\small 2: Department of Statistics and Data Science, The Wharton School, University of Pennsylvania}\\
    }
 \date{}
  \maketitle
\begin{abstract}
