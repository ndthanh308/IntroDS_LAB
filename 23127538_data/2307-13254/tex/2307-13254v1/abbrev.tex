...
\newcommand{\contourorgange}[1]{%
  \contour{orange}{#1}%
}

\newcommand{\contourgreen}[1]{%
  \contour{green}{#1}%
}
...
\newcommand{\fig}[2][1]{% Figure removed}
\newcommand{\figh}[2][1]{% Figure removed}
...
\hypersetup{
    colorlinks=true,
    linkcolor=black,   % 참조된 페이지와의 링크 색상을 검은색으로 설정
    citecolor=black,   % 인용문과의 링크 색상을 검은색으로 설정
    urlcolor=black,    % URL과의 링크 색상을 검은색으로 설정
}
