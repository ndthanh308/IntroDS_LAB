...
For the knot components $k_i\, (i=1,2,\dots,n)$ of $k$, the band surgery operation $k\to k'$ induces the band surgery operation $k_i\to k'_i$ for all $i$. If the link $k'_i$ is a knot for all $i$, then 
...
assume that a band sum $o'=k\#_b o$ of $k$ and a trivial link $o$ is a trivial knot in ${\mathbf R}^3$. 
...
Then the link $k$ is a ribbon knot in ${\mathbf R}^3$. 
...
The link $k'$ is a ribbon link with components $k'_i\, (i=1,2,\dots,n)$, there is a fusion $o'\to k'$ with a trivial link $o'$ consisting of 
...
The link $k$ is a fusion of the trivial link consisting of the split sum of $o'_i, \,(i=,2,3,\dots,n);\, o''_i\, (i=1,2,\dots,n)$, meaning that the knot $k$ is a ribbon link.
...
\noindent{\bf Proof of Corollary~2.3.} For the knot components $k_i\, (i=1,2,\dots,r)$ of $k$, the band sum $k'=k\#_b o$ is the union of band sums $k'_i=k_i\#_b o_i\, (i=1,2,\dots,r)$ for each of which 
the proof of Lemma~2.3 can be applied although a band used for the band sum $k'_i=k_i\#_b o_i$ 
may pass through the other loop system $o\setminus o_i$. Thus, the link $k$ is a ribbon link. 
...
where $k_3 \to k_2\cup o$ is a fission, $k_2\cup o\to k_1\cup o$ is a genus addition fixing $o$ and $k_1\cup o\to k+o$ is a fission fixing $o$. 
...
Since the bands used for the fission $k_3 \to k_2\cup o$ cut the bands of the fusion $k_2 \cup o \to k_3$, the genus addition 
$k_2\cup o\to k_1\cup o$ changes into a genus addition 
$k_2+o\to k'_1+o$ fixing $o$ for a new link $k'_1$ and the fission 
$k_1 \cup o \to k+o$ changes into a fission 
$k'_1 + o \to k+o$ fixing $o$, respectively. 
Note that the link $k'_1$ has the same number of components as $k_1$. 
Then the sequence 
\[ k +o \to k_1\cup o \to k_2 \cup o \to k_3\]
changes a sequence 
\[ k +o \to k'_1+ o \to k_2 + o \to k_3,\]
where 
the operation $k+o \to k'_1+ o$ is a fusion fixing $o$ with $k'_1$ a link of 
$r$ components, the operation 
$k'_1+o \to k_2 + o$ is a genus addition fixing $o$, 
and the operation $k'_2 + o \to k_3$ is a fusion meaning that $k_3$ is a bund sum $k'_2\#_b o$ of $k'_2$ and $o$. Since $k_3$ is a ribbon link, $k'_2$ is a ribbon link by Lemma~2.3. Thus, there is a sequence 
a sequence 
\[ k \to k'_1 \to k_2 \to o'_3,\]
where the operation $k \to k'_1$ is a fusion with $k'_1$ a link of 
$r$ components, the operation 
$k'_1 \to k'_2 $ is a genus addition 
and the operation $k'_2 \to o'_3$ is a fission with $o'_3$ a trivial link. 
...
This work was partly supported by JSPS KAKENHI Grant Numbers JP19H01788, JP21H00978 and 
Osaka Central Advanced Mathematical Institute, Osaka Metropolitan University (MEXT Joint Usage/ Research Center on Mathematics and Theoretical 
Physics JPMXP 0619217849). 
