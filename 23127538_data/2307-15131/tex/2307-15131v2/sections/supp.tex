...
\section{Teacher Model Output \textit{v.s} Local Pertaining in Fast Preview}

Local pretraining is proposed for the fast preview. Using the teacher model output for preview could be a bottleneck of speed during preview, giving a rendering speed of only 1-2 FPS when the editing space is very large and the sampling-computing-mapping operations of the proxy function become extremely complicated, much slower than the NGP rendering speed at 20-30 FPS, making it not practical for interactive preview.
