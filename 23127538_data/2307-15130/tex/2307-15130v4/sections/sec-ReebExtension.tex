...
Given some input data $f:\X \to \R$, we can either construct its Reeb cosheaf $\tF:\Int \to \Set$, or by fixing some choice of $\delta$, we can construct its mapper cosheaf $F:\Open(K) \to \Set$. 
