...
\title{Bounding the Interleaving Distance for Mapper Graphs with a Loss Function
 \thanks{The authors would like to thank Vidit Nanda for helpful discussions related to non-commutative diagrams, as well as anonymous reviewers whose feedback improved the state of the paper. This work was funded in part by the National Science Foundation through grants CCF-1907591, CCF-1907612, CCF-2106578, CCF-2142713, CCF-2106672, DMS-2301361, and IIS-2145499.}
}


\author[1]{Erin Chambers}
\author[2]{Elizabeth Munch}
\author[3]{Sarah Percival}
\author[4]{Bei Wang}
\affil[1]{University of Notre Dame}
\affil[2]{Michigan State University}
\affil[2]{University of New Mexico}
\affil[4]{University of Utah}
...
\input{sections/sec-loss-function}
\input{sections/sec-computation}
\input{sections/sec-ReebExtension}
\input{sections/sec-proofs}
