...
On more graph based representations \cite{Bollen2021}, for Reeb graphs the problem is graph isomorphism-hard~\cite{deSilva2018};  and for merge trees, it is fixed parameter tractable \cite{FarahbakhshTouli2019}; while for formigrams it is polynomial \cite{Kim2019b}.
%
%
