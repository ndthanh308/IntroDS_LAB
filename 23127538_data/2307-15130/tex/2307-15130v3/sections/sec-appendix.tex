...
\subsection{Proofs from Sec.~\ref{sec:Bkgd}}
...
Next we show that the distance of \ref{def:interleavingDistance} is indeed a distance 
using the superlinear family of translations framework of \cite{Bubenik2014a}.
...
\end{theorem}
\begin{proof}
Because \cref{lem:composedthickenings} is a stronger requirement than needed for \cref{defn:superlinear}, the collection $\{ ( - )^n\}_{n \geq 0}$ forms a super-linear family of translations. 
...
%
\subsection{Proofs from Section \ref{sec:loss-function}}
