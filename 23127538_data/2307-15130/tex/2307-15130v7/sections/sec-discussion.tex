...
In the followup work \cite{Chambers2025}, we will use this bound in the context of an ILP framework, where an input $n$-assignment can be improved incrementally thus finding a better bound on the distance. 
