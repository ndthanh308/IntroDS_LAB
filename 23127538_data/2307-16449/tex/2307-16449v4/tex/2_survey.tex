...
% ~\cite{yin2023survey,fu2023mme,alayrac2022flamingo,zhu2023minigpt,li2023otter,li2022blip,li2023blip,gong2023multimodal,lyu2023macaw,ye2023mplug,dai2023instructblip,wang2023visionllm,liu2023visual,maaz2023video,su2023pandagpt,gao2023llama}
...
% VideoChat Longvideo~\cite{videochatlong} further incorporates LangChain~\cite{langchain} into VideoChat to handle videos exceeding one minute in length.
% \cite{wu2021towards} proposes an object-centric benchmark to cover wide but coarse tasks of long-form videos, including content understanding, user engagement prediction, and movie metadata prediction.
...
\input{fig/overview}
%~\cite{cheng2022xmem,oh2019video,cheng2021rethinking,hu2021learning,lu2020video,mao2021joint,seong2020kernelized,seong2021hierarchical,xie2021efficient,ying2023ctvis}
% ~\cite{cai2022memot,hao2022umotma,xin2022multi,fang2018recurrent,allen2006multiple}
% ~\cite{zhou2023memory,fu2021stmtrack,yang2018learning,liu2017mavot,ma2018adaptive}
...
% Unlike using embedded feature given by certain visual encoders, we find that using tokens in Transformers~\cite{vaswani2017attention} as the carriers of memory suitable for both LLMs and ViT~\cite{dosovitskiy2020image} based visual encoder.
