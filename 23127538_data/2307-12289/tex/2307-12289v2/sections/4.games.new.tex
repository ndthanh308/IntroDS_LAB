...
\begin{align*} Attr^0_C (F^a) &= F^a \\ Attr^{i+1}_C (F^a) &= Attr^i_C (F^a) \\ &\cup \set{ q^a \in Q^a_C \, | \, \exists r \big((q^a, r) \in E \land r \in Attr^i_C (F^a)\big) } \\ &\cup \set{ q^a \in Q^a_E \, | \, \forall r \big((q^a, r) \in E \implies r \in Attr^i_C (F^a) \big) }. \end{align*}
