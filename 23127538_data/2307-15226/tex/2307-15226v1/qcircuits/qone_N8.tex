...
\lstick{\ket{0}}&\qw & \ctrl{-1}  &\qww & \qw       & \ctrl{-2}  &\qww & \qw       & \qw        & \qw       & \targ      & \qww \\
\lstick{i} &\qw & \targ      &\qww & \targ     & \qw        &\qww & \ctrl{-4} & \qw        & \qw       & \qw        & \qww \\
...
\lstick{\ket{+}}&\qw & \ctrl{-1}  &\qww & \qw       & \ctrl{-2}  &\qww & \qw       & \qw        & \qw       & \ctrl{-4}  & \qww 
  \inputgrouph{1}{4}{2.3em}{\mathcal{Z}\left\lbrace\raisebox{0em}[3.4em]{\,}\right.}{3em}
  \inputgrouph{6}{8}{1.6em}{\mathcal{X}\left\lbrace\raisebox{0em}[2.3em]{\,}\right.}{3em}
}