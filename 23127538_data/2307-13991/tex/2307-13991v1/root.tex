...
\thanks{This work was supported by the Agency For Defense Development Grant funded by the Korean Government in 2023.}% <-this % stops a space
...
\thanks{$^{2}$Taekyung Kim was with the Agency for Defense Development. He is now with Robotics Institute, University of Michigan, MI 48109, USA
...
\input{_II.Related_Work/2.1.Traversability_Estimation}

\subsection{Meta-Learning}
\input{_II.Related_Work/2.2.Meta_Learning}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{METHODS}
\input{_III.Method/3.0.Overview}

\subsection{Dense Traversability Cost Map \label{sec:baseline}}
\input{_III.Method/3.1.Baseline}

\subsection{METAVerse: Meta-Learning Traversability Cost Map}
\input{_III.Method/3.2.Meta_Learning}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EXPERIMENTS}
\input{_IV.Experiments/4.0.Overview}

\subsection{Implementation Details}
\input{_IV.Experiments/4.1.0.Implementation}

\subsection{Learning Global Traversability Model}
\input{_IV.Experiments/4.1.Real_World}

\subsection{Autonomous Navigation in Unstructured Environments}
\input{_IV.Experiments/4.2.0.Simulation}

\subsubsection{Safe Navigation \label{sec:navigation}}
\input{_IV.Experiments/4.2.1.Stabilizing}
\subsubsection{Effect of Online Adaptation}
\input{_IV.Experiments/4.2.2.Adapt}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{CONCLUSION}
\input{_V.Conclusion/5.1.Conclusion}
