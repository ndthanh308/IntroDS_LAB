...
\midrule
\multicolumn{3}{c}{QM9 and QM9* intersection}\\\midrule tot. num. mol. & $\phantom{-(}89015$ & $ \phantom{-(}\_$\\                   num. mol. &                        $\phantom{-(}$67826 &                     $\phantom{-(}$20325 \\
      min. $\dEsolv$, kJ/mol &           $(-9.483 \pm 0.007)\cdot 10^{1}$ &        $(-5.636 \pm 0.037)\cdot 10^{1}$ \\
...
\midrule\multicolumn{3}{c}{EGP and EGP* intersection}\\\midrule tot. num. mol. & $\phantom{-(}9437$ & $ \phantom{-(}\_$\\                   num. mol. &                         $\phantom{-(}$6190 &                       $\phantom{-(}$863 \\
      min. $\dEsolv$, kJ/mol &           $(-9.474 \pm 0.006)\cdot 10^{1}$ &        $(-7.814 \pm 0.019)\cdot 10^{1}$ \\
...
max. RMSE($\dEsolv$), kJ/mol &           $\phantom{-(}6.960\cdot 10^{-1}$ &        $\phantom{-(}3.500\cdot 10^{-1}$ \\
 max. RMSE($\dEsolv$) SMILES &             $\phantom{-(}$N=C1NC=CN1C(N)=O &               $\phantom{-(}$ClCC1CCCCO1 \\
       ...
       max. $\dipole$, debye & $\phantom{-}(1.326 \pm 0.000)\cdot 10^{1}$ & $\phantom{-}\phantom{(}8.050 \pm 0.048$ \\
