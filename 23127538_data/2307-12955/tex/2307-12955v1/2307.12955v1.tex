...
The author thanks M. Schlosser and N. H. Zhou for helpful comments on a first draft of this note, in particular for pointing out the related paper of Liu and Zhou.
...
\begin{prop}\label{Prop: F_a,c}
	Let $\zeta$ be a primitive $b$-th root of unity. As $z\to 0$ in $D_\theta$ we have that
	\begin{align*}
