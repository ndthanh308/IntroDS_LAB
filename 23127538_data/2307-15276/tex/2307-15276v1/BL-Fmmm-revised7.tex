...
(iii) The Fermi surfaces of LNO and BSCCO fundamentally differ with regards to the presence of hole pockets at $(\pi,\pi)$ for LNO. These pockets are crucial for the stability of $s_{\pm}$ pairing.
...
Furthermore, a vHs near the Fermi level was found at the $M$ point in the BZ in our TB band structure, indicating a possible stripe ($\pi$, 0) order instability.
...
range of Hubbard-Hund couplings. Moreover, due to the particular shape of the Fermi surface, and its orbital composition, the $s^\pm$ pairing channel should be the pairing symmetry of LNO.
...
By changing $\Delta$ to 0.6 eV at 0 Gpa, the hole band sinks below the Fermi level and the $\gamma$-pocket disappears. In this case, $\lambda_{s^\pm}$ is suppressed significantly from 1.55 (at $\Delta=0.474$) to 0.040, and $\lambda_{d_{x^2-y^2}}$ becomes the leading solution, albeit with a similarly small $\lambda_{d_{x^2-y^2}} = 0.045$, providing strong evidence of the importance of the $(\pi,\pi)$ $\gamma$ hole pocket in mediating superconductivity in this system. This could also explain why the superconductivity is only observed in the high-pressure Fmmm phase since the $\gamma$ hole pocket around ($\pi$, $\pi$) vanishes in the Amam phase, suggesting the importance of the Fmmm phase (stable the $\gamma$ pocket) for the superconductivity in the LNO system.
...
The NN hopping matrix of different pressures was obtained from MLWFs. The detailed values can be found in Supplementary Note II. The Fermi energy is obtained by integrating the density of states for all $\omega$ to count the number of electrons $n = 3$. Based on the obtained Fermi energy, a $4000\times4000$ k-mesh was used to calculate the Fermi surface.
...
\bibitem{nematic2} Liang, S., Moreo, A., Dagotto, \& E., {Nematic State of Pnictides Stabilized by Interplay between Spin, Orbital, and Lattice Degrees of Freedom.} \href{https://doi.org/10.1103/PhysRevB.81.140501} {\it Phys. Rev. Lett.}{ \textbf {111}, 047004 (2013)}, and references therein.
