...
\item In this work we have found that the gradients of an effective mass can act as a source of the spin polarization (quantified by the increase of the divergence of the GLW spin tensor). Although, this effect has been found to be absent for a simple one-dimensional expansion, it can occur for more realistic scenarios. We have left an analysis of such cases for future investigations. Clearly, the framework constructed in this work may serve as a departure point for more advanced analyses.
...
We thank Sourav Dey for illuminating discussions. This work was supported in part by the Polish National Science Centre Grants Nos. 2018/30/E/ST2/00432, 2020/39/D/ST2/02054, and 2022/47/B/ST2/01372. GKK acknowledges the hospitality of the Institute of Nuclear Physics PAN, Krak\'ow, Poland, and the Indian Institute of Technology, Gandhinagar (IIT GN) for the Overseas Research Experience Fellowship to visit INP PAN.%
