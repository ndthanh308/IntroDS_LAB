...
We perform an iterative-open coding process, which is widely used to generate categories in Software Engineering~\cite{seaman1999qualitative, liu2018learning, sgier2012qualitative}. We do this on 120 randomly selected phone GUIs and 80 TV GUIs (approximately 2\% of collected phone and TV GUIs) to categorize their GUI groups.
...
\refix{Our first step involves manually identifying and extracting GUI components from respective groups within the phone GUI. 
...
%\todo{I wonder if this lacks detail about HOW need to map e.g. size difference?  Composite difference?  tab content e.g. can you fit the same number of items on phone vs TV?  Ditto list view, navigation... I also wonder about interaction differences e.g. TV remote vs finger on phone...  }
%\fix{fixed}
