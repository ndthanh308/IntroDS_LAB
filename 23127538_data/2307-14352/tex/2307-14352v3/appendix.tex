...
To further verify the model performance in the general image-to-image translation tasks, we make more experiments with different reference images, as shown in Fig.\;\ref{appendixfig:appendix_animal_face}. 

% Figure environment removed

It's noted that there is a trade-off between structural preservation and semantic changes. As shown in Fig.\;\ref{appendixfig:result_balance}, the injection ratio of cross-attention and self-attention affects the result a lot. To obtain the ideal results, we can adjust the attention injection ratio to the optimal value. Empirically, we adopt a low cross-attention injection ratio of about $20\%$, and adjust the self-attention injection ratio to achieve different preservation results.
