\llproof \ref{lem:min-eig}. 
We prove the result in the case of the log-likelihood function.
The proof in the case of the log-pseudolikelihood function follows similarly, 
substituting the appropriate quantities relevant to the log-pseudolikelihood.  
Using \eqref{general model},  
\beno
-\mbE \, \nabla_{\nat}^2 \, \ell(\nat; \bX, \bY)
...
given $\bY = \by$ under \eqref{general model}, 
which implies 
\beno
\ell(\nat; \bx, \by)
...
follows from the form of \eqref{general model},
