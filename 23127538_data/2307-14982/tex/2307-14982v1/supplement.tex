...
{Appendix \ref{sec:pf_thm1}: Proof of Theorem \ref{thm1}}\dotfill\pageref{sec:pf_thm1}\s\\
...
We establish concentration inequalities of gradients of log-likelihoods and log-pseudolikelihoods functions 
of network separable multilayer networks in Lemma \ref{lem:concentration_likelihood} and Lemma \ref{lem:concentration_pl},
respectively.
...
which we presented in Theorem \ref{thm2}. 
...
We present additional simulation results that enhance those contained in Section \ref{sec:sim}.
