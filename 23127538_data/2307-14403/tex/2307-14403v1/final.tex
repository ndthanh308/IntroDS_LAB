...
\author{
Matteo~Ciotola, Giovanni~Poggi, Giuseppe~Scarpa% <-this % stops a space
\thanks{
...
with a low-pass Gaussian-shaped filter. %with Nyquist gain fixed to 0.3.
Finally, a combination of Euclidean distance and structural similarity index (SSIM) is used to compare them.
...
%In this case, of course, the spatial information is subject to degradation, therefore spatial consistency cannot be taken into account.
...
\newcommand{\imCoreg}[1]{% Figure removed}
...
%\footnote{This is a conscious over-hyping,
%just to better convey the idea. A mismatch between the two losses is unavoidable with real-world rich images.},
...
%        &   & + \;\; \beta D_\rho(\widetilde{M},P)
%    \label{eq:total-old fig}
%\end{eqnarray}
%\hl{[$D_\rho$ non e' stata definita e $\hM\rightarrow\tM$. O ci mettiamo $\LL_S$ oppure la descrizione estesa come di seguito]}
...
%On the other hand, measuring the performance by means of the very same metrics used in training would put the proposed method at an advantage.
...
%and likely lower values with further cycles,
...
%C-BDSD           &   &     0.105   &     4.991   &     0.152   &     0.169   &     0.037   &     0.064   &   &     0.137   &     6.731   &     0.205   &     0.113   &     0.065   &     0.117   \\
...
%C-GSA            &   &     0.065   &     3.734   &     0.133   &     0.120   &     0.099   &     0.004   &   &     0.078   &     4.411   &     0.172   &     0.060   &     0.106   &     0.001   \\
...
%MTF-GLP-HPM-H    &   &     0.053   &     3.284   &     0.055   &     0.074   &     0.117   &     0.060   &   &     0.043   &     2.953   &     0.061   &     0.049   &     0.120   &     0.039   \\
%MTF-GLP-HPM-R    &   &     0.051   &     3.319   &     0.044   &     0.109   &     0.080   &     0.055   &   &     0.042   &     2.986   &     0.056   &     0.071   &     0.086   &     0.036   \\
%MTF-GLP-CBD      &   &     0.051   &     3.316   &     0.040   &     0.100   &     0.087   &     0.054   &   &     0.043   &     2.995   &     0.056   &     0.070   &     0.087   &     0.033   \\
%C-MTF-GLP-CBD    &   &     0.055   &     3.452   &     0.040   &     0.187   &     0.054   &     0.063   &   &     0.047   &     3.254   &     0.060   &     0.163   &     0.078   &     0.038   \\
...
%\LPNN w/o.       &   &     0.052   &     3.444   & \zb{0.031}  &     0.059   &     0.062   &     0.122   &   &     0.039   &     2.891   & \zb{0.052}  &     0.037   &     0.135   &     0.085   \\
...
%C-BDSD           &   &     0.164   &     4.888   &     0.244   &     0.217   &     0.088   &     0.153   &   &     0.124   &     5.538   &     0.202   &     0.300   &     0.099   &     0.090   \\
...
%C-GSA            &   &     0.053   &     2.510   &     0.100   &     0.090   &     0.104   & \zb{0.001}  &   &     0.063   &     3.983   &     0.112   &     0.129   &     0.074   &     0.002   \\
...
%MTF-GLP-HPM-H    &   &     0.030   &     1.834   &     0.039   &     0.079   &     0.109   &     0.039   &   &     0.032   &     2.870   &     0.042   &     0.101   &     0.095   &     0.059   \\
%MTF-GLP-HPM-R    &   &     0.034   &     1.932   &     0.043   &     0.109   &     0.091   &     0.040   &   &     0.034   &     2.935   &     0.039   &     0.142   &     0.061   &     0.055   \\
%MTF-GLP-CBD      &   &     0.031   &     1.857   &     0.038   &     0.101   &     0.099   &     0.038   &   &     0.035   &     2.927   &     0.039   &     0.135   &     0.067   &     0.052   \\
%C-MTF-GLP-CBD    &   &     0.032   &     1.902   &     0.039   &     0.153   &     0.086   &     0.040   &   &     0.039   &     3.112   &     0.041   &     0.224   &     0.041   &     0.054   \\
...
%\LPNN w/o        &   &     0.029   &     1.774   &     0.035   &     0.046   &     0.091   &     0.065   &   &     0.030   &     2.721   &     0.041   &     0.055   &     0.065   &     0.094   \\
...
%C-BDSD           &   &     0.147    &     4.542  &     0.227   &     0.111   & \zb{0.055}  &     0.025   &   &     0.143   &     6.526   &     0.231   &     0.078   & \zb{0.030}  &     0.051   \\
...
%C-GSA            &   &     0.160    &     4.461  &     0.262   &     0.079   &     0.143   &     0.008   &   &     0.109   &     5.214   &     0.192   &     0.052   &     0.110   & \zb{0.002}  \\
...
%MTF-GLP-HPM-H    &   &     0.098    &     3.997  &     0.100   &     0.090   &     0.079   &     0.133   &   &     0.036   &     3.575   &     0.055   &     0.081   &     0.049   &     0.056   \\
%MTF-GLP-HPM-R    &   &     0.095    &     3.759  &     0.092   &     0.094   &     0.121   &     0.100   &   &     0.037   &     3.585   &     0.056   &     0.089   &     0.063   &     0.055   \\
%MTF-GLP-CBD      &   &     0.098    &     3.818  &     0.092   &     0.092   &     0.131   &     0.097   &   &     0.038   &     3.539   &     0.056   &     0.088   &     0.069   &     0.054   \\
%C-MTF-GLP-CBD    &   &     0.108    &     4.005  &     0.097   &     0.202   &     0.082   &     0.111   &   &     0.045   &     3.804   &     0.066   &     0.173   &     0.054   &     0.055   \\
...
%\LPNN/wo.        &   &     0.078    &     3.517  & \zb{0.058}  &     0.068   &     0.080   &     0.304   &   &     0.027   &     3.314   & \zb{0.046}  &     0.042   &     0.095   &     0.177   \\
...
\newcommand{\imAx}[1]{% Figure removed}
\newcommand{\imPx}[1]{% Figure removed}
\newcommand{\imWy}[1]{% Figure removed}
\newcommand{\imPy}[1]{% Figure removed}
\newcommand{\imGz}[1]{% Figure removed}
\newcommand{\imPz}[1]{% Figure removed}
...
%Our analyses suggest this to be the effect of imperfect pre-processing of the released multi-resolution products.
...
\newcommand{\imLo}[1]{% Figure removed}
% Figure environment removed
