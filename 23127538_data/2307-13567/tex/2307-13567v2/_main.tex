...
\author{\authororcid{Chen Chen}{0000-0003-3171-0657}, \authororcid{Bongshin Lee}{0000-0002-4217-627X}, \authororcid{Yunhai Wang}{0000-0003-0059-6580},  Yunjeong Chang, and \authororcid{Zhicheng Liu}{0000-0002-1015-2759}}

\authorfooter{
  %% insert punctuation at end of each item
  \item
  	Chen Chen, Zhicheng Liu, and Yunjeong Chang are with University of Maryland, College Park, Maryland, United States.
  	E-mail: \{cchen24, leozcliu\}@umd.edu, ychangs2@terpmail.umd.edu.
...
%% Abstract section.
\abstract{\input{sections/00-abstract}}
...
\teaser{
  \centering
  % Figure removed
  \caption{Each pair shows an existing chart (left) and a new chart created using Mystique (right). The existing charts are produced using a variety of tools, such as D3, Vega-lite, Mascot, PlotDB, Highcharts, and Data Illustrator.}
  \label{fig:teaser}
}
...
\input{sections/04-svgPreprocessing}
\input{sections/05-axis-legend}
\input{sections/06-deconstruction}
\input{sections/07-UI}
...
Chen Chen and Zhicheng Liu were supported in part by NSF grant IIS-2239130, and Yunhai Wang was supported by NSFC (No. 62132017, 62141217) and Shandong Provincial Natural Science Foundation (No. ZQ2022JQ32).
}
