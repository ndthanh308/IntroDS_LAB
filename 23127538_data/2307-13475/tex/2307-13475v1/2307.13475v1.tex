...
%TCIDATA{LastRevised=Saturday, December 24, 2022 21:56:50}
...
%EndAName
Durham University}
\date{This version: 24 December 2022}
\maketitle
...
Kruiniger (2018) derived the limiting distributions of two Modified MLEs for
a panel ARX(1) model with homoskedastic errors when the autoregressive
...
is indexed by the parameter vector $\phi \in \Phi \subset 
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}P_{g}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}G^{\prime }-G^{\prime }W^{1/2}P_{g}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
&&(\frac{1}{3}L+G_{1p}HG)/\sigma _{G}+%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{dg}W^{1/2}(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
}WD)^{-1}D^{\prime }W$. In addition, let $V=$ $-2%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
=G^{\prime }W^{1/2}M_{d}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}$ and $\mathbf{1}($\textperiodcentered $)$ is the usual indicator
function.
...
under the condition that $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{1}=0)=0.$ DH claim in their Remark 1 that this condition \textquotedblleft
is not expected to be restrictive in general ...\textquotedblright ,
although they also add the following caveat: \textquotedblleft However, when 
$q=p=1$ (one moment restriction with one non first-order locally identified
parameter), we can see that $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{1}=0$.\textquotedblright\ However, as we show in the proof of Lemma 2 in
the Appendix, the condition $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{1}=0)=0$ is actually only satisfied when $\phi $ is overidentified, i.e.,
when $q>p;$ when $\phi $ is exactly identified, i.e., when $q=p,$ then $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{1}=0)\neq 0.$ In other words, the theory of DH only provides the limiting
distribution of $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$ for the case
where $\phi $ is overidentified.
...
\mathbb{R}
%EndExpansion
_{2}=0)=0$. The difference between the limiting distributions of $T^{1/4}(%
\widehat{\phi }_{p}-\phi _{0,p})$ given in parts (a) and (b) is related to
the difference between the distributions of the Bernoulli r.v.'s $B_{1}$ and 
$B_{2}$ that determine the sign of $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$
when $%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
...
\mathbb{R}
%EndExpansion
_{2}=0)=0$ holds if $F+3!G_{1pp}HG+\frac{4!}{2}\tilde{\lambda}_{3}\neq 0,$
where $\tilde{\lambda}_{3}=(\lambda _{3,1}\ldots \lambda _{3,q})^{\prime }$
with $\lambda _{3,k}=\frac{1}{4}G^{\prime }H^{\prime }K_{k}HG$ for $%
k=1,2,\ldots ,q,$ cf. Lemma 2(b). When $q=p>1$ and $F+3!G_{1pp}HG+\frac{4!}{2%
}\tilde{\lambda}_{3}=0,$ then the condition $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)=0$ may still hold, but $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0$ when $F=0,$ $G_{1pp}=0$ and $K_{k}=0$ for $k=1,2,\ldots ,q$. When $%
q=p=1,$ then $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)=0$ if only if $F\neq 0$. If $q=p$ and $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
<0\mathbf{)}=1$. In fact, when $q=p,$ then $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{1}=0$, see the end of the proof of Lemma 2(a1). However, if $q=p$ and $\Pr
(%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)=0,$ then the limiting distribution of the sign of $T^{1/4}(\widehat{%
\phi }_{p}-\phi _{0,p})$ can be obtained from the $O_{p}(T^{-7/4})$ terms in
the expansion of $m_{T}^{\prime }(\widehat{\phi })W_{T}m_{T}(\widehat{\phi }%
).$ In that case we have:$\vspace{-0.12in}$%
\begin{equation*}
m_{T}^{\prime }(\widehat{\phi })W_{T}m_{T}(\widehat{\phi })=\underline{K}%
_{T}(\phi _{0,p})+(\widehat{\phi }_{p}-\phi _{0,p})\times
...
T^{6/4}R_{2T}\overset{d}{\rightarrow }%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}$ if $q=p.$ When $Z_{T}<0$, $q=p,$ $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)=0$ and $T$ is large, then the minimum of $m_{T}^{\prime }(\phi
)W_{T}m_{T}(\phi )$ is reached when $(\phi _{p}-\phi _{0,p})$ has the
opposite sign to $R_{2T}$. This suggests that if $q=p$ and $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)=0$, then the limiting distribution of the sign of $T^{1/4}(\widehat{%
\phi }_{p}-\phi _{0,p})$ can be described by $(-1)^{B_{2}}$ with $B_{2}=%
\mathbf{1}(%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}\geq 0).$ If $q=p$ and $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)>0,$ then we may still be able to characterize the sign of $T^{1/4}(%
\widehat{\phi }_{p}-\phi _{0,p})$ by using an expansion of $m_{T}^{\prime }(%
\widehat{\phi })W_{T}m_{T}(\widehat{\phi })$ of an even higher order.
However, if, for instance, $q=p=1$ and $\frac{\partial ^{k}m}{\partial \phi
_{p}^{k}}(\phi _{0})=0$ for $k\geq 4,$ then we cannot characterize the sign
of $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$ and the latter does not have a
proper limiting distribution, whereas $\sqrt{T}(\widehat{\phi }_{p}-\phi
_{0,p})^{2}$ has one, which is given in Lemma 1(b).
...
\mathbb{Z}
%EndExpansion
\geq 0)=\frac{1}{2}.$ Furthermore, note that when $q>p,$ then $\Pr
(B_{1}=1)\neq \frac{1}{2},$ and when $q=p,$ then $\Pr (B_{2}=1)\neq \frac{1}{%
2}.$ Hence the limiting distributions of\ $T^{1/4}(\widehat{\phi }_{p}-\phi
_{0,p})$ given in Theorem 1 are generally asymmetric around $0$.$\vspace{%
-0.14in}$

\subsection{Examples with exact identification}

Kruiniger (2018) derived the limiting distributions of two Modified MLEs for
the panel ARX(1) model with homoskedastic errors when the autoregressive
parameter equals one by viewing them as GMM\ estimators. In the unit root
...
exactly identified and the condition $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)=0$ holds because the condition $F+3!G_{1pp}HG+\frac{4!}{2}\tilde{%
\lambda}_{3}\neq 0$ is satisfied. It is therefore unsurprising that the
limiting distributions obtained by Kruiniger (2018) for both Modified MLEs
of the autoregressive parameter are in agreement with Theorem 1(b) above.
...
N^{1/2}(\widehat{\rho }-1)^{2}\overset{d}{\rightarrow }-\widetilde{%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
}_{0}\mathbf{1}(\widetilde{%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
}_{0}<0)/\sigma ^{2}$ with $N^{-1/2}\tsum_{i=1}^{N}(\varepsilon _{i,3}\Delta
\varepsilon _{i,2})\overset{d}{\rightarrow }\widetilde{%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
}_{0},$ but can no longer determine the sign of $N^{1/4}(\widehat{\rho }-1)$.
...
distributions can be obtained by drawing randomly copies of $(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{1}^{\prime })^{\prime }$ from $N(0,\widehat{v})$, where $\widehat{v}$ is a
consistent estimator of $v$, and using consistent estimators of $W,$ $D,$ $%
G, $ $L,$ $G_{1p},$ $G_{1pp},$ $G_{1ppp},$ $F$ and $K_{k}$ for $k=1,2,\ldots
,q$ as required. One can use the quantiles of the simulated distributions to
construct confidence sets for the elements of $\phi _{0}$.
...
Kruiniger (2018) discusses a Quasi LM\ test for $H_{0}:\phi _{0}=a,$ when $%
\phi _{0,p}$ is possibly only second-order locally identified. Specifically,
Kruiniger's (2018) Quasi LM\ test-statistic generalizes the LM
...
will be replaced by its first-derivative. Kruiniger (2018) shows that his
...
Using simulations, Kruiniger (2018) and DH studied the finite sample
...
\mathbb{R}
%EndExpansion
^{p}$ which is defined by the following set-up: the auxiliary model consists
of a set of $q$ population moment conditions indexed by a vector of
auxiliary parameters $h\in \mathcal{H}\subset 
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
in terms of their conditions, when $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{1}^{(b)}(s)=0)=0$, respectively, where $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{1}^{(b)}(s)$ are defined similarly as $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{1}$, see DH. Our results and derivations for GMM estimation under
second-order local identification can be used to complete both theories and
in particular can be used to straightforwardly derive the limiting
distributions of the II estimators in the case of exact identification under
either scenario. The representations of these distributions are obtained by
replacing $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
...
\mathbb{R}
%EndExpansion
_{1}^{(b)}(s)$ (implicit) in Theorems 2 and 3(b) in DH by $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{2}^{(b)}(s)$, respectively, which are defined similarly as $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{1}$ is defined in (\ref{f7}). We have shown that this condition is only
satisfied when $\phi $ is overidentified and derived the limiting
distribution of $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$ for the case
where $\phi $ is exactly identified. This distribution is different from
that of $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$ given in DH\ for the case
where $\phi $ is overidentified. In particular, the limiting distributions
of the sign of $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$ for the cases of
exact and overidentification, respectively, are different and are obtained
by using expansions of the GMM objective function of different orders. We
have also pointed out that the limiting distribution theories of DH for
Indirect Inference (II) estimation under two different scenarios with
second-order identification where the target function is a GMM\ estimator of
the auxiliary parameter vector, are incomplete for similar reasons and we
have discussed how they can be completed.
...
jointly converges in distribution towards, say, $(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\rightarrow }\underline{K}(\phi _{0})\equiv 
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{d}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{d}W^{1/2}GV+\frac{1}{4}G^{\prime
}W^{1/2}M_{d}W^{1/2}GV^{2}.
\end{equation*}%
Let $%
%TCIMACRO{\U{2124} }%
%BeginExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{d}W^{1/2}G.$ If $%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
<0,$ then $\underline{K}(\phi _{0})$ is minimized at 
\begin{equation*}
V=-2\frac{%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{d}W^{1/2}G}{G^{\prime }W^{1/2}M_{d}W^{1/2}G}=-2\frac{%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
\geq 0,$ then $\underline{K}(\phi _{0})$ is minimized at $V=0.$

Either way, we conclude that $\sqrt{T}(\widehat{\phi }_{p}-\phi _{0,p})^{2}%
\overset{d}{\rightarrow }V=-2%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
_{0,1})\overset{d}{\rightarrow }H(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}+\frac{1}{2}GV),$ where $H=-(D^{\prime }WD)^{-1}D^{\prime }W.$\quad $%
{\tiny \blacksquare }$\textbf{\medskip }\pagebreak
...
it remains to characterize its sign when $%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
TR_{1T})$ converges in distribution towards\linebreak $(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{1})$. According to our Lemma 2, when $q>p,$ $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{1}$ does not have an atom of probability at $0.$

Applying a version of Lemma 1 of DH (2018), we have $(\sqrt{T}Z_{0T},$ $%
\sqrt{T}Z_{1T},$ $(-1)^{B_{1T}})\overset{d}{\rightarrow }(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{1},$ $(-1)^{B_{1}})$, where $B_{1}=\mathbf{1}(%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
_{0,p}|,$ $(-1)^{B_{1T}})\overset{d}{\rightarrow }(H%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}+HGV/2,$ $\sqrt{V},$ $(-1)^{B_{1}})$. Since the limit distribution does
not depend on the subsequence, the whole sequence converges towards that
limit. By the continuous mapping theorem, we deduce that: $(\sqrt{T}(%
\widehat{\phi }_{1}-\phi _{0,1}),$ $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p}))%
\overset{d}{\rightarrow }(H%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}+HGV/2,$ $(-1)^{B_{1}}\sqrt{V})$.
...
\mathbb{Z}
%EndExpansion
<0$. According to our Lemma 2, when $q=p,$ $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
<0\mathbf{)}=1.$ Hence when $q=p,$ $(-1)^{B_{1}}$ with $B_{1}=\mathbf{1}(%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{1}\geq 0)$ will not correctly describe the behaviour of the sign of $%
T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$ in its limiting distribution.
However, when $q=p,$ we can characterize the sign of $T^{1/4}(\widehat{\phi }%
_{p}-\phi _{0,p})$ by expanding $m_{T}^{\prime }(\widehat{\phi })W_{T}m_{T}(%
\widehat{\phi })$ around $\phi _{0}$ up to $o_{p}(T^{-7/4})$. Specifically,
the $O_{p}(T^{-7/4})$ terms in a Taylor expansion of $m_{T}^{\prime }(%
\widehat{\phi })W_{T}m_{T}(\widehat{\phi })$ up to $o_{p}(T^{-7/4})$ will
provide the sign of $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p})$ in case $q=p$
as we will now show.
...
$\underline{R}_{2,T}(\phi _{0})=(\widehat{\phi }_{p}-\phi _{0,p})\times
2R_{2,T}$ where%
\begin{eqnarray}
R_{2,T} &=&\frac{1}{2!}(\kappa _{1,T}\ldots \kappa _{q,T})W(\frac{\partial
m_{T}}{\partial \phi _{p}}(\phi _{0})+\frac{\partial ^{2}m_{T}}{\partial
\phi _{p}\partial \phi _{1}^{\prime }}(\phi _{0})(\widehat{\phi }_{1}-\phi
_{0,1}))+  \notag \\
...
obtain%
\begin{eqnarray}
R_{2,T} &=&\frac{1}{2!}(\lambda _{1,T}\ldots \lambda
...
\begin{eqnarray}
R_{2,T} &=&\frac{1}{2!}\tilde{\lambda}_{1,T}^{\prime
...
\end{eqnarray}%
At the minimum of $Q_{T}(\phi )$, we expect $\underline{R}_{2,T}(\phi _{0})$
to be negative, i.e., $(\widehat{\phi }_{p}-\phi _{0,p})$ and $R_{2,T}$ have
opposite sign. Hence,%
\begin{equation}
...
\widehat{\phi }_{p}-\phi _{0,p})^{2}$ in (\ref{h3}) by its expression from (%
\ref{g6}) and scaling (\ref{h3}) by $T^{6/4}$, we can see, using the
continuous mapping theorem, that $T^{6/4}R_{2,T}$ converges in distribution
towards, say, $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
...
\mathbb{R}
%EndExpansion
_{2}$ is given by (\ref{h3}) with $Z_{0T},$ $Z_{1T}$ and\ powers of $(%
\widehat{\phi }_{p}-\phi _{0,p})^{2}$\ replaced by $%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
<0)/\sigma _{G}),$ and with the unspecified $o_{p}(T^{-6/4})$ term at the
very end of (\ref{h3}) omitted.

We actually have that $(\sqrt{T}Z_{0T},$ $\sqrt{T}Z_{1T},$ $T^{6/4}R_{2,T})$
converges in distribution towards\linebreak $(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{2})$. Furthermore, recall that we have assumed that $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
Applying a version of Lemma 1 of DH (2018), we have $(\sqrt{T}Z_{0T},$ $%
\sqrt{T}Z_{1T},$ $(-1)^{B_{2,T}})\overset{d}{\rightarrow }(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{1},$ $(-1)^{B_{2}})$, where $B_{2}=\mathbf{1}(%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
in distribution. Using part (b) of Lemma 1, such a subsequence obeys $(\sqrt{%
T}(\widehat{\phi }_{1}-\phi _{0,1}),$ $T^{1/4}|\widehat{\phi }_{p}-\phi
_{0,p}|,$ $(-1)^{B_{2,T}})\overset{d}{\rightarrow }(H%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}+HGV/2,$ $\sqrt{V},$ $(-1)^{B_{2}})$. Since the limit distribution does
not depend on the subsequence, the whole sequence converges towards that
limit. By the continuous mapping theorem, we deduce that: $(\sqrt{T}(%
\widehat{\phi }_{1}-\phi _{0,1}),$ $T^{1/4}(\widehat{\phi }_{p}-\phi _{0,p}))%
\overset{d}{\rightarrow }(H%
...
\mathbb{Z}
%EndExpansion
_{0}+HGV/2,$ $(-1)^{B_{2}}\sqrt{V})$. ${\tiny \blacksquare }$
...
\mathbb{R}
%EndExpansion
_{1}$ is the sum of two terms with the first term given in the first line of
(\ref{g9}) and the second term given in the second line of (\ref{g9}).

(a1) We will first show that 
\begin{equation*}
(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime })W^{1/2}M_{d}W^{1/2}\mathbf{1(}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
/\sigma _{G}=-2(G^{\prime }W^{1/2}M_{d}W^{1/2}G)^{-1}G^{\prime
}W^{1/2}M_{d}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
...
\mathbb{Z}
%EndExpansion
<0\mathbf{)=1(}Z_{1}>0)$ and $\sqrt{T}(\widehat{\phi }_{p}-\phi
_{0,p})^{2}\rightarrow ^{d}V=Z_{1}\mathbf{1(}Z_{1}>0).$
...
\mathbb{Z}
%EndExpansion
_{0}G^{\prime }-G^{\prime }W^{1/2}M_{d}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{d}W^{1/2}G(G^{\prime
}W^{1/2}M_{d}W^{1/2}G)^{-1}G^{\prime }W^{1/2}M_{d}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{d}W^{1/2}GZ_{1}G^{\prime }-G^{\prime
}W^{1/2}M_{d}W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{d}W^{1/2}G(\frac{1}{2}Z_{1}G^{\prime }+%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{0}+\frac{1}{2}Z_{1}G)^{\prime }W^{1/2}M_{d}W^{1/2}\mathbf{1(}Z_{1}>0)=0.$
The latter can be shown as follows. If $q=p$ and $Z_{T}<0$, then upon
replacing $(\widehat{\phi }_{1}-\phi _{0,1},$ $(\widehat{\phi }_{p}-\phi
_{0,p})^{2})^{\prime }$ in (\ref{g4}) by\linebreak $-(D$ $\frac{1}{2}%
G)^{-1}m_{T}(\phi _{0})+o_{p}(T^{-1/2})$, we obtain $\underline{K}_{T}(\phi
_{0})=o_{p}(T^{-1})$. Hence it follows from (\ref{g2}) that if $q=p$ and $%
Z_{T}<0,$ then $m_{T}^{\prime }(\widehat{\phi })Wm_{T}(\widehat{\phi })\leq $
$o_{p}(T^{-1})$ and hence $m_{T}(\widehat{\phi })=o_{p}(T^{-1/2}).$ Using
this result, that $\sqrt{T}Z_{T}\rightarrow ^{d}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
$ and that $\sqrt{T}(\widehat{\phi }_{1}-\phi _{0,1})\rightarrow ^{d}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{0}+HGV/2$, it follows from (\ref{f8}) that $(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{2}+\frac{1}{2}Z_{1}G)\mathbf{1(}Z_{1}>0)=0$.\footnote{%
...
\mathbb{Z}
%EndExpansion
_{0}+\frac{1}{2}Z_{1}G)\mathbf{1(}Z_{1} &>&0)= \\
(I-D(D^{\prime }WD)^{-1}D^{\prime }W)(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{2}+\frac{1}{2}Z_{1}G)\mathbf{1(}Z_{1} &>&0)=0.
\end{eqnarray*}
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{dg}W^{1/2}\mathbf{1(}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
<0\mathbf{)}=0$ so that the second term of $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
<0$. Using $M_{dg}=M_{d}-P_{g}$ and the definition of $Z_{1}$, we obtain$%
\vspace{-0.07in}$%
\begin{equation*}
%TCIMACRO{\U{2124} }%
%BeginExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }+\frac{1}{2}Z_{1}G^{\prime })W^{1/2}M_{d}W^{1/2}\mathbf{1(}%
Z_{1}>0)=0
\end{equation*}%
again because $W^{-1/2}M_{d}W^{1/2}(%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{0}+\frac{1}{2}Z_{1}G)\mathbf{1(}Z_{1}>0)=0.$ We conclude that if $q=p,$
then $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
...
\mathbb{Z}
%EndExpansion
<0\mathbf{)}=0,$ which means that $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{R}
%EndExpansion
_{1}=0$ when $q=p$. It is easily verified that the matrix $M_{dg}$ projects
a vector on the orthogonal complement of $(W^{1/2}D$ $W^{1/2}G).$ When $q=p,$
$Rank(D$ $G)=p=q.$ Moreover, $W$ has full rank. Hence when $q=p,$ then $%
M_{dg}=\mathbf{0}$ and $(\frac{1}{2}Z_{1}G^{\prime }+%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{0}^{\prime }W^{1/2}M_{dg}W^{1/2}=0$ so that both terms of $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
(a2) Note that only the second term of $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{1}.$ It therefore suffices to show that $\Pr (%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{1}=0)=0.$\linebreak The latter follows from $M_{dg}^{2}=M_{dg},$ $%
Rank(M_{dg})=q-p>0,$ and the fact that\linebreak $((W^{1/2}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
...
\mathbb{Z}
%EndExpansion
_{1})^{\prime })^{\prime }$ has a continuous multivariate (normal)
distribution with mean zero and a covariance matrix of full rank. We
conclude that when $q>p$, $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
...
(b) There is no combination of terms in the formula for $%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}$ that includes $\frac{1}{4!}%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
_{1}^{\prime }W(F+3!G_{1pp}HG+\frac{4!}{2}\tilde{\lambda}_{3})\times (-2%
%TCIMACRO{\U{2124} }%
%BeginExpansion
\mathbb{Z}
%EndExpansion
/\sigma _{G})^{2}$ and equals zero. We conclude that when $q=p$ and $%
F+3!G_{1pp}HG+\frac{4!}{2}\tilde{\lambda}_{3}\neq 0$, then $\Pr (%
%TCIMACRO{\U{211d} }%
%BeginExpansion
\mathbb{R}
%EndExpansion
_{2}=0)=0.\vspace{-0.2in}$
\end{proof}
...
\bibitem{Kruin5} Kruiniger, H., 2018, A further look at Modied ML estimation
of the panel AR(1) model with fixed effects and arbitrary initial
conditions. MPRA Working paper 88623, https://mpra.ub.uni-muenchen.de/88623/
(revised on 26 August 2022)
...
\bibitem{Sargan} Sargan, J. D., 1983, Identification and lack of
identification. Econometrica 51, 1605-1633.
