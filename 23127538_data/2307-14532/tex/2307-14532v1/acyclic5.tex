...
\node[circle,draw=black,label={}] (v1) at (-2,0){};
\node[circle,draw=black,label={}] (v2) at (0,0){};
\node[circle,draw=black,label={[xshift=-0.2cm, yshift=-0.1cm]$v'$}] (v3) at (2,0){};
...
\node[shape=rectangle,draw=black,label={}] (c1) at (-1,0){};
\node[shape=rectangle,draw=black,label={[xshift=-0.3cm, yshift=-0.1cm]$c$}] (c2) at (1,0){};
