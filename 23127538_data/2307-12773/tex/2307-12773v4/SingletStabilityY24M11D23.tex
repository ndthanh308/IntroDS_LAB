...
&\hspace{0.75cm} \begin{tikzpicture} \draw (0,0) node[rotate=90] {\Huge $\Bigg\{$}; \end{tikzpicture}
\hspace{1.75cm} \begin{tikzpicture} \draw (0,0) node[rotate=90] {\Huge $\Bigg\{$}; \end{tikzpicture}\\[-30pt]
...
&\hspace{9.25cm} \begin{tikzpicture} \draw (0,0) node[rotate=90] {\Huge $\Bigg\{$}; \end{tikzpicture}\\[-25pt]
&\hspace{10.55cm} L
\end{split}
\end{equation*}
...
of Lieb and Mattis \cite{LiebMattis}, using the Perron-Frobenius theorem.
...
&\hspace{-3.75cm} \begin{tikzpicture} \draw (0,0) node[rotate=90] {\Huge $\Bigg\{$}; \end{tikzpicture}\\[-25pt]
&\hspace{-2.45cm} L
\end{split}
\end{equation*}
...
We note that Lemma \ref{lem:TL} is easy to generalize to higher spins. 
