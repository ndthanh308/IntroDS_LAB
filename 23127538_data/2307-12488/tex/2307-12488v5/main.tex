...
\newcommand{\lan}[1]{{\color{green} Lan:} {\color{red} #1}}
...
\title{\LARGE How Does Naming Affect LLMs on Code Analysis Tasks?}
...
\author[2]{Xinzhi Luo}
\author[1]{Peng Liu}
\affil[1]{College of Information Science and Technology, The Pennsylvania State University}
\affil[2]{Heinz College, Carnegie Mellon University}
...
\input{sections/codebert}
\input{sections/chatgpt}
