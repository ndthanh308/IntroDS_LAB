...
\begin{shaded*}
\noindent{\bf \setword{Appx Q1}{appendix:Q1}:} \textit{Please analyze the following algorithm and infer the algorithm type:}  
  {
...
\colorlet{shadecolor}{red!5}
\begin{shaded*}
\noindent{\bf \setword{Appx Q2}{appendix:Q2}:}  \textit{Please analyze the following algorithm and infer the algorithm type:}  
  {
  \begin{lstlisting}[language=C++,
    emph={lmn,efg,abc},
    belowskip=-1.2 \baselineskip,
...
\colorlet{shadecolor}{red!5}
\begin{shaded*}
\noindent{\bf \setword{Appx Q11}{appendix:Q11}:} \textit{Could you define the seeds to fuzz the following program?}
  {
  \begin{lstlisting}[language=C++,
...
\colorlet{shadecolor}{red!5}
\begin{shaded*}
\noindent{\bf \setword{Appx Q12}{appendix:Q12}:} \textit{Could you mutate the following seed? ``hello\%20worlw''}
  { }
  \end{shaded*}
\vspace{-1.7em}
\colorlet{shadecolor}{green!5}
...
\colorlet{shadecolor}{red!5}
\begin{shaded*}
\noindent{\bf \setword{Appx Q13}{appendix:Q13}:} \textit{What kind of vulnerability will be found if we use the seed ``hello\%20\%21\%22world''?}
...
\colorlet{shadecolor}{red!5}
\begin{shaded*}
\noindent{{\bf \setword{Appx Q14}{appendix:Q14}:} Could you review the bellowing code?}
  {\begin{lstlisting}[language=C++,
    emph={abc,printf,main},
...
\colorlet{shadecolor}{red!5}
\begin{shaded*}
\noindent{\bf \setword{Appx Q15}{appendix:Q15}:} \textit{Could you review~\ref{code:obfuscated}?}
  {}
  \end{shaded*}
\vspace{-1.7em}
\colorlet{shadecolor}{green!5}
