...
\title{The Effectiveness of Large Language Models (ChatGPT and CodeBERT) for Security-Oriented Code Analysis}
\author[1]{Zhilong Wang} % \thanks{Corresponding author:~zzw169@psu.edu}
\author[1]{Lan Zhang}
\author[1]{Chen Cao}
\author[1]{Peng Liu}
\affil[1]{College of Information Science and Technology, The Pennsylvania State University, United States}
