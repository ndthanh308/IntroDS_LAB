...
\end{equation}
where $a>0$, $0<\alpha <1$, and $n>0$. In Figure 1 we show the difference between the TAP logistic equation and the traditional logistic equation for $a=1$, $\alpha=0.2$, and $n=10$. 
...
The behavior of the system resembles a predator-prey model \cite{key-7}, where the innovation and production of "items" (the predator) is chasing the "resources" (the prey).  
