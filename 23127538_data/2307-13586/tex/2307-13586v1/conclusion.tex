...
how to understand other RL settings as well.  
...
Additionally, multiple other tabular settings (e.g., time-homogeneous finite-horizon MDPs, discounted infinite-horizon MDPs) have also suffered from similar issues regarding burn-in requirements \citep{zhang2020reinforcement,ji2023regret}. 
