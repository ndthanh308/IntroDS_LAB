...
%
This paper concentrates on time-inhomogeneous (or nonstationary) finite-horizon MDPs. 
...
Note that both the reward and the state transition are independently drawn from their respective distributions, depending solely on the current state-action-step triple but not any previous outcomes. 
