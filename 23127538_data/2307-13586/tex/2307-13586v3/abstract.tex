...
The key technical innovation lies in a novel analysis paradigm (based on a new concept called ``profiles'') to decouple complicated statistical dependency --- a long-standing challenge facing the analysis of online RL in the sample-hungry regime. 
