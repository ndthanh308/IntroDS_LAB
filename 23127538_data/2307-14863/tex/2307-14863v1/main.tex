...
\author{Xiaochen Ma\textsuperscript{1}, Bo Du\textsuperscript{1},  Xianggen Liu\textsuperscript{1}, Ahmed Y. Al Hammadi\textsuperscript{2},  and Jizhe Zhou\textsuperscript{1}  \\
...
\textit{IML-ViT (ours)}                 & \textbf{0.734}   & \textbf{0.836}    & \textbf{0.339} & 0.425  & \textbf{0.156}   & \textbf{0.498} \\ \bottomrule[2pt]
\end{tabular}
}
