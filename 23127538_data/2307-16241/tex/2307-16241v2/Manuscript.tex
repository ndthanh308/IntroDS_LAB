...
\usepackage{titlesec}
\usepackage[colorlinks = true, linkcolor = black, citecolor =black, urlcolor = black, linkbordercolor = white, bookmarks = false, pdfstartview={XYZ null null 1.00}]{hyperref}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[L]{\normalfont\sffamily Kulkarni et al.}
\fancyhead[C]{\normalfont\sffamily Manuscript Draft}
...
\renewcommand{\eqref}[1]{%
 ...
 \leavevmode
  \color{blue}%
  \hypersetup{linkbordercolor=[named]{blue}}%
  \@msm@th@eqref{#1}%
  \endgroup
}
...
@inproceedings{Kulkarni2012b,
  title={Bag Breakup \vspace{-1pt}of Viscous Drops},
...
@inproceedings{Kulkarni2015,
  ...
  author={\vspace{-1pt} Kulkarni, Varun and Bulusu, Kartik V and Plesniak, Michael W and Sojka, Paul E},
  booktitle={APS Division of Fluid Dynamics Meeting Abstracts},
  pages={D32--007},
  year={2015}
}
...
\title[\textit{\footnotesize Applied Physics Letters}]{\textcolor{black}{On interdependence of instabilities and average drop sizes in bag breakup} \vspace{10pt}\\}
...
\affiliation{School of Mechanical Engineering, Purdue University, West Lafayette, IN 47906, \textcolor{black}{USA}}
...
\vspace{-20pt}
\section*{\normalsize Conflict of Interest Statement}
\vspace{-12pt}
