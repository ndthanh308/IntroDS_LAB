...
% Title.
% ------
\title{Non-Intrusive Speech Intelligibility Prediction for Hearing Impaired Individuals using Self-Supervised Speech Representations\thanks{This work was supported by \xblackout{the Centre for Doctoral Training in Speech and Language Technologies (SLT) and their Applications funded by UK Research and Innovation [grant number EP/S023062/1]. This work was also funded in part by TOSHIBA Cambridge Research Laboratory}}}
%
% Single address.
% ---------------
\name{BLIND}
...
\name{George Close, Thomas Hain, Stefan Goetze}
%\email{glclose1@sheffield.ac.uk,t.hain@sheffield.ac.uk,s.goetze@sheffield.ac.uk}
