...
in the formalism of Soft-Collinear Effective Theory (SCET)~\cite{Becher:2009qa, Catani:1998bh, Dixon:2009ur} as
\begin{equation}
...
\mathbf{\Gamma}(\{p\}, \mu)=  \mathbf{\Gamma}_\text{dip}(\{p\}, \mu)  + \mathbf{\Delta}_4(\{p\}, \mu)  \; .
\end{equation}
...
The quadrupole contribution $\mathbf{\Delta}_4$ in
...
\mathbf{\Delta}^{(3), ijk}_4 = -f_{abe} f_{cde}\\ \times
\bigg[
16 \,C   \, \sum_{i=1}^4 \sum_{\substack{1\leq j < k \leq4 \\ j,k\neq i}}  \left\{ \mathbf{T}^a_i,\mathbf{T}^d_i \right\} \mathbf{T}^b_j \mathbf{T}^c_k 
\bigg]\,,
\end{multline}
