...
\title{BayesDAG:  Gradient-Based Posterior Sampling for Causal Discovery}
...
\author{%
\textbf{Yashas Annadani}$^{\printfnsymbol{2}\thanks{Equal contribution. \printfnsymbol{2} Work done during internship at Microsoft Research. Correspondence to \texttt{wenbogong@microsoft.com}}\,\,\,1,3}$
\quad
