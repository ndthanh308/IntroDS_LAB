...
\end{equation}
%
Notice that other objective functions can also be modeled. \citet{salo2022} discuss the use of the conditional value-at-risk, for example.
