...
In order to create a user-friendly package that precludes a deeper understanding of MILP modeling by the user, we implemented a structure for influence diagrams and an interface for constructing them, demonstrated in Figure \ref{fig:code-nodes}. In that, we illustrate the implementation of the pig farm problem, originally proposed in \citet{lauritzen2001representing}. The influence diagram of the pig farm problem is presented in Figure \ref{fig:pigfarm}.
%
