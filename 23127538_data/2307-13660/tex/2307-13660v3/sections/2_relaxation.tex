...
\end{align*}
where $\RR \defeq \begin{bmatrix}\FF & \\ &\GG\end{bmatrix}$ is the matrix representation of $R$ and $\VV \defeq \begin{bmatrix}\XX & \\ &\YY\end{bmatrix}$, $\UU \defeq \begin{bmatrix}\YY & \\ &\XX\end{bmatrix}$, $\WW \defeq \begin{bmatrix}& \YY \\ \XX&\end{bmatrix}$. We note that the presence of a redundant block $\GG\XX-\YY\FF^T$ in the distance difference matrix $\VV - \RR\UU\RR^T + \RR\WW - \WW^T\RR^T$ is motivated by matrix symmetry.
