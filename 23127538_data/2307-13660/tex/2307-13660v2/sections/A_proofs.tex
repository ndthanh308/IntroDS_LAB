...
\voronoiface*
\begin{proof}
    Note that $$\|\SS - \RR\|_2^2 = \|\SS\|_2^2 - 2\langle \SS, \RR \rangle + n+m\quad\forall\RR \in \RRR$$ and therefore $$\argmin_{\RR \in \RRR}\,\|\SS - \RR\|_2 = \argmax_{\RR \in \RRR} \;\langle \SS, \RR \rangle.$$
