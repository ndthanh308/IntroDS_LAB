...
\K = \begin{pmatrix}
 ...
 \end{pmatrix} , 
\end{equation}
where $\A$ is the adjacency- and $\DD$ is the diagonal degree-matrix of the
graph (it contains the row-sums of $\A$, i.e., the node-degrees of $G$
...
\subsection{Random graphs obtained by bond-percolation}
