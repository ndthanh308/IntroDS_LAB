...
Lastly, we consider a purely graph-theoretic problem that can be resolved by the polynomial method, while there is still no known graph-theoretic proof.
It comes from translating the joints with multiplicity problem.
