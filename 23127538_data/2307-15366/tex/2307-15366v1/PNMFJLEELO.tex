...
phenomenon due to a change in the moment of inertia~\cite{Glendenning:1997fy,Franzon:2016urz} that can lead to spin up of the star.
...
Whereas neutron star masses lie in the rather compact interval 1-2$M_{\odot}$, there is more spread in the period of pulsars, that range from millisecond to seconds. The fastest known pulsar has a frequency of 716 Hz
that corresponds to  $\Omega=4.5\;\rm{ms^{-1}}$. We will therefore illustrate our computations with angular velocities up to 
$\Omega= 5$ radians per millisecond. 




In General Relativity, the maximum angular velocity above which the centrifugal force exceeds the gravitational pull, so that the star sheds mass, is~\cite{Glendenning} 
...
rotation condition and, to be specific, we would like to maintain $\Omega R<0.05$ which includes most pulsars (see the discussion below in section~\ref{sec:HartleThorne}). 
...
Our deployed mock phase transitions satisfy those limits.
...
we can see that the phase transition (flat stretch of the  red line  in figure~\ref{eosfig}, the bottom one at 400 MeV/fm$^3$) causes a clear kink in the bottom right corner of the top plot of figure~\ref{fig:static}. That is, the $M(R)$ diagram shows phase transitions of the equation of state as kinks. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Hartle-Thorne theory for stationary rotating stars} \label{sec:HartleThorne}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

This static star is then modified by rotation following the theory of Hartle and Thorne~\cite{Hartle:1967he,Hartle:1968si}. The metric with a stationary time dependence is
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
After the numeric integration,  $\xi_0(r)$ and $\xi_2(r)$ are reconstructed from $p_0^*$ and $p_2^*$,
...
the Einstein telescope, will reach precisions down to the 50 meter level~\cite{Huxford:2023qne}, and then ellipticities will also be
accessible.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
this is in analogy to the kink long predicted in the mass-radius diagram and we think can be of future use.
...
Eur. Phys. J. C \textbf{83}, no.4, 295 (2023)
...
Phys. Rev. D \textbf{105}, no.12, 124071 (2022)
