...
\begin{itemize}
    ...
    \end{equation}
    For $Q2^n$, $X$ and $Y$ are the hypercomplex numbers of $x$ and $y$, respectively, $\mu_X$ and $\mu_Y$ are the means of $X$ and $Y$, respectively, $\sigma_X$ and $\sigma_Y$ are the variances of $X$ and $Y$, and $\sigma_{XY}$ denotes the covariance between $X$ and $Y$.
    The $Q2^n$ metric represents a good candidate to give an overall evaluation of both radiometric and spectral distortions in the pansharpened images.
