...
\begin{center}
Eliza Maria Ferreira$^1$, Ricardo Edem Ferreira$^2$ and Chiara Mocenni$^3$ \\ $^{1, 2}$\textit{Federal University of Lavras} \\ $^{3}$\textit{University of Siena}
\end{center}
