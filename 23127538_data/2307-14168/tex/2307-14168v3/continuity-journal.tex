...
\title[\Btt: a Family of Effectful, Extensional Type Theories]{\Btt: a Family of Extensional Type Theories with Effectful Realizers of Continuity}
...
\section{\texorpdfstring{\Btt}{BoxTT} : Syntax \& Semantics}
...
\subsection{\texorpdfstring{\Btt}{BoxTT}'s Syntax and Operational Semantics}
\label{sec:syntax}
...
\section{Principles (In)Compatible with \texorpdfstring{\Btt}{BoxTT}}
...
\begin{lem}[\llink{276}]                 % was the ~ intended?
