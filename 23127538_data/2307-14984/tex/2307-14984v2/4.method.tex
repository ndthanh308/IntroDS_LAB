...
\begin{table}[t]
    \centering
    \begin{minipage}{0.45\textwidth}  % Width of the first table
            \caption{Prediction performance of gender and age.}
        \centering
        \small
        \renewcommand{\arraystretch}{1.2} % Adjust vertical cell spacing
        \begin{tabular}{c|ccc}
    ...
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth}  % Width of the second table
        \centering
