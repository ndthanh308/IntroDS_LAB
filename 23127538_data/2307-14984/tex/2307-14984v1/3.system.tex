...
\begin{table}[t!]
	\caption{The utilized datasets for social network simulation.}\label{tab:stat_craw}
    \vspace{0.2cm}
    \scriptsize
	\label{tab::overall}
	\centering
	\begin{tabular}{c|c|c|c|c|c}
		\hline
		{\bf Scenario} & \bf \#Users   & \bf \#Relations &  \bf\#Posts      &  \bf Demographics     & \bf Purpose  \\ \hline
 \bf Gender Discrimination &   8,563    &    8,823     &    18,275    &      Age, Gender, Occupation  &  Information\&Emotion Propagation \\ \hline
 \bf Nuclear Energy    &   17,945    &     28,713    &  50,000      & Age, Gender, Occupation & Information\&Attitude Propagation  \\ \hline
	\end{tabular}
\end{table}

In this study, our focus was directed toward two specific focal points, namely gender discrimination and nuclear energy. These particular subjects were chosen owing to their highly controversial nature, which yielded an extensive corpus of data. More specifically, our investigation regarding nuclear energy centered on examining the prevailing attitudes of the general public toward the choice between supporting nuclear energy sources or relying on fossil fuels. As for gender discrimination, our objective was to delve into the emotional experiences of individuals and populations, particularly those elicited by incidents of gender-based discrimination, such as feelings of anger. The availability of such copious amounts of data facilitated the extraction of a substantial portion of the authentic network, thereby enabling us to gain a macroscopic perspective that closely approximates reality. To conduct this analysis, we collect the real data with users, social connections, and textual posts in social media, as detailed in Table \ref{tab:stat_craw}. This dataset provided us with the necessary resources to delve deep into the dynamics of these contentious subjects and gain valuable insights into their impact on social networks. 
...
\begin{table}[t!]
\centering
\caption{Performance of our system on five prediction tasks for individual simulation.}
\vspace{0.3cm}
\label{tab::ind1}
\begin{tabular}{ccccc}
\hline
\textbf{Scenario} & \textbf{Prediction Task} & \textbf{Accuracy} & \textbf{AUC} & \textbf{F1-Score} \\ \hline
\multirow{2}{*}{\textbf{Gender Discrimination}} & Emotion Level                 & 71.8\% & {---} & {---} \\
                                                & Event Propagation & 66.2\% & 0.662 & 0.667 \\
                                                \hline
                                                & Initial Attitude              & 74.3\% & 0.727  &  0.834 \\ 
\multirow{2}{*}{\textbf{Nuclear Energy}}        & Attitude Change               & 83.9\% & 0.865  & 0.857 \\
                                                & Event Propagation & 69.5\% & 0.681 & 0.758 \\ \hline
\end{tabular}
\end{table}
...
As depicted in Table~\ref{tab::ind1}, our methods have demonstrated excellent performance. In the task of predicting initial attitudes, our approach yields an accuracy of 74.3\%, an AUC score of 0.727, and an F1-Score of 0.667. In the subsequent task of attitude change prediction, our method performs even better, achieving an impressive accuracy of 83.9\%, an AUC score of 0.865, and an F1-Score of 0.857. These results can be largely attributed to the ability of LLMs to profoundly comprehend human behavior and cognition. Such understanding enables a sophisticated interpretation of user-generated content, resulting in a more accurate prediction of users' attitudes and their evolution over time.
\begin{table}[t!]
\centering
