...
In this section, we  will introduce the first 4 operators and their parameters shown in Table~\ref{tab:dsl} (we will give additional details in our technical report~\cite{full} in the interest of space).
