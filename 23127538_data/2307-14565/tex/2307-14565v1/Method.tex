...
We rank all resulting multi-step transformations by probabilities. This returns $\{O_1, O_3\}$ as the most likely (with probability 0.5*0.8 = 0.4), which is indeed the desired transformation as discussed in Example~\ref{ex:multi-step}.
\end{example}
\vspace{-2mm}
