...
\subsubsection*{Acknowledgements} We thank Dr. Samuel Marchal and Shelly Wang for initial discussions on this problem and for collaborating on an alternative approach for fingerprinting DRLs that we explored prior to the solution presented in this paper. We also thank Aalto Science-IT for computational resources.
