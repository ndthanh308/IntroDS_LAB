...
\hypersetup{
	...
	pdfauthor={Kim, Kraus, Myers},     % authors
...
%
 ...
 %
which agrees with the statement of the soft theorem in section 2.8.8 of \cite{Strominger:2017zoo}.  
...
%
\eq{ap16}{ \langle {\cal O}(y_1) \ldots {\cal O}(y_n)\rangle = \lim_{z_i \rt \epsilon} z_1^{-\Delta } \ldots z_n^{-\Delta} G_n(x_1,\ldots ,x_n)~. }
%
...
%
\eq{ap17}{ K(x;y') = \lim_{z'\rt \epsilon} z'^{-\Delta} G(x,x')~. }
%
