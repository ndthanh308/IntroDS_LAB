    ...
    We observe that tensor factorization-based methods can be sensitive to the orientation of the coordinate frames, since axis-aligned features are used; in essence, this is because the rank of a sparse tensor is sensitive to rotation, as shown in Fig.~\ref{fig:toy-rot}.
