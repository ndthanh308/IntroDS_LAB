...
$$
\frac{\DT}{h} \leq \frac{1}{\lambda_{\max}} \sim 10^{-\nicefrac{\kappa}{2}}.
$$ 
...
\begin{table}[th!]
	\caption{Comparisons of the orders of convergence of Quinpi schemes on the initial condition~\eqref{eq:conv:test:ic} with $\kappa=4$. The grid ratio is $\nicefrac{\Delta t}{h}=4$ which corresponds to a Courant number $C=673.3$.\label{tab:rates:kappa4}}
	\centering
	\vspace{0.25cm}
	\pgfplotstabletypeset[
	font=\small,
...
The authors appreciate the unknown referee’s valuable and profound comments which helped to improve significantly the results of this work.
