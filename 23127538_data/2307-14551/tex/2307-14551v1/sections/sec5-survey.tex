...
We recruited 300 participants on the survey recruitment platform Prolific, and ran the survey on the survey delivery platform Qualtrics. We selected participants that had used YouTube before, were adults (18+), and resided in the US. Participants were paid \$15 an hour. The authors' institutional IRB team approved the study.
...
Since attention checks are important to maintaining experimental validity, we also implemented three of them throughout the survey to make sure they were focusing on and comprehending the survey questions.
\al{
%\marginnote{R1-10}
...
Moving onto results, we find for \emph{Awareness} that survey respondents were most aware of the ``Dislike" button's existence (94\%). ``Don't recommend channel" was the least well-known (36\%). As for \emph{Usage}, they favored ``Not interested" (83\%) and ``No channel" (81\%) to remove unwanted recommendations when they experienced it. ``Dislike" was the least used button (38\%). Looking at \emph{Belief in efficacy}, users found ``Delete" (3.76), ``Not interested" (3.42), and ``No channel" (4.43) all more effective than the ``Dislike" button (2.46). 
