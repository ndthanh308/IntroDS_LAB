...
Due to network churn and imperfect routing tables, we observed in our experiments that successive calls to $\Call{GetClosestPeers}{\key}$ do not always return the true set of $k=20$ closest peers (we provide more details in \Cref{sec:evaluation}, \Cref{fig:20closest}).
%
