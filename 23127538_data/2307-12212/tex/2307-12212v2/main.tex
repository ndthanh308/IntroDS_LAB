...
%
%
\title{Content Censorship in the\\InterPlanetary File System}
...
\author{
  ...
  \IEEEauthorblockA{
    \begin{tabular}{ccc}
      ...
      \IEEEauthorrefmark{3}ICTEAM, UCLouvain & \IEEEauthorrefmark{6}Protocol Labs & \IEEEauthorrefmark{4}City, University of London \\
    \end{tabular}
  }
}
...
\input{sections/ae_appendix.tex}
