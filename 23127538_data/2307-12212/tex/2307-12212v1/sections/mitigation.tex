...
The number of lookups required increases linearly in the number of Sybil identities placed by an attacker.
%
Importantly, operating a Sybil identity requires participating in the DHT routing and responding to keep-alive messages.
%
As a result, the cost for the attacker also increases linearly with the number of Sybil identities.
%
