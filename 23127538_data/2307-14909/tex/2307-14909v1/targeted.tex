...
Initially developed and tested on the Xen and XAPI project source code.
...
There are a lot of C static analysers (some even written in OCaml), but to the author's knowledge none of them
