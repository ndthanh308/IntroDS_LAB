...
\usepackage{graphicx,dblfloatfix} % takes care of graphic including machinery
%\usepackage[letterpaper]{geometry} % decreases margins
...
\newcommand{\crm}{\times}
% \newcommand{\T}{^\top}
% \newcommand{\Tten}{^{\bar{\top}}} % transpose 1-2 for tensor
% \newcommand{\Rten}{^{\bar{\mathrm{R}}}} % transpose 2-3 for tensor
% \newcommand{\RTten}{^{\bar{\mathrm{R}},\bar{\!\top\!}}} % transpose 2-3 for tensor
\newcommand{\T}{^\top}
\newcommand{\Tten}{^{\widetilde{\top}}} % transpose 1-2 for tensor
\newcommand{\Rten}{^{\widetilde{\mathrm{R}}}} % transpose 2-3 for tensor
\newcommand{\RTten}{^{\widetilde{\mathrm{R}},\widetilde{\!\top\!}}} % transpose 2-3 for tensor
...
\newcommand{\IC}[1]{\I_{#1}^{C}}
\newcommand{\BC}[1]{\B_{#1}^{C}}
\newcommand{\BCT}[1]{\B_{#1}^{C,T}}
...
\usepackage{scalerel}
% new notation
\newcommand{\timesM}{{\tilde{\smash[t]{\times}}}}
\newcommand{\timesfM}{\timesM {}^*}
%\newcommand{\timesMT}{\timesM {}\T}
%\newcommand{\timesMR}{\timesM {}^{R}}
%\newcommand{\timesfMR}{\timesM {}^{*R}}
\newcommand{\crffM}{\scaleobj{.87}{\,\tilde{\bar{\smash[t]{\!\times\!}}{}}}{}^{\,*}}
\newcommand{\crffMR}{\scaleobj{.87}{\,\tilde{\bar{\smash[t]{\!\times\!}}{}}}{}^{\,*R}}


% \newcommand{\timesM}{{\widetilde{\smash[t]{\times}}}}
% \newcommand{\timesfM}{\timesM {}^*}
% \newcommand{\timesMT}{\timesM {}^T}
% \newcommand{\timesMR}{\timesM {}^{R}}
% \newcommand{\timesfMR}{\timesM {}^{*R}}
% \newcommand{\crffM}{\,\widetilde{\smash[t]{\underline{\smash[b]{\!\times\!}}{}}}{}^{\,*}}
% \newcommand{\crffMR}{\,\widetilde{\smash[t]{\underline{\smash[b]{\!\times\!}}{}}}{}^{\,*R}}

\newcommand{\timesf}{{\times}^*}

% For SO partials
\newcommand{\dtaudqSO}[3]{\frac{\partial ^{2} \taubar_{#1}}{\partial \q_{#2} \partial \q_{#3}}}

\newcommand{\dtaudqdSO}[3]{\frac{\partial ^{2} \taubar_{#1}}{\partial \qd_{#2} \partial \qd_{#3}}}

\newcommand{\dtaudqdMSO}[3]{\frac{\partial ^{2} \taubar_{#1}}{\partial \q_{#2} \partial \qd_{#3}}}

% tensor
\newcommand{\Bicphi}[2]{\mathcal{B}_{#1}^C[\Phibar_{#2}]}
% tensor
\newcommand{\Bicpsiidot}[2]{\mathcal{B}_{#1}^{C}\big[\Psibardot_{#2}\big]}

% matrix
\newcommand{\Bicphip}[1]{\B_{#1}^C[\phibar_{#1,p}]}
%matrix
\newcommand{\Bicpsiidotp}[1]{\B_{i}^{C}\big[\psibardot_{#1,p}\big]}


% M FO commands

\newcommand{\dMdq}[3]{\frac{\partial  \M_{#1,#2}}{\partial \q_{#3} }}
...
\newcommand{\Jc}{\J_{c}}
\newcommand{\Jdc}{\dot{\J_{c}}}
\newcommand{\lambdah}{\hat{\lambda}}
% selector matrix
\renewcommand{\S}{\mathbf{S}\T}


% MDDP variables
\newcommand{\uM}{\mathbf{u}}
\newcommand{\XMD}{\mathbf{X}}
