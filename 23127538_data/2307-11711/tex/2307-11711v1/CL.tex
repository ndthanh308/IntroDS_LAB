...
While our results are presented based on 1000 simulations, they can be easily extrapolated to the projected number of clusters in CMB S4, estimated to be $10^5$. By employing the MAP estimator for $10^5$ clusters, the mass can be impressively constrained, achieving a remarkable accuracy down to 0.47\% for our ideal scenario where no mis-centering or foreground effects are present.
