...
\resizebox{.95\linewidth}{!}{\begin{minipage}{\linewidth}
    ...
    \hline
     ...
     \hline
    \end{tabular}
    \caption{Summarizing which spin point groups have new (co-)irrep content. For those with existing (co-)irreps, the reader is referenced to the appropriate group's (co-)irreps. For the collinear groups, see Appendix \ref{app:colinirreptables}.}
     \label{tab:coirrsum}
    \end{minipage}}
\end{table}
