...
Upon completion of this work, three independent groups posted preprints to the arXiv preprint server that provide a discussion and enumeration of spin-space groups \cite{xiao2023spin,ren2023enumeration,jiang2023enumeration,chenmagnon2023}. References \cite{xiao2023spin,ren2023enumeration,chenmagnon2023} contain discussions of the representation theory of these groups that has some overlap with the results contained here. 

\section*{Acknowledgements} 

PM would like to thank Jeff Rau and Pedro Ribeiro for useful discussions. The authors acknowledge use of the \textsc{GTPack} \cite{GTPack} Mathematica group theory package developed by W. Hergert and M. Geilhufe.
