...
\title{\LARGE{\bf Coupled thermoelastic isotropic laminates}\bigskip\\\large{- PREPRINT -}}

%%%%% Authors
\author{Paolo Vannucci\\ 
\begin{small}LMV - Laboratoire de Mathématiques de Versailles, UMR8100.\\Université de Versailles et Saint Quentin - \href{mailto:paolo.vannucci@uvsq.fr}{paolo.vannucci@uvsq.fr}\end{small}}
