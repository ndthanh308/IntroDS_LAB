...
\begin{abstract}
  ...
  This is an extended version of a perspective article
  \cite{JaegerNohedaVdWiel22a} that will appear in Nature
  Communications soon after this manuscript goes public on arxiv.  
\end{abstract}
...
acknowledged. Finally, we want to thank the anonymous reviewers of the
short journal version \cite{JaegerNohedaVdWiel22a} of this arXiv article for
their extensive, insightful and constructive feedback. In this long
version we could  accomodate all of their valuable
suggestions.
