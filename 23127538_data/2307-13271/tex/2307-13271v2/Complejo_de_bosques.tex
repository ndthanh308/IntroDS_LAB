...
known fact about homotopy push-out (see \citep{indcomplcartprod} for a proof).
...
contractible or empty, $X_i$ is connected for all $i$ and there is a graph $G$ of size $k$ and a 
...
\begin{itemize}
    ...
    \item $(uv)(vw)=uw$ if $\{u,v,w\}$ is a simplex of $\mathcal{F}_2(G)$.
\end{itemize}
we have that $H_T\cong\pi_1\left(\mathcal{F}_2(G)\right)$ (see \citep{rotmantop} Theorem 7.34).
