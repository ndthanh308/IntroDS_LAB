...
\begin{equation*}
\xymatrix{
X \cap Y \cap Z \ar@{->}[rr] \ar@{->}[dr] \ar@{->}[dd] & & Y \cap Z \ar@{->}[dd] \ar@{->}[rd] & & \\
 & X \cap Z \ar@{->}[rr] \ar@{->}[dd] & & P \ar@{->}[r] \ar@{->}[dd] & Z \ar@{->}[dd] \\
...
\begin{prop}
For $d\leq n$,
$$\aste{Z}_{_{sk_d\Delta^n}}\left(\bigvee_{r-1}\mathbb{S}^0,\emptyset\right)\simeq\bigvee_{f_d(r,n)}\mathbb{S}^d,$$
where
...
$$\aste{Z}_{_{sk_d\Delta^n}}\left(X,\emptyset\right)\simeq\bigvee_{\binom{n+1}{2}r^2-(n+1)r+1}\mathbb{S}^1.$$
...
$$\aste{Z}_{_{sk_d\Delta^n}}\left(X,\emptyset\right)=\left[\left(\bigvee_{r-1}\mathbb{S}^0\right)*\aste{Z}_{_{sk_{d-1}\Delta^{n-1}}}\left(X,\emptyset\right)\right]\bigcup\aste{Z}_{_{sk_d\Delta^{n-1}}}\left(X,\emptyset\right).$$
Since the intersection of those two subcomplexes is $\aste{Z}_{_{sk_{d-1}\Delta^{k-1}}}\left(X,\emptyset\right)$, we can conclude that $\aste{Z}_{_{sk_d\Delta^n}}\left(X,\emptyset\right)$ is homotopy equivalent to the homotopy pushout of 
\begin{equation*}
    \xymatrix{
...
$$X=V\left(K_r^0\right)*\aste{Z}_{_{sk_{d-1}\Delta^{n-1}}}(sk_0K_r,\emptyset),
...
$$X\cap Z=\aste{Z}_{_{sk_{d-1}\Delta^{n-1}}}(sk_0K_r,\emptyset)\simeq\bigvee_{f_{_{d-1}}(r,n-1)}\mathbb{S}^{d-1}$$
...
$$X=\aste{Z}_{_{\Delta^n}}(sk_0K_r,\emptyset)\simeq\bigvee_{(r-1)^{n+1}}\mathbb{S}^n.$$
As before, $Y\cap Z=\emptyset$, $X\cap Y=sk_0Y$ and 
$$X\cap Z=\aste{Z}_{_{\Delta^{n-1}}}(sk_0K_r,\emptyset)\simeq\bigvee_{(r-1)^n}\mathbb{S}^{n-1}.$$
...
%$$\mathcal{F}_\infty(K_{n,m}\circ K_r)\simeq\bigvee_{\binom{r-1}{2}^n}\mathbb{S}^{2n-1}\vee\bigvee_{\binom{r-1}{2}^m}\mathbb{S}^{2m-1}\vee\bigvee_{(r-1)^n}\mathbb{S}^n\vee\bigvee_{(r-1)^m}\mathbb{S}^m\vee\aste{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(sk_0K_r,\emptyset\right)$$
%and
...
$$X=\aste{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(sk_0K_r,\emptyset\right),\;Y=\aste{Z}_{_{\Delta^U}}\left(K_r,\emptyset\right),\;W=\aste{Z}_{_{\Delta^V}}\left(K_r,\emptyset\right),$$
we have that $\mathcal{F}_\infty(K_{n,m}\circ K_r)=X\cup Y\cup W$. Now, $Y\cap W=X\cap Y\cap W=\emptyset$ and
$$X\cap Y=\aste{Z}_{_{\Delta^U}}\left(sk_0K_r,\emptyset\right), \;X\cap W=\aste{Z}_{_{\Delta^V}}\left(sk_0K_r,\emptyset\right).$$
...
$\Sigma\aste{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(sk_0K_r,\emptyset\right)$. Now, 
$$\Sigma\aste{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(sk_0K_r,\emptyset\right)\simeq\hat{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(\bigvee_{r-1}\mathbb{S}^1,\mathbb{S}^0\right)$$
Because the inclusion of $\mathbb{S}^0$ in a wedge of copies of $\mathbb{S}^1$ is null-homotopic, we have that 
$$\hat{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(\bigvee_{r-1}\mathbb{S}^1,\mathbb{S}^0\right)\simeq\Sigma\mathcal{F}_\infty(K_{n,m})\vee\bigvee_{\sigma\in\mathcal{F}_\infty(K_{n,m})}lk(\sigma)*\hat{D}(\sigma).$$
We have $\displaystyle\hat{D}=\bigwedge_{|\sigma|}\bigvee_{r-1}\mathbb{S}^1\simeq\bigvee_{(r-1)^{|\sigma|}}\mathbb{S}^{|\sigma|}$, and thus
$$\hat{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(\bigvee_{r-1}\mathbb{S}^1,\mathbb{S}^0\right)\simeq\Sigma\mathcal{F}_\infty(K_{n,m})\vee\bigvee_{\sigma\in\mathcal{F}_\infty(K_{n,m})}\left(\bigvee_{(r-1)^{|\sigma|}}\Sigma^{|\sigma|+1}lk(\sigma)\right).$$
...
Therefore:
$$\hat{Z}_{_{\mathcal{F}_\infty(K_{n,m})}}\left(\bigvee_{r-1}\mathbb{S}^1,\mathbb{S}^0\right)\simeq\bigvee_{c}\mathbb{S}^3\vee\bigvee_{a'}\mathbb{S}^{n+1}\vee\bigvee_{b'}\mathbb{S}^{m+1},$$
...
%$$\mathcal{F}_\infty(G)\simeq\bigvee_{i=1}^k\left(\bigvee_{\binom{r-1}{2}^{n_i}}\mathbb{S}^{2n_i-1}\vee\bigvee_{(r-1)^{n_i}}\mathbb{S}^{n_i}\right)\vee\aste{Z}_{_{\mathcal{F}_\infty(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right)$$
%and
...
\end{theorem}
\begin{proof}
$$\mathcal{F}_\infty(G)=\aste{Z}_{_{\mathcal{F}_\infty(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right)\cup\bigsqcup_{i=1}^k\aste{Z}_{_{\Delta^{V_i}}}\left(K_r,\emptyset\right)$$
For all $i$, 
$$\aste{Z}_{_{\mathcal{F}_\infty(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right)\cap \aste{Z}_{_{\Delta^{V_i}}}\left(K_r,\emptyset\right)=\aste{Z}_{_{\Delta^{V_i}}}\left(sk_0K_r,\emptyset\right).$$
As in the proposition before, we take $v\in V_j$ with $j\neq i$. Then the inclusion factors as
$$\aste{Z}_{_{\Delta^{V_i}}}\left(sk_0K_r,\emptyset\right)\longhookrightarrow \aste{Z}_{_{\Delta^{V_i\cup\{v\}}}}\left(sk_0K_r,\emptyset\right)\longhookrightarrow\aste{Z}_{_{\mathcal{F}_\infty(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right),$$
and is thus null-homotopic. Therefore,
$$\mathcal{F}_\infty(G)\simeq\aste{Z}_{_{\mathcal{F}_\infty(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right)\vee\bigvee_{i=1}^k\left(\aste{Z}_{_{\Delta^{V_i}}}\left(K_r,\emptyset\right)\vee\Sigma\aste{Z}_{_{\Delta^{V_i}}}\left(sk_0K_r,\emptyset\right)\right).$$
For the suspension, as in the last proposition, we have that
$$\Sigma\aste{Z}_{_{\mathcal{F}_\infty(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right)\simeq\Sigma\mathcal{F}_\infty(K_{n_1,\dots,n_k})\vee\bigvee_{\sigma\in\mathcal{F}_\infty(K_{n_1,\dots,n_k})}lk(\sigma)*\aste{D}(\sigma)$$
...
\begin{proof}
Assume $U=\{u_1,\dots,u_n\}$ and $V=\{v_1,\dots,v_m\}$ are the partition of the vertices of $K_{n,m}$. Taking
$$X=\aste{Z}_{_{\mathcal{F}_d(K_{n,m})}}\left(sk_0K_r,\emptyset\right),\;Y=\aste{Z}_{_{\Delta^U}}\left(K_r,\emptyset\right),\;W=\aste{Z}_{_{\Delta^V}}\left(K_r,\emptyset\right),$$
we have that $\mathcal{F}_d(K_{n,m}\circ K_r)=X\cup Y\cup W$. Now, $Y\cap W=X\cap Y\cap W=\emptyset$ and
$$X\cap Y=\aste{Z}_{_{\Delta^U}}\left(sk_0K_r,\emptyset\right), \;X\cap W=\aste{Z}_{_{\Delta^V}}\left(V(K_r),\emptyset\right).$$
...
$$\Sigma\aste{Z}_{_{K}}\left(\underline{L},\underline{\emptyset}\right)\simeq\Sigma\mathcal{F}_d(K_{n,m})\vee\bigvee_{\sigma\in K}\bigvee_{(r-1)^{|\sigma|}}\Sigma^{|\sigma|+1}lk(\sigma).$$
...
(see \cite{forestfilt}). These the result follows from all these.
\end{proof}
...
$$\mathcal{F}_d(G)=\aste{Z}_{_{\mathcal{F}_d(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right)\cup\bigsqcup_{i=1}^k\left(\bigast_{n_i}K_r\right).$$
For all $1\leq i\leq k$,
$$\aste{Z}_{_{\mathcal{F}_d(K_{n_1,\dots,n_k})}}\left(sk_0K_r,\emptyset\right)\cap\bigast_{n_i}K_r=\aste{Z}_{_{\Delta^{V_i}}}\left(sk_0K_r,\emptyset\right),$$
and the inclusion $\displaystyle\aste{Z}_{_{\Delta^{V_i}}}\left(sk_0K_r,\emptyset\right)\longhookrightarrow\bigast_{n_i}K_r$ is 
...
\end{itemize}
As before,
$$\Sigma\aste{Z}_{_{K}}\left(\underline{L},\underline{\emptyset}\right)\simeq\Sigma K\vee\bigvee_{\sigma\in K}\bigvee_{(r-1)^{|\sigma|}}\Sigma^{|\sigma|+1}lk(\sigma).$$
...
(see \citep{forestfilt}). The result follows from all these.
\end{proof}
