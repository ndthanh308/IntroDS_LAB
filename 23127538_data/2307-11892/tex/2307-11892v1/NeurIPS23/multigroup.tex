...
In this paper, for ease of presentation we will focus on the disjoint case of binary groups i.e. two groups. 
...
The elegant and contemporary approach in \cite{multicalib} by defining relevant groups with a computationally rich class $C$ handles the issue of group and sub-group 
