...
\geometry{paperheight=9.72in, paperwidth=6.85in}
...
The condition on sector angles is 
\begin{equation*}
	f_{22}=0, ~~ f_{20}=0,~~f_{02}=0 ~~ \Leftrightarrow ~~  \alpha=\beta=\gamma=\delta
\end{equation*}
which means:
...
This is the most general case with no extra condition on the sector angles. 
\begin{equation*} 
	f_{22} \neq 0, ~~ f_{20} \neq 0 , ~~ f_{02} \neq 0 ~~ \Leftrightarrow ~~ \begin{dcases}
		\alpha - \beta + \gamma - \delta \neq 0 \\
		\alpha - \beta - \gamma + \delta \neq 0 \\
...
\end{prop} 
\begin{proof}
	(1) and (2) can be verified by direct calculation. (3) and (4) could be proved by rewritten the addition formulas.
	\begin{equation*}
		\begin{gathered}
