...
Similarly, the Hawk-eye system~\cite{owens2003hawk} 
...
ens2021grand}. 
%
IA offers several advantages over traditional desktop visualizations~\cite{kraus2022immersive} due to its large screen spaces and embodied interaction offered by AR/VR technologies: immersion~\cite{millais2018exploring, helbig2014concept}, multi-modal interaction~\cite{butscher2018clusters, lopez2015towards, ready2018immersive}, and presenting data in-situ~\cite{benko2004collaborative, hachet2011toucheo, moran2015improving}, which improves spatial understanding and user experience throughout the visual analysis process.
%
...
With these identified benefits of IA, recent works investigate applying immersive analytics to sports~\cite{lin2020sportsxr}. Besides ShuttleSpace~\cite{ye2020shuttlespace} and TIVEE~\cite{chu2021tivee} for badminton shuttle trajectory analysis in VR, 
