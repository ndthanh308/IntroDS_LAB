...
\label{sec:findings}
Overall, we observed coaching practices vary widely among the interviewees due to varying resource levels, player skill levels, and coach style. 
...
Therefore, the current way of presenting data and video separately may impede a holistic understanding of the game due to inefficient workflow.
...
strengths and weaknesses of the players and develop playing
