...
Furthermore, our works demonstrates that it is possible to rigorously show that control variates can accelerate the convergence of BBVI.
It will be interesting to analyze and compare the existing control variates by~\citet{miller_reducing_2017, geffner_approximation_2020, wang_dual_2023}.
