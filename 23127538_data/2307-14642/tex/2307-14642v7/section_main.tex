...
\begin{definition}
    \(\pi\) is said to be \(\mu\)-strongly log-concave if its negative log-density \(V = -\log \pi\) satisfies the inequality
{%
\setlength{\abovedisplayskip}{.5ex} \setlength{\abovedisplayshortskip}{.5ex}
\setlength{\belowdisplayskip}{1.ex} \setlength{\belowdisplayshortskip}{1.ex}
    \[
...
\end{definition}
Essentially, this assumes that the negative log-density of \(\pi\), $V$, is \(\mu\)-strongly convex.
