...
The bottom few rows are shown for comparison. \upgreen{$\uparrow$}/\downred{$\downarrow$} marks the ones with better/worse cross-dataset performance compared to the zero-shot version Alpaca$_{ZS}$.
}
