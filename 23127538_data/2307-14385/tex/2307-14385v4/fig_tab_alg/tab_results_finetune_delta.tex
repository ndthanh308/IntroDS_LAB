...
\centering
\caption{
Balanced Accuracy Performance Change with Instruction Finetuning. This table is calculated between the finetuning and zero-shot section, as well as the finetuning and few-shot section of Table~\ref{tab:results_overall_short}. GPT-3.5$_{Best}$ and GPT-4$_{Best}$ are the best results among zero-shot and few-shot settings.
}
