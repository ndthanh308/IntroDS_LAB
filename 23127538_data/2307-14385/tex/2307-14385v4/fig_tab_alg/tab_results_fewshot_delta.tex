...
\centering
\caption{
Balanced Accuracy Performance Change with Few-shot Prompting. This table is calculated between the zero-shot and the few-shot sections of Table~\ref{tab:results_overall_short}.
}
