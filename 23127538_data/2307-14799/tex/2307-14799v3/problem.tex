...
An operation $m[j_s]=\{s\}$ constitutes a \emph{setup violation} for
$s\in\mathbb{N}$ if % $m[j_s]=\{s\}$ for some $j_s<j$ 
$m[j]\in\mathbb{N}$ for some $j>j_s$ indicates a setup change such that
