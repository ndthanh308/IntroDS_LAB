...
\textbf{Physics-Informed Neural Networks (PINNs).} Physics-Informed Neural Networks (PINNs) have emerged as a promising approach for tackling scientific and engineering problems.~\cite{raissi2019physics} introduced the framework that incorporates physical laws into the neural network training to solve PDEs. This work has led to applications across diverse domains, including fluid dynamics, solid mechanics, and quantum mechanics~\citep{carleo2019machine, yang2020physics}. Researchers have investigated different learning schemes for PINNs~\citep{mao2020physics, wang2021understanding, wang2022and}, which have yielded substantial improvements in convergence, generalization, and interpretability.
