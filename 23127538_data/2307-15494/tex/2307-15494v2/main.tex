...
%\usepackage{NEURIPS2023/neurips_2023}
...
\author{%
  ...
  Daniel Hernandez,
  Ozan Vardal,
  Sondess Missaoui, and James Alfred Walker \\
  Department of Computer Science\\
  University of York\\
  York, UK \\
  %Pittsburgh, PA 15213 \\
  \texttt{kevin.denamganai@york.ac.uk}, \\ \texttt{daniel.hernandez@sony.com}, \texttt{ozan.vardal@york.ac.uk}, \\ \texttt{sondess.missaoui@york.ac.uk}, \texttt{james.walker@york.ac.uk}
%   Kevin DENAMGANAÏ\\
%   Department of Computer Science\\
%   University of York\\
%   York, UK \\
...
\input{parts/broader-impact}
\input{parts/implementation-details}
\input{parts/higher-ablation-study}

\include{parts/ether-algorithm}
\input{parts/ether-referential-game}

%\input{parts/co-occurrence-grounding}
\input{parts/co-occurrence-hypothesis}
\include{parts/semantic-co-occurrence-figures}
