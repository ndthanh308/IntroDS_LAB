...
Despite the use of the semantic co-occurrence grounding loss, the issue of how to constrain the emergent language to be as close as possible to the benchmark language, or natural languages broadly, remains. 
...
We suggest that future work uses the listener agent of the referential game to learn, in an unsupervised fashion, a predicate function that can be used in place of the partial predicate function built here, for the purpose of hierarchical RL too.
Indeed, following the approaches in \citet{levy2018hierarchical} and \citet{MulBouchacourtBruni2019}, we plan to investigate the use of emergent language utterances as options to a hierarchical reinforcement learning architecture where only the option-following part of the policy (conditioned on emergent language utterances) is trained with a hindsight experience replay scheme as a pre-training taking place before the option-selecting part of the policy (conditioned on the actual episode's instruction) is trained.
