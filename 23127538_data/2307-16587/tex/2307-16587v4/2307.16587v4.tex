...
The following two conditions on the triple
\\
 $(G, \pi_1, \pi_2)$
 are equivalent:
\\
...
\end{equation}
for $g^{-1}=\begin{pmatrix} a & b \\ c & d \end{pmatrix}$.  
...
The operators $\{R_{\ell}\}_{\ell \in {\mathbb{N}}}$ are differential SBO
 for the fusion rule 
of the two Hardy spaces, 
see \cite{vDP, KPgen, xRa56} for instance.  
...
Let 
\[
  I_{1,1}:=\begin{pmatrix} 1 & \\ & -1\end{pmatrix} \in {\mathfrak{s l}}(2,{\mathbb{R}}), \quad
...
\quad
g H \mapsto \operatorname{Ad}(g)I_{1,1}
...
In the right-hand side
 $\pi_{2\ell+2}^+$ is the holomorphic discrete series representation
 with minimal $K$-type $\chi_{2\ell+2}$, 
 and $\pi_{2\ell+2}^-$ is its contragredient representation.  
By an abuse of notation, 
 we write $\varpi_{1+\sqrt{-1} \nu}$
 for the spherical unitary principal series representation of $G$, 
 obtained as the unitarization
 of $\varpi_{1+\sqrt{-1} \nu}^+$ of $G$, 
 see \eqref{eqn:ps}.  
...
on the Hilbert space $L^2(G/P, {\mathcal{L}})$ 
...
is not true 
 ...
 of eigenfunctions in Theorem \ref{thm:230626_SB}.  
...
Then the assertion \eqref{eqn:23062618} holds
 because 
\[
...
\int_0^{\infty} \frac{t^{\lambda}}{t+w} d t=
 \int_\gamma \frac{(sw)^{\lambda}}{s+1}ds,
\]
...
The sheaf ${\mathcal{B}}$ of hyperfunctions is defined
 as local cohomology group.  
...
\bibitem{vDP}
G.\ van Dijk, M.\ Pevzner, 
{\textit{Ring structures for holomorphic discrete series
 and Rankin--Cohen bracket}}, 
 J.\ Lie Theory {\bf{17}}, 
 (2007), 283--305.  

\bibitem{xfar}
J.~Faraut, 
{\textit{Distributions sph{\'e}riques sur les espaces hyperboliques}}, 
...
\bibitem{TK22}
T.\ Kobayashi, 
{\textit{Bounded multiplicity theorems for induction and restriction}}, 
 J.\ Lie Theory {\bf{32}} (2022), no.\ 1, 197--238.  

\bibitem{TK23}
T.\ Kobayashi, 
{\textit{Bounded multiplicity branching for symmetric pairs}}, 
...
\bibitem{KP24}
T.~Kobayashi, M.~Pevzner,
\textit{A short proof for Rankin--Cohen brackets and generating operators}, 
 to appear in PROMS, Springer-Nature. 
Available also at arXiv: 2402.05363.  
...
\bibitem{xsato}
M.~Sato, 
{\textit{Theory of hyperfunctions}}. I, 
