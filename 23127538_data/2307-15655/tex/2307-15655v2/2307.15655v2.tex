...
\address[A.\,Maione]{Abteilung f\"{u}r Angewandte Mathematik\newline\indent Albert-Ludwigs-Universit\"{a}t Freiburg \newline\indent Hermann-Herder-Strasse 10, 79104 Freiburg i. Br., Germany}
%\address[A.\,Maione]{Centre de Recerca Matemàtica%\newline\indent Albert-Ludwigs-Universit\"{a}t Freiburg 
%\newline\indent Edifici C, Campus Bellaterra, 08193 Bellaterra, Spain}
\email{amaione@crm.cat}
...
\subsection*{Funding}
The authors are members and acknowledge the support of {\it Gruppo Nazionale per l’Analisi Matematica, la Probabilità e le loro Applicazioni} (GNAMPA) of {\it Istituto Nazionale di Alta Matematica} (INdAM).

N.~Cangiotti acknowledges the support of the MIUR - PRIN 2017 project ``From Models to Decisions" (Prot. N. 201743F9YE).

M.~Caponi acknowledges the support of the project STAR PLUS 2020 - Linea~1 (21-UNINA-EPIG-172) ``New perspectives in the Variational modeling of Continuum Mechanics'', and of the MIUR - PRIN 2017 project ``Variational Methods for Stationary and Evolution Problems with Singularities and Interfaces'' (Prot. N.~2017BTM7SN).

A.~Maione acknowledges the support of the DFG SPP 2256 project ``Variational Methods for Predicting Complex Phenomena in Engineering Structures and Materials'' (Project number 422730790) and the support of the University of Freiburg.
...
E.~Vitillaro is supported by the MIUR - PRIN 2022 project ''Advanced theoretical aspects in PDEs and their applications'' (Prot. N.  2022BCFHN2) and by``Progetti Equazioni delle onde con condizioni iperboliche ed acustiche al bordo,  finanziati  con  i Fondi  Ricerca  di Base 2017--2022, della Universit\`a degli Studi di Perugia''.

% A. Maione acknowledges the support provided to the Centre de Recerca Matemàtica by the María de Maeztu Award. This work is supported by the Spanish State Research Agency, through the Severo Ochoa and María de Maeztu Program for Centers and Units of Excellence in R\&D (CEX2020-001084-M).
% He also thanks CERCA Programme/Generalitat de Catalunya for institutional support.
...
\bibitem{AR}
{\sc A. Ambrosetti, and P.H. Rabinowitz},
{\em Dual variational methods in critical point theory and applications}, J. Functional Analysis \textbf{14}, 349--381 (1973)

\bibitem{Ambrosio2016}
{\sc V. Ambrosio}, \emph{Ground states for superlinear fractional {S}chr\"{o}dinger equations in {${\bf R}^N$}}, Ann. Acad. Sci. Fenn. Math. \textbf{41}(2), 745--756 (2016)

\bibitem{Azzolini08}
{\sc A. Azzollini, and A. Pomponio}, \emph{Ground state solutions for the nonlinear {S}chr\"{o}dinger-{M}axwell equations}. J. Math. Anal. Appl. \textbf{345}(1), 90--108 (2008)

\bibitem{BF98}
{\sc V. Benci, and D. Fortunato}, \emph{An eigenvalue problem for the {S}chr\"{o}dinger-{M}axwell equations}, Topol. Methods Nonlinear Anal. \textbf{11}(2), 283--293 (1998)

\bibitem{CCMV23}
{\sc N. Cangiotti, M. Caponi, A. Maione, and E. Vitillaro}, {\em Klein-Gordon-Maxwell equations driven by mixed local-nonlocal operators}, Milan J. Math. (2023). https://doi.org/10.1007/s00032-023-00387-0

\bibitem{Chen09}
{\sc S.-J. Chen, and C.-L. Tang}, \emph{High energy solutions for the superlinear {S}chr\"{o}dinger-{M}axwell equations}, Nonlinear Anal. \textbf{71}(10), 4927--4934 (2009)

\bibitem{Chiao64}
{\sc R.Y. Chiao, E. Garmire, and C.H. Townes}, \emph{Self-Trapping of Optical Beams}, Phys. Rev. Lett. \textbf{13}(15), 479--482 (1964)

\bibitem{Coclite04}
{\sc G.M. Coclite, and V. Georgiev}, \emph{Solitary waves for {M}axwell-{S}chr\"{o}dinger equations}, Electron. J. Differential Equations, No. 94, 31pp. (2004)

\bibitem{Dap1}
{\sc T. D’Aprile, and D. Mugnai},
{\em Solitary waves for nonlinear {K}lein-{G}ordon-{M}axwell and {S}chr\"{o}dinger-{M}axwell equations}, Proc. Roy. Soc. Edinburgh Sect. A \textbf{134}(5), 893--906 (2004)

\bibitem{Dap2}
{\sc T. D’Aprile, and D. Mugnai},
{\em Non-existence results for the coupled Klein-Gordon-Maxwell equations}, Adv. Nonlinear Stud. \textbf{4}(3), 307--322 (2004)

\bibitem{dAvenia02}
{\sc P. D’Avenia}, \emph{Non-radially symmetric solutions of nonlinear {S}chr\"{o}dinger equation coupled with {M}axwell equations}, Adv. Nonlinear Stud. \textbf{2}(2), 177--192 (2002)

\bibitem{DRV}
{\sc E. Di Nezza, G. Palatucci, and E. Valdinoci}, {\em Hitchhiker's guide to the fractional Sobolev spaces}, Bull. Sci. Math. \textbf{136}(5), 521--573 (2012)

\bibitem{Esteban89}
{\sc M.J. Esteban, and P.L. Lions}, \emph{Stationary solutions of nonlinear {S}chr\"{o}dinger equations with an external magnetic field}. In: Brezis, H. (ed) Partial differential equations and the calculus of variations, {V}ol. {I}, 401--449, Progr. Nonlinear Differential Equations Appl. \textbf{1}, Birkh\"{a}user Boston, Boston, MA (1989)

\bibitem{Felsager81}
{\sc B. Felsager}, \emph{Geometry, Particles and Fields}, Odense University Press, Odense (1981)

\bibitem{Ginzburg1950}
{\sc V.~L.~Ginzburg, and L.~D.~Landau}, \emph{On the Theory of Superconductivity}, Zh. Eksp. Teor. Fiz. \textbf{20}, 1064--1082 (1950)

\bibitem{Ginzburg1958}
{\sc V.~L.~Ginzburg, and L.~P.~Pitaevskii}, \emph{On the Theory of superfluidity}, Soviet Physics JETP \textbf{34}(7), 858--861 (1240--1245 \v{Z}. Eksper. Teoret. Fiz.) (1958)

\bibitem{GMV}
{\sc G. Giovannardi, D. Mugnai, and E. Vecchi}, {\em An {A}hmad-{L}azer-{P}aul-type result for indefinite mixed local-nonlocal problems}, J. Math. Anal. Appl. \textbf{527}(2), Paper No. 127442, 16 pp. (2023)

\bibitem{Laskin02}
{\sc N. Laskin}, \emph{Fractional {S}chr\"{o}dinger equation}, Phys. Rev. E (3) \textbf{66}(5), 056108, 7 pp. (2002)

\bibitem{MMV}
{\sc A. Maione, D. Mugnai, and E. Vecchi}, {\em Variational methods for nonpositive mixed local--nonlocal operators}, Fract. Calc. Appl. Anal. {\bf 26}(3), 943--961 (2023)

\bibitem{Pierantoni08}
{\sc L. Pierantoni, D. Mencarelli, and T. Rozzi}, \emph{A New 3-D Transmission Line Matrix Scheme for the Combined Schr\"odinger–Maxwell Problem in the Electronic/Electromagnetic Characterization of Nanodevices}, IEEE Transactions on Microwave Theory and Techniques \textbf{56}(3), 654--662 (2008)

\bibitem{Pierantoni09}
{\sc L. Pierantoni, D. Mencarelli, and T. Rozzi}, \emph{Boundary Immittance Operators for the Schr\"odinger–Maxwell Problem of Carrier Dynamics in Nanodevices}. IEEE Transactions on Microwave Theory and Techniques \textbf{57}(5), 1147--1155 (2009)

\bibitem{Rabinowitz86}
{\sc P.H. Rabinowitz}, {\em Minimax methods in critical point theory with applications to differential equations}, CBMS Regional Conference Series in Mathematics \textbf{65}, Providence, RI (1986)

\bibitem{Ruiz06}
{\sc D. Ruiz}, \emph{The {S}chr\"{o}dinger-{P}oisson equation under the effect of a nonlinear local term}, J. Funct. Anal. \textbf{237}(2), 655--674 (2006)

\bibitem{Secchi04}
{\sc S. Secchi}, \emph{Ground state solutions for nonlinear fractional {S}chr\"{o}dinger equations in {$\mathbb{R}^N$}}, J. Math. Phys. \textbf{54}(3), 031501, 17 pp. (2013)

\bibitem{Zhang16}
{\sc J. Zhang, J.M. do Ó, and M. Squassina}, \emph{Fractional {S}chr\"{o}dinger-{P}oisson systems with a general subcritical or critical nonlinearity}, Adv. Nonlinear Stud. \textbf{16}(1), 15--30 (2016)

\bibitem{Zhao08}
{\sc L. Zhao, and F. Zhao}, \emph{On the existence of solutions for the {S}chr\"{o}dinger-{P}oisson equations}, J. Math. Anal. Appl. \textbf{346}(1), 155--169 (2008)
