\documentclass[aps,prd,twocolumn,nofootinbib,notitlepage]{revtex4-1}
...
This position is defensible even if we need PA to describe the world, but it becomes much more intuitive if we are able to completely capture physical reality using mathematics that is complete and decidable, such as Presburger arithmetic (PrA) \cite{presburger1929uber,haase}.
...
Modular addition can be included, therefore PrA suffices to capture the evolution on a toroidal lattice that is used in this model.
