...
\begin{sidewaystable*}
    ...
    \begin{tabular}{|p{2.7cm}|p{1.6cm}|p{2.2cm}|p{2cm}|p{2cm}|p{2cm}|p{1.5cm}|p{1.5cm}|p{1.3cm}|}
        \toprule
...
mTEC~\citep{bhattacharya_betz_eggert_schlaefer_2021} & Polyp, Instrument	& DPRA-EdgeNet	 &  HarDNet & Cascade	& DSC and mIoU &	No	& --- & ---	\\ \hline
MedSeg\_JU \citep{Banik2021}	  & Instrument	&  EM-Net	&  EfficientNet-B3	&  Encoder-decoder & DSC	& Yes	& DSC & 	Adam	\\ \hline
MAHUNM~\citep{Haithami2021} & 	Polyp, Instrument	&  DeeplabV3 with GRU	& ResNet-50/ResNet-101	& Sequential	& DSC  and mIoU	& No	& ---	& ---	\\\hline											IIAI-CV\&Med~\citep{Dong2021}& Polyp, Instrument	& Polyp-PVT, Sinv2-PVT and Transfuse- PVT	& Transformer & 	Ensemble & 	Majority voting	& No & 	IoU & 	Adam\\ \hline	
...
CV\&Med IIAI~\citep{Chou2021} & Polyp, Instrument	& SINetv2	& PVT v2 & Encoder-decoder&  mIoU	& No	&  PPA loss	& ---		\\ \hline
...
NAAMII~\citep{Rauniyar2021} & Polyp, Instrument	& U2Net	& None & Encoder-decoder&  mIoU	& Yes	& Mean Squared Error, Cross-entropy	& Adam		\\\hline	
 \bottomrule
    \end{tabular}
\end{sidewaystable*}
