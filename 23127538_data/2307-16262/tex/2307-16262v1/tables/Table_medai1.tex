...
\begin{table*}[!t]
    \centering
    \caption{Performance of teams in polyp segmentation task of MedAI:Transperancy in Medical Image Segmentation (MedAI 2021)}\label{table:medai}
    \begin{tabular}{ l l l l l l l l }
        \toprule
        Team Name  	& Accuracy $\uparrow$	& mIoU $\uparrow$  & DSC $\uparrow$ & Recall $\uparrow$ & Precision $\uparrow$ \\ \midrule
        
        
        agaldran  &	\textbf{0.9791} & 	\textbf{0.8522} &	\textbf{0.8965}  &	\textcolor{red}{0.9009}	& \textcolor{red}{0.9242} \\
        
        
        IIAI-CV\&Med	& 0.9593	& 0.8361	& \textcolor{red}{0.8927}		& \textbf{0.9195}	& 0.8963 \\

        
        NYCity	&0.9735&	\textcolor{red}{0.8418} &	0.8885		&0.8794&	\textbf{0.9319}\\
        mTEC&	0.9679	&0.8334	&0.8892	&0.9010	&0.9096\\
        CV\&Med IIAI	& \textcolor{red}{0.9766}	&0.8213	&0.8612		&0.8602	&0.8814\\
        ...
        %MAHUNM	&	0.9354	&0.5501	&0.6043	&0.6043	&0.5899	&0.7160\\
