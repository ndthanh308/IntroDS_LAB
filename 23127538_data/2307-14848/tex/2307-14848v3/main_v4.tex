...
\markboth{This paper has been submitted to IEEE Transactions on Wireless Communications. Copyright may change without notice.}%
%\markboth{IEEE Transactions on Mobile Computing,~Vol.~xx, No.~x, April 2022}%
{Testolina \MakeLowercase{\textit{et al.}}: Modeling Interference for the Coexistence of 6G Networks and Passive Sensing Systems}
...
% \centering\footnotesize This paper has been accepted for presentation at XXX. \textcopyright YEAR IEEE.\\
% Please cite it as: XXX}};
% \end{tikzpicture}
