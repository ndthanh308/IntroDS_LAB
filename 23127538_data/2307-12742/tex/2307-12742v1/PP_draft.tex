...
\end{equation}
where $\bm{S}$ is the second Piola-Kirchhoff stress tensor, while $\mathcal{S}_0$ encompasses the entropy sources, sinks, and fluxes that account for biochemical and cellular interactions. The material rate of Helmholtz free energy hence is given by
