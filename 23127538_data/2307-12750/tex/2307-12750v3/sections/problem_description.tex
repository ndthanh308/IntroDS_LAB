...
Given a desired end-effector pose, we address the problem of computing the joint configuration of the controlled arm that can attain this end-effector pose while avoiding collisions with the external arms.
