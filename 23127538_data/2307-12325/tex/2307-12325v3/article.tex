...
Under conditions: 
\begin{enumerate} 
\item[(i)] $G = \mathcal{O}(N^{\alpha}), 1\leq \alpha < 1.25$,
...
\begin{equation*}
	\begin{split}
    \sum\limits_{(i', j')\in A_{(i, j)}}w_{i'j'}\leq |A_{(i, j)}|\max\limits_{(i', j')\in A_{(i, j)}}w_{i'j'}=:|A_{(i, j)}|w_{\text{max}} = |A_{(i, j)}|w_{ij}\frac{w_{\text{max}}}{w_{ij}},
\end{split}
\end{equation*}
...
\begin{equation*}
	\begin{split}
&\sum\limits_{(i, j)\in G}w_{ij}|A_{(i, j)}|\sum\limits_{(i', j')\in A_{(i, j)}}w_{i'j'}\\= &\mathcal{O}(\sum\limits_{(i, j)\in G}w_{ij}^2|A_{(i, j)}|^2) \\=& \mathcal{O}(\sum\limits_{i=1}^N\sum\limits_{(i', j')\in G_i}w_{i'j'}^2|A_{(i', j')}|^2) \\=& \mathcal{O}(\sum\limits_{i=1}^N\sum\limits_{(i', j')\in G_i}w_{i'j'}^2|G_i|^2) \\\leq &\mathcal{O}(\sum\limits_{(i, j)\in G}w_{ij}^2)N^{2\alpha - 2}\\= &  o(\sum\limits_{(i, j)\in G}w_{ij}^2N^{0.5}).
\end{split}
\end{equation*}
