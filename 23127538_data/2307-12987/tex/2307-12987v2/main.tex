\documentclass[lettersize,journal, anonymous=true]{IEEEtran}
...
\newcommand*{\sysname}{DeepCal}

\begin{document}

% \linenumbers

% \title{Efficient and Explainable Calibration for Multi-agent Fintech Market Simulation}
\title{Deep Calibration of Multi-Agent Model for Simulating Real-World Stock Trading} 

\author{
    \IEEEauthorblockN{Tianlang He\IEEEauthorrefmark{1}, Keyan Lu\IEEEauthorrefmark{1},
    Xianfeng Jiao\IEEEauthorrefmark{2}, Tianfan Xu\IEEEauthorrefmark{2},
    Chang Xu\IEEEauthorrefmark{3}, Yang Liu\IEEEauthorrefmark{3}, Weiqing Liu\IEEEauthorrefmark{3}, \\
    S.-H. Gary Chan\IEEEauthorrefmark{1},
    Jiang Bian\IEEEauthorrefmark{3}} 
    \\\IEEEauthorblockA{\IEEEauthorrefmark{1}The Hong Kong University of Science and Technology} 
    \\\IEEEauthorblockA{\IEEEauthorrefmark{2}Peking University} 
    \\\IEEEauthorblockA{\IEEEauthorrefmark{3}Microsoft Research Asia} 
    \\\{theaf, klual, gchan\}@cse.ust.hk, \{jiaoxianfeng, xitianfan\}@stu.pku.edu.cn, \{chanx, yangliu2, weiqing.liu, jiang.bian\}@microsoft.com 
}
...
\begin{IEEEkeywords}
Fintech, Market simulation, Multi-agent model, Derivative-free optimization, Style transfer
\end{IEEEkeywords}

\input{Sections/intro}
\input{Sections/preliminary}
% \input{Sections/prob_form}
