...
\end{aligned}
\end{equation}
According to \cite{williams2006gaussian}, the marginal and conditional distribution of $\bm{x}$ are shown as
\begin{equation}
...
\end{equation}
When $v<0$, by combining $\Phi\left(-z\right)=1-\Phi\left(z\right)$ and (\ref{app7}), we can obtain
\begin{equation}
\label{app12}
