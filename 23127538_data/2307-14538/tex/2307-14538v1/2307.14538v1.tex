...
\ee
This expression results interesting as it contains the quadratic expansion of the pure Yang-Mills action \eqref{YM_action}. Going to momentum space it becomes
\be
\label{HD_momentum}
...
where $\Pi^{\rho\mu}$ was defined in \eqref{PiProjector}. To apply the double copy prescription we consider a correction to the three-point vertex function, given by
\be
...
\ee
At this point, we can apply the double copy prescription \eqref{DcFields}, \eqref{DCCartan}, \eqref{DC_structure} but considering instead $\Pi^{\mu\nu\rho}$. Then the higher-derivative cubic contributions read,
\bea
...
We would like to kindly thank Felipe Diaz-Jaramillo, Olaf Hohm  and Silvia Nagy for very interesting comments in the first manuscript of this work. EL is supported by the Croatian Science Foundation project IP-2019-04-4168. The work of GM has been partially supported by Conselho Nacional de Desenvolvimento Cient\'ifico e Tecnol\'ogico - CNPq under grant 317548/2021-2 and Fundac\~ao Carlos Chagas Filho de Amparo \`a Pesquisa do Estado do Rio de Janeiro - FAPERJ under grant E-26/201.142/2022. The work of JAR is supported by CONICET, and would also like to thank the Hanrieder Foundation for Excellence and the Max Planck Institut für Physik (MPP) for support and hospitality during the early stages of this project. 
