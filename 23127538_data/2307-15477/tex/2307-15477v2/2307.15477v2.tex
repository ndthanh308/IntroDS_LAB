...
\begin{equation}
\label{rep1}
b \mt \diag(1, \ep^s, \ldots, \ep^{(\ell/d-1)s}), \quad a \mt (g_{rt})_{r,t=1}^{\ell/d},
\; \; g_{rt} :=
\begin{cases}
...
\begin{equation}
\label{rep2}
b \mt \diag(\ep^{j}, \ep^{j+s}, \ldots, \ep^{j+ (\ell/d-1)s}), \quad a \mt (\ep^i g_{rt})_{r,t=1}^{\ell/d}.
\end{equation}
...
\[
y \mt \sqrt[\ell]{v} \diag(1, \ep^s, \ldots, \ep^{(\ell/d-1)s}), \; \;  x \mt (g_{rt})_{r,t=1}^{\ell/d},
\; g_{rt} :=
\begin{cases}
