...
&= \left. e^{\vartheta_{ij} \left( \partial_\mu^{(i)} \, \eta^{\mu \nu}_{ij} \, \partial_\nu^{(j)} \right)} \, \Phi_i(x_i) \cdot \Phi_j(x_j) \right|_{x_i=x_j=x} \, , \\
...
\begin{itemize}[label=$\spadesuit$]
\item For neutral fields: the fuzzy plaquette $\eta_0 = 1/\Lambda_0^2$; the symbol $\star_0$ defined as (no summation on $i$ and $j$)
\begin{align}
A_{\rho} (x) \star_0 A_{\sigma} (x)
&= A_{\rho}(x) \, e^{\vartheta_0 \left( \overleftarrow{\partial_\mu} \, \eta^{\mu \nu}_0 \, \overrightarrow{\partial_\nu} \right)} \, A_{\sigma}(x) \, , \\
&= \left. e^{\vartheta_0 \left( \partial_\mu^{(i)} \, \eta^{\mu \nu}_0 \, \partial_\nu^{(j)} \right)} \, A_{\rho}(x_i) \cdot A_{\sigma}(x_j) \right|_{x_i=x_j=x} \, ,
\end{align}
with the notation $\eta^{\mu \nu}_0 = \eta_0 \, g^{\mu \nu}$, and the entire function $\vartheta_0(z)$.
\item For fields creating/annihilating particles of charge $-1$ and antiparticles of charge $+1$: the fuzzy plaquette $\eta_e = 1/\Lambda_e^2$; the symbol $\star_e$ defined as (no summation on $i$ and $j$)
\begin{align}
\phi^*(x) \star_e \phi(x)
&= \phi^*(x) \, e^{\vartheta_e \left( \overleftarrow{\mathcal{D}_\mu} \, \eta^{\mu \nu}_e \,\overrightarrow{\mathcal{D}_\nu} \right)} \, \phi(x) \, , \\
&= \left. e^{\vartheta_e \left( \mathcal{D}_\mu^{(i)} \, \eta^{\mu \nu}_e \, \mathcal{D}_\nu^{(j)} \right)} \, \phi^*(x_i) \cdot \phi(x_j) \right|_{x_i=x_j=x} \, ,
\end{align}
with the notation $\eta^{\mu \nu}_e = \eta_e \, g^{\mu \nu}$, the entire function $\vartheta_e(z)$, and the covariant derivative defined as
\begin{equation}
\mathcal{D}_\mu^{(i)} \phi(x_i) = \left[ \partial_\mu^{(i)} + i e \, A_\mu(x_i) \right] \cdot \phi(x_i) \, ,
 \ \ \ 
\mathcal{D}_\mu^{(i)} \phi^*(x_i) = \left[ \partial_\mu^{(i)} - i e \, A_\mu(x_i) \right] \cdot \phi^*(x_i) \, ,
\end{equation}
where $\left[ \mathcal{D}_\mu^{(i)} , \mathcal{D}_\nu^{(j)} \right] = 0$ if $i \neq j$.
\end{itemize}
