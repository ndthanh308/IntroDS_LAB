...
\begin{conj}\label{conj:reductiontwobins}
  For $k\in \Theta(1)$, two bin $\LH$ incurs maxload larger than $n/2+k\sqrt{n}$
...
$\setof{ax}{a\in \halfp}$ to consist of $m$ collections of sets of points spaced
out by $k$. Formally:
...
$\bigO(\sqrt{n} \log^2 n)$. We leave strengthening
