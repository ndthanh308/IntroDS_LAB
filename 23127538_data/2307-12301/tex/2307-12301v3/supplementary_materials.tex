...
% In the following section, we provide the detailed results of each algorithm evaluated independently on the SUN397 \cite{data-sun397}, Caltech101 \cite{data-caltech101}, and ImageNet21K \cite{data-imagenet21k} datasets. These are the same results obtained from the experiments conducted in Section \ref{sec:experiments}, but we detail the individual results from each dataset for reference.

% \subsection{Outlier Detection with Clean Training}
% The results listed below are from the same experiment in Section \ref{exp:outlier_detection_benchmark}. Tables \ref{suppl:clean_train_imagenet}, \ref{suppl:clean_train_caltech}, and \ref{suppl:clean_train_sun397} refer to the experiments on the SUN397 \cite{data-sun397}, Caltech101 \cite{data-caltech101}, ImageNet21K \cite{data-imagenet21k} and datasets.
...
% Isolation Forest \cite{isolation_forest} &      $0.953$ &  $0.951$ &  $0.951$ &  $0.945$ &  $\pm0.02$ \\
% INNE  \cite{algo-inne}             &      $0.967$ &  $0.970$ &  $0.973$ &  $0.961$ &  $\pm0.01$ \\
% LOF   \cite{local_outlier_factor}              &      $0.971$ &  $0.972$ &  $0.972$ &  $0.973$ &  $\pm0.01$ \\
% AutoEncoder  \cite{Outlier_Analysis_aggarwal}      &      $0.949$ &  $0.953$ &  $0.954$ &  $0.942$ &  $\pm0.02$ \\
% LUNAR   \cite{algo-lunar}            &      $0.957$ &  $0.958$ &  $0.958$ &  $0.954$ &  $\pm0.02$ \\
% KNN Distance  \cite{knn-distance-algo}     &      $0.976$ &  $0.980$ &  $0.978$ &  $0.976$ &  $\pm0.01$ \\
% GOAD  \cite{goad}             &      $0.946$ &  $0.950$ &  $0.944$ &  $0.945$ &  $\pm0.02$ \\
% Deep SVDD  \cite{2018_deepsvdd}        &      $0.904$ &  $0.901$ &  $0.894$ &  $0.879$ &  $\pm0.03$ \\
% RCA   \cite{rca}               &      $0.863$ &  $0.850$ &  $0.847$ &  $0.822$ &  $\pm0.03$ \\
% NeuTraL  \cite{2021_neural_transformation}          &      $0.889$ &  $0.894$ &  $0.888$ &  $0.872$ &  $\pm0.04$ \\
% RANSAC-NN (Ours)        &      $0.978$ &  $0.976$ &  $0.975$ &  $0.958$ &  $\pm0.02$ \\

% \bottomrule
% \end{tabular}
% \end{adjustbox}

%     \caption{\textbf{OD with Clean Training - SUN 397 \cite{data-sun397}.}}
%     \label{suppl:clean_train_sun397}
% \end{table}
...
% Isolation Forest \cite{isolation_forest} &      $0.977$ &  $0.970$ &  $0.970$ &  $0.966$ &  $\pm0.02$ \\
% INNE  \cite{algo-inne}             &      $0.966$ &  $0.970$ &  $0.968$ &  $0.963$ &  $\pm0.01$ \\
% LOF   \cite{local_outlier_factor}              &      $0.976$ &  $0.972$ &  $0.972$ &  $0.971$ &  $\pm0.01$ \\
% AutoEncoder  \cite{Outlier_Analysis_aggarwal}      &      $0.970$ &  $0.960$ &  $0.965$ &  $0.953$ &  $\pm0.01$ \\
% LUNAR   \cite{algo-lunar}            &      $0.968$ &  $0.970$ &  $0.968$ &  $0.962$ &  $\pm0.01$ \\
% KNN Distance  \cite{knn-distance-algo}     &      $0.982$ &  $0.982$ &  $0.981$ &  $0.975$ &  $\pm0.01$ \\
% GOAD  \cite{goad}             &      $0.979$ &  $0.976$ &  $0.976$ &  $0.972$ &  $\pm0.01$ \\
% Deep SVDD  \cite{2018_deepsvdd}        &      $0.950$ &  $0.962$ &  $0.950$ &  $0.946$ &  $\pm0.01$ \\
% RCA   \cite{rca}               &      $0.934$ &  $0.935$ &  $0.932$ &  $0.906$ &  $\pm0.02$ \\
% NeuTraL  \cite{2021_neural_transformation}          &      $0.936$ &  $0.948$ &  $0.937$ &  $0.945$ &  $\pm0.02$ \\
% RANSAC-NN (Ours)        &      $0.974$ &  $0.970$ &  $0.971$ &  $0.903$ &  $\pm0.05$ \\

% \bottomrule
% \end{tabular}
% \end{adjustbox}

%     \caption{\textbf{OD with Clean Training - Caltech101 \cite{data-caltech101}.}}
%     \label{suppl:clean_train_caltech}
% \end{table}
...
% Isolation Forest \cite{isolation_forest} &      $0.969$ &  $0.971$ &  $0.968$ &  $0.970$ &  $\pm0.00$ \\
% INNE  \cite{algo-inne}        &   $0.986$ &  $0.987$ &  $0.988$ &  $0.987$ &  $\pm0.00$ \\
% LOF   \cite{local_outlier_factor}           &      $0.982$ &  $0.983$ &  $0.983$ &  $0.983$ &  $\pm0.00$ \\
% AutoEncoder  \cite{Outlier_Analysis_aggarwal}    &      $0.984$ &  $0.984$ &  $0.983$ &  $0.984$ &  $\pm0.00$ \\
% LUNAR   \cite{algo-lunar}         &      $0.985$ &  $0.986$ &  $0.985$ &  $0.985$ &  $\pm0.00$ \\
% KNN Distance  \cite{knn-distance-algo}   &      $0.992$ &  $0.991$ &  $0.991$ &  $0.991$ &  $\pm0.00$ \\
% GOAD  \cite{goad}           &      $0.975$ &  $0.975$ &  $0.976$ &  $0.974$ &  $\pm0.00$ \\
% Deep SVDD  \cite{2018_deepsvdd}      &      $0.913$ &  $0.917$ &  $0.914$ &  $0.914$ &  $\pm0.01$ \\
% RCA   \cite{rca}           &      $0.970$ &  $0.968$ &  $0.964$ &  $0.957$ &  $\pm0.00$ \\
% NeuTraL  \cite{2021_neural_transformation}        &      $0.968$ &  $0.968$ &  $0.968$ &  $0.962$ &  $\pm0.00$ \\
% RANSAC-NN (Ours)       &      $0.989$ &  $0.989$ &  $0.986$ &  $0.962$ &  $\pm0.00$ \\

% \bottomrule
% \end{tabular}
% \end{adjustbox}

%     \caption{\textbf{OD with Clean Training - ImageNet21K \cite{data-imagenet21k}.}}
%     \label{suppl:clean_train_imagenet}
% \end{table}

% \subsection{Influence of Contaminated Training}
% The figures listed below are from the same experiment in Section \ref{exp:impact_of_contaminated_training}. 
