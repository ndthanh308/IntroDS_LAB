...
\date{}
\affil{$^*$Corresponding Author. Email Address: jaworden@vt.edu}
...
quantum thermodynamics; steepest entropy ascent; computational physics; thermoelectric materials

\smallbreak
\textbf{Program Summary}
\smallbreak

\textit{Manuscript Title:} Predicting Coupled Electron and Phonon Transport Using Steepest-Entropy-Ascent Quatnum Thermodynamics

\textit{Authors:} Jarod Worden, Michael von  Spakovsky, Celine Hin

\textit{Program Title:} SEAQT

\textit{Journal Reference:} 

\textit{Catalogue Identifier:}

\textit{Licensing Provisions:} Contact Michael von Spakovsky (vonspako@vt.edu) or Celine Hin (celhin@vt.edu); the code is under copyright and will require a free license for the academic and national lab communities and a commercial license for industry.

\textit{Programming Language:} MATLAB and Python

\textit{Computer:} The program needs a MATLAB version $\geq$ MATLAB 2020b and a python version $\geq3.6$

\textit{Operating System:} Unix/Linux

\textit{RAM:} The amount of RAM follows similar specifications as MATLAB, with 3695 MB used for the systems being analyzed in this paper. 

\textit{Run Time:} 5 minutes for the system parameters discussed in the paper.

\textit{Github URL:} Contact Michael von Spakovsky (vonspako@vt.edu) or Celine Hin (celhin@vt.edu)
...
%\smallbreak
    \begin{tabular} {|c|c|} 
     ...
     \hline
     p-type 2$\times10^{16}$ & 3.618\\ 
     \hline
     p-type 1$\times10^{20}$ & 1.761 \\ 
    \hline
    n-type 2$\times10^{17}$  & 3.472 \\ 
     \hline
     n-type 1$\times10^{18}$ & 2.312 \\ 
     \hline
    n-type 2$\times10^{19}$  & 2.002 \\ 
    \hline
    n-type 1$\times10^{20}$  & 1.498 \\ 
    \hline 
    \end{tabular} 
    \label{DopedSiTau}
\end{table}
...
\hfill \break
\textbf{Jarod Worden:} software, validation, formal analysis, investigation, data curation, writing - original draft, writing - review and editing, visualization \textbf{Micheal von Spakovsky:} conceptualization, methodology, resources, writing - review and editing, supervision, project administration, funding acquisition \textbf{Celine Hin:} writing - review and editing, supervision, project administration
