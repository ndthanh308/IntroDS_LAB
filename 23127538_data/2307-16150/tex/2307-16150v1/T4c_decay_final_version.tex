...
c^{(0)}_{\gamma\gamma,3}&=&\frac{128\sqrt 6 \pi ^3 e_Q^4 \alpha^2 \alpha_s^2}{m_H m_Q^4},\\
%-----------------------------------
...
c^{(0)}_{{\rm LH},3}&=&\frac{44\sqrt 6 \pi^3 \alpha_s^4}{3m_H m_Q^4},\\
%------------------------------------
%------------------------------------
...
Finally, it is worth noting that our prediction for the ${\rm Br}[T_{4c}^{0^{++}}\to \gamma\gamma]$ is consistent with the value $(2.77\pm0.36)\times 10^{-6}$ estimated 
...
\begin{table}[!htbp]\small
	...
	%\resizebox{\textwidth}{!}
	{
		\begin{tabular}{|c|c|c|c|c|}
			...
			& $4.81^{+3.05}_{-1.53}\times10^{-3}$
			& $4.00^{+2.55}_{-1.27}\times10^{-6}$
                & $2.13^{+1.35}_{-0.68}\times10^{-3}$
                & $1.78^{+1.13}_{-0.56}\times10^{-6}$
			\\
			\hline
			%----------------------------------------------------------
			...
			& $1.01^{+1.70}_{-0.54}$
			& $0.84^{+1.41}_{-0.45}\times 10^{-3}$
			& $0.30^{+0.50}_{-0.16}$
                & $0.25^{+0.41}_{-0.13}\times 10^{-3}$
                \\
			\hline
	...
	%\resizebox{\textwidth}{!}
	{
		\begin{tabular}{|c|c|c|c|c|}
			...
			\cline{2-5}
                ...
                \multirow{1}{*}{$T_{4c}^{0^{++}}\to \gamma\gamma$}
			& $37\pm 26$
			& $(1.48 \pm 1.04 ^{+0.94}_{-0.47})\times 10^4$
                & $9 \pm 6$
                & $(1.60 \pm 1.07 ^{+1.02}_{-0.51})\times 10^3$
			\\
			\hline
			%----------------------------------------------------------
			\multirow{1}{*}{$T_{4c}^{2^{++}}\to \gamma\gamma$}
			...
			\hline
                \multirow{1}{*}{$T_{4c}^{0^{++}}\to\rm LH$}
			& $37\pm 26$
			& $(3.12 \pm  2.20 ^{+5.23}_{-1.67})\times 10^6$
			& $9 \pm 6$
                & $(2.22 \pm 1.48 ^{+3.72}_{-1.18})\times 10^5$
                \\
			\hline
                \multirow{1}{*}{$T_{4c}^{2^{++}}\to \rm LH$}
			& $93 \pm 65$
...
%-----------------------
The work of W.-L. S. is supported by the National Natural Science Foundation of China under Grants No. 11975187.
%-----------------------
