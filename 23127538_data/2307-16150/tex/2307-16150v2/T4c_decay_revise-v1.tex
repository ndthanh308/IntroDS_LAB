...
from literature.  
The branching fractions are predicted to be around $10^{-3}$ and  $10^{-6}$ for the $T_{4c}$ hadronic decay and electromagnetic decay, respectively. 
...
With integrated luminosity $\mathcal{L}=100 \,{\rm fb}^{-1}$, it is expected that the event numbers can reach $10^3- 10^4$ for $T_{4c}\to \gamma\gamma$,
...
are determined to be $M=6950\pm 11\pm 7\,{\rm MeV}$ and $\Gamma=80\pm 19 \pm 33 \,{\rm MeV}$, respectively, 
while, they become
...
The operators in (\ref{nrqcd-ldmes}) are constructed in the diquark-antidiquark basis, where the spin configuration and color configuration of the diquark are correlated due to Fermi statistics. Specifically, the S-wave spin-singlet diquark must be a color-sextet, while the S-wave spin-triplet diquark must be a color-triplet.
...
\begin{subequations}\label{sdcs-expand}
 \begin{eqnarray}
%-----------------------------------
c^{(0)}_{\gamma\gamma,1}&=&\frac{128 \pi ^3 e_Q^4 \alpha^2 \alpha_s^2}{3 m_H m_Q^4},\\
c^{(0)}_{\gamma\gamma,2}&=&\frac{2304 \pi ^3 e_Q^4 \alpha^2 \alpha_s^2}{ m_H m_Q^4},\\
c^{(0)}_{\gamma\gamma,3}&=&\frac{256\sqrt 6 \pi ^3 e_Q^4 \alpha^2 \alpha_s^2}{m_H m_Q^4},\\
%-----------------------------------
c^{(2)}_{\gamma\gamma}&=&\frac{16384 \pi ^3 e_Q^4 \alpha^2 \alpha_s^2}{15 m_H m_Q^4},
%------------------------------------
\end{eqnarray}
\end{subequations}
%-------------------------------------
...
\begin{subequations}\label{sdcs-expand}
 \begin{eqnarray}
%-----------------------------------
c^{(0)}_{{\rm LH},1}&=&\frac{484 \pi^3 \alpha_s^4}{27m_H m_Q^4},\\
c^{(0)}_{{\rm LH},2}&=&\frac{72 \pi^3 \alpha_s^4}{m_H m_Q^4},\\
c^{(0)}_{{\rm LH},3}&=&\frac{88\sqrt 6 \pi^3 \alpha_s^4}{3m_H m_Q^4},\\
%------------------------------------
%------------------------------------
c^{(2)}_{{\rm LH}}&=&\frac{6272 \pi^3 \alpha_s^4}{135 m_H m_Q^4} \left(1+\frac{48}{49}n_L\right),
%------------------------------------
\end{eqnarray}
\end{subequations}
%-------------------------------------
...
Prior to making phenomenological predictions, we need to fix the various input parameters.~\footnote{Due to lack of necessary values for the LDMEs of $T_{4b}$, we restrict this section to predictions on $T_{4c}$.}
...
Finally, it is worth noting that our prediction for the ${\rm Br}[T_{4c}^{0^{++}}\to \gamma\gamma]$ is roughly consistent with the value $(2.77\pm0.36)\times 10^{-6}$ estimated 
...
\begin{table}[!htbp]\small
	...
	%\resizebox{\textwidth}{!}
	{
		\begin{tabular}{|c|c|c|c|c|}
			...
			& $5.17^{+3.29}_{-1.64}\times10^{-3}$
			& $4.31^{+2.74}_{-1.37}\times10^{-6}$
                & $1.85^{+1.18}_{-0.59}\times10^{-3}$
                & $1.54^{+0.98}_{-0.49}\times10^{-6}$
			\\
			\hline
			%----------------------------------------------------------
			\multirow{1}{*}{$T_{4c}^{2^{++}}\to \gamma\gamma$}
			& $0.87^{+0.55}_{-0.28}\times10^{-3}$
			& $0.72^{+0.46}_{-0.23}\times10^{-6}$
			& $0.76^{+0.48}_{-0.24}\times10^{-3}$
			& $0.63^{+0.40}_{-0.20}\times10^{-6}$
			\\
			\hline
                \multirow{1}{*}{$T_{4c}^{0^{++}}\to\rm LH$}
			& $1.23^{+2.07}_{-0.66}$
			& $1.03^{+1.72}_{-0.55}\times 10^{-3}$
			& $0.13^{+0.21}_{-0.07}$
                & $0.11^{+0.18}_{-0.06}\times 10^{-3}$
                \\
			\hline
                \multirow{1}{*}{$T_{4c}^{2^{++}}\to \rm LH$}
			& $0.77^{+1.28}_{-0.41}$
			& $0.64^{+1.07}_{-0.34}\times 10^{-3}$
			& $0.67^{+1.12}_{-0.36}$
                & $0.56^{+0.94}_{-0.30}\times 10^{-3}$
			\\
			\hline
	...
	%\resizebox{\textwidth}{!}
	{
		\begin{tabular}{|c|c|c|c|c|}
			...
			\cline{2-5}
                ...
                \multirow{1}{*}{$T_{4c}^{0^{++}}\to \gamma\gamma$}
			& $37\pm 26$
			& $(1.59 \pm 1.12 ^{+1.01}_{-0.51})\times 10^4$
                & $9 \pm 6$
                & $(1.39 \pm 0.93 ^{+0.88}_{-0.44})\times 10^3$
			\\
			\hline
			%----------------------------------------------------------
			\multirow{1}{*}{$T_{4c}^{2^{++}}\to \gamma\gamma$}
			& $93 \pm 65$
			& $(6.72 \pm 4.70 ^{+4.27}_{-2.13})\times 10^3$
			& $81 \pm 57$
			& $(5.12 \pm 3.61^{+3.26}_{-1.63})\times 10^3$
			\\
			\hline
                \multirow{1}{*}{$T_{4c}^{0^{++}}\to\rm LH$}
			& $37\pm 26$
			& $(3.80 \pm 2.67 ^{+6.37}_{-2.03})\times 10^6$
			& $9 \pm 6$
                & $(0.96 \pm 0.64 ^{+1.60}_{-0.51})\times 10^5$
                \\
			\hline
                \multirow{1}{*}{$T_{4c}^{2^{++}}\to \rm LH$}
			& $93 \pm 65$
			& $(5.94 \pm 4.15 ^{+9.95}_{-3.17})\times 10^6$
			& $81 \pm 57$
                & $(4.52 \pm 3.18 ^{+7.58}_{-2.42})\times 10^6$
			\\
			\hline
...
We find the branching fractions are around $10^{-3}$ and $10^{-6}$ for the $T_{4c}$ hadronic decay and electromagnetic decay, respectively.
...
%-----------------------
The work of W.-L. S. and T. W. is supported by the National Natural Science Foundation of China under Grants No. 11975187.
%-----------------------
...
%3 citations counted in INSPIRE as of 17 Jul 2023
