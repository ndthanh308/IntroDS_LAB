...
\foreach \y/\c/\rc/\mid/\i in {9/blue!65!green/blue!80!green/blue!70!green/1,
    ...
    \draw[\mid, very thick]
                    ...
                    (\y-3,3) ;
    \fill[color=black!50!white] 
        (\y-3.5,4.2) circle (0.55cm);
    \draw[black,dashed,postaction = decorate,decoration = {markings, mark = at position 0.65 with {\arrowreversed{stealth}} }] 
        (\y-3.5,4.2) circle (0.65cm) node[below=0.49cm]{$g_{\i}$};
    ...
    \draw[thick]
        (2,0) -- (3,0) 
        (5,0) -- (15.5,0) 
        (7.3,0) node[below=0.3cm]{$m_1(\mathbb{S}^{d-2})$}
        (11.3,0) node[below=0.3cm]{$m_2(\mathbb{S}^{d-2})$};
    \draw[mygreen, -latex, very thick]
        (3,0) -- (5,0) node[pos=0.5,below=2pt]{$J_0$};
