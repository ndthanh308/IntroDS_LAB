...
Recently, using improved values for the form factors and radiative corrections associated to the relevant meson and neutron decay processes, a deviation from the unitarity condition of the first row of the CKM matrix was found. This discrepancy is known as CKM unitarity problem \cite{Seng2018,Seng2019,Czarnecki2019,Belfatto2020,Seng2020,Cheung2020,Hayen2021,Shiells2021,FLAG2022,Crivellin2022} and is one of the main motivations for the introduction of VLQ extensions of the SM. The experimental results are compatible with
%
\be
