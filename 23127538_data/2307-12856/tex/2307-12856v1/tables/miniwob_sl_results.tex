...
We also finetune HTML-T5 with 347K expert traces~\citep{furuta2023mmwebnav}, which performs better than Flan-T5-XXL (11B parameters) even with 3B parameters. See \autoref{sec:per_task_miniwob_results} for the detailed results.
}
