...
% \subsubsection{3D Grounding (Referring)}
...
% \subsubsection{3D Feature Extractor \& Pre-training}
% In the paper, we claimed that it's hard to train 3D features and LLMs from scratch. Here, we carry out an ablative study where we 1) do not use feature extractor to extract 3D features from 2D images, and use a PointNet encoder instead; 2) do not use pre-trained VLMs, train 3D-LLMs from scratch. We use BLIP2-flant5 for the ablative experiment. Table \ref{tab:pretrain} shows the result. From the table, we can see that the performances of 3D-LLMs drop a lot if we do not use pre-trained VLMs or 3D feature extractors. 
...
%     \hline
%         ~ & BLEU-1 & BLEU-2 & BLEU-3 & BLEU-4 & METEOR & ROUGH\_L & CIDER & EM \\ \hline
%         3D-LLM wo/ feature extractor & 18.2 & 9.1 & 5.5 & 3.1 & 9.4 & 18.3 & 33.5 & 5.6 \\ \hline
%         3D-LLM wo/ pre-trained VLM & 28.1 & 15.4 & 9.6 & 5.1 & 12.2 & 25.6 & 40.0 & 10.7 \\ \hline
%         3D-LLM (BLIP2-flant5) & 39.4 & 25.2 & 18.3 & 12.3 & 14.9 & 35.9 & 69.3 & 19.2 \\ \hline
%     \end{tabular}
%     \caption{Avalative Study of using pre-trained modules for 3D-LLMs}
%     \label{tab:pretrain}
% \end{table}
