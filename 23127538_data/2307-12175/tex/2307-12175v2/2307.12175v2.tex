...
\begin{document}
	...
	\begin{abstract}
		...
		\textit{\textbf{Keywords and Phrases : }}Dirichlet Series, Dedekind Zeta Functions, Number Field Extension, Riemann Hypothesis, Holomorphic Functions, Partial Dedekind Zeta Functions, Polar Density, Finite Extension, Class Number Formula, Dirichlet L-Functions.\\\\
		\texttt{\textbf{2020 MSC: }}\texttt{Primary  11-02, 11M36, 11R42, 11R45, 11S40 }.\\
		\hspace*{53pt}\texttt{Secondary 11R44, 11S15, 32A60, 32A10 }.
	\end{abstract}
	...
	\end{thm}
		...
		\begin{proof}
			...
			Here, we clearly observe that, $\wp\in \mathcal{B}$ $\implies$ $\mathcal{N}(\wp)$ is prime, and this statement holds for all primes $\wp$ except finitely many, which are ramified over $K$. \par  Therefore,
			\begin{center}
