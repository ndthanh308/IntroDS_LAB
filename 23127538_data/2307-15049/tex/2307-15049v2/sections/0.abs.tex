...
In this work, we design a new type of tuning method, termed as \textbf{regularized mask tuning}, which masks the network parameters through a learnable selection.
...
It is noteworthy that we manage to deliver \textbf{18.73\%} performance improvement compared to the zero-shot CLIP via masking an average of only \textbf{2.56\%} parameters.
...
Project page can be found \href{https://wuw2019.github.io/R-AMT/}{here}.
\nonumfootnote{$\dagger$ indicates equal contribution.}
% \indent {\hspace{1mm}}* This work was done during an internship at Ant Group.}
