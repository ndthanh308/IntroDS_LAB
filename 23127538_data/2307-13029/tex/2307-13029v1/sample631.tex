...
% other planet?
Finally, we note that recent data indicates that instead of CI Tau b, CI Tau hosts a different planet with a 24~d period and has a mass of 2.6 Jupiter-mass (Jean-Francois Donati, priv. comm.). This would place the planet at about 0.16 au, in good agreement with where we identify the disk break, which is at $0.14\pm0.08~\rm au$.
