...
\mathtoolsset{showonlyrefs}
\usepackage{xr}
\externaldocument{MVFD_arxiv_renamed_SM}
...
\medskip	
	...
	\textbf{Key words:} Concentration of estimators, Hölder exponent, Minimax rate, Random fields
...
\input{sections/local_reg}
\input{sections/non_asymp}
\input{sections/exampleG}
%\input{sections/exampleG_inv}
\input{sections/adapt_smooth}
