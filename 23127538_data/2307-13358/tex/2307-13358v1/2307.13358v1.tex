...
and contramodules over $k$\+linear categories.
 I~also wish to thank Michal Hrbek for a helpful conversation.
...
and all co/contramodules are co/contraunital by default.
 The book~\cite{Swe} is a classical reference source on coalgebras.
...
ring $\C^*$ (called ``rational'' in~\cite{Swe}).
...
is \emph{not} locally finite, belongs ot the essential image of
