\documentclass[tighten, twocolumn, twocolappendix]{aastex631}
...
&\ \left. + 2\frac{2F}{\Sigma}\mathrm{d}\tau\mathrm{d}r - 2\left(1+\frac{2F}{\Sigma}\right)a\sin^2{\vartheta}~\mathrm{d}r\mathrm{d}\phi\right]\,,
\end{align}
...
X^2\frac{\dot{r}^2}{E^2} =&\ \left(\Delta + 2F - a\xi\right)^2 - \Delta\eta^2 + \frac{2\mathscr{L}}{E^2}\Delta X_r =: \mathscr{R}(r)\,.
\end{align}
