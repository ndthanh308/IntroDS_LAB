...
\tabcolsep 4pt
\caption{
Object detector performance on YCBV~\cite{ycbv}. On this dataset, failures and successes of $\Delta_{S \to F}$ and $\Delta_{F \to S}$ are measured in terms of ADD-S. Key: $^\ast$: symmetric object.
}
...
% \resizebox{1.0\columnwidth}{!}{
    \begin{tabular}{lcccc}
        \toprule
        Object & AP & $AP_{50}$ & $\Delta_{S \to F}$ & $\Delta_{F \to S}$ \\
        \midrule
