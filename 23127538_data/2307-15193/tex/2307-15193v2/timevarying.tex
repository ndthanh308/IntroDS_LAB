...
is the expected probability of selecting bid $b$, where the expectation is taken with respect to all valuation vectors $\bm{v} \in \mathcal{V}$. This procedure, formally described in Algorithm~\ref{alg: Decoupled Exponential Weights - Time Varying Known Finite}, yields the following regret upper bound:
