...
This article is based  on a talk I gave in the ``Octonion Standard Model Unification''  (OSMU) internet lecture series, organized by Tejander Singh and Michael Wright.  The present writeup, as a contribution to the Lars Brink Memorial Volume,  benefited from the hospitality of the Aspen Center for Physics, which is supported by National Science Foundation Grant PHY-2210452.
