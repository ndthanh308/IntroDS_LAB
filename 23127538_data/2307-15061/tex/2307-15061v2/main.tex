...
\author{%
  ...
  \textbf{Benoit R. Cottereau}$^{7,8,\color{robo_green}\spadesuit}$\quad \textbf{Liangjun Zhang}$^{9,\color{robo_green}\spadesuit}$\quad \textbf{Hesheng Wang}$^{10,\color{robo_green}\spadesuit}$\quad
  \textbf{Wei Tsang Ooi}$^{1,\color{robo_green}\spadesuit}$\\ \textbf{Ruijie Zhu}$^{11}$\quad \textbf{Ziyang Song}$^{11}$\quad \textbf{Li Liu}$^{11}$\quad \textbf{Tianzhu Zhang}$^{11,12}$\quad \textbf{Jun Yu}$^{11}$\\ \textbf{Mohan Jing}$^{11}$\quad \textbf{Pengwei Li}$^{11}$\quad \textbf{Xiaohua Qi}$^{11}$\quad \textbf{Cheng Jin}$^{13}$\quad \textbf{Yingfeng Chen}$^{13}$\\
