...
\begin{enumerate}[(a)]
    \item lives in the joint space of the manipulator (like the metric of Zein et al. \cite{zein}),
...
According to \cite{zein}, another application of intrinsic metrics is the determination of the center/home configuration of the robot as the one that has the largest singularity distance within the joint space.
