...
\begin{table*}[htbp]
 ...
 ~\cite{deng2020tianjic,pei2019towards} & \textbf{SpiNNaker}  ~\cite{Furber2014SpiNNaker,HBPNeuromorphicComputing} & \textbf{Brain ScaleS-2}  ~\cite{HBPNeuromorphicComputing,pehle2022brainscales,grubl2020verification} & \textbf{DYNAP SEL}  ~\cite{moradi2017scalable,rueckert2020update} & \textbf{Akida}  ~\cite{demler2019brainchip}   & \textbf{Human Brain}  ~\cite{martins2016human,martins2019human} \\
            ...
            \textbf{Key properties} & Limited to on-chip training & First commercial neuromorphic chip & Fully programmable chip & First hybrid ANN/SNN & Scalable SNN simulation & Hybrid Plasticity & One plastic core & Continuous and few-shot learning & - \\
             ...
             \textbf{GSOPS/W} & - & 400  & \(\sim 42 x 10\) & 649-1278 ~\cite{deng2020tianjic,basu2022spiking}& 0.033 & \(>10\)& 33 & Akida & - \\
...
\paragraph{\textbf{FDA approach towards AI}}

A neuromorphic device utilizing CMOS technology has been developed to detect epileptic seizures by analyzing local field potential (LFP) signals\cite{ronchini2021cmos}. This study's prospective direction allows closed-loop intervention for seizure duration reduction with SNN with a delay of 64.98$\pm$30.92 ms and only consuming \(<\)50~pW. Followed by that study, NET-TEN emerged as a neuromorphic network designed to detect seizure-related brain activity using an analog approach. This technology improves upon existing neuromorphic processors by reducing the required area and power consumption, making it more feasible for use in implantable devices \cite{ronchini2023net}.
...
\bibliographystyle{ieeetr}  % Choose your desired citation style
...
\begin{IEEEbiography}[{% Figure removed}]{Luis Fernando Herbozo Contreras} is a PhD student in Biomedical Engineering at the University of Sydney (USYD), Australia working with neuromorphic computing for seizure detection and prediction for on-chip learning. He holds a bachelor’s degree in biomedical engineering, graduating with first-class honours and ranking among the top 3 students in his degree at the Tecnologico de Monterrey, Mexico. He has a strong background in research, with previous experience in exoskeletons and two research internships at KAUST and McGill universities, where he worked on projects related to body area networks and haptic devices. He had been awarded the Visiting Student Research Program and Mitacs Globalink Internship fellowships. In addition, he has been awarded by USYD with the Faculty of Engineering Research Scholarship.

\end{IEEEbiography}

\begin{IEEEbiography}[{% Figure removed}]{Nhan Duy Troung} received the BEng degree in electronics and telecommunications with Gold Medal for Top Graduate from Ho Chi Minh City University of Technology, Vietnam, in 2010, the MEng degree in electronics and computer engineering from the Royal Melbourne Institute of Technology, Australia, in 2013, and the PhD degree in epileptic seizure forecasting ecosystems from The University of Sydney, Australia, in 2020. He is a postdoctoral research associate at ARC Training Centre for Innovative BioEngineering, Australia. His research interests include neural networks, medical devices, deep learning and hardware implementation. He is the co-founder of a neurotechnology startup.
\end{IEEEbiography}

\begin{IEEEbiography}[{% Figure removed}]{Jason K. Eshraghian} (Member, IEEE) received the B.Eng. (electrical and electronic), L.L.B., and PhD degrees from The University of Western Australia, Perth, WA, Australia, in 2017 and 2019, respectively. From 2019 to 2022, he was a Post-Doctoral Research Fellow at the University of Michigan, Ann Arbor MI, USA. He is an Assistant Professor with the Department of Electrical and Computer Engineering, The University of California at Santa Cruz, Santa Cruz, CA, USA. His research interests include neuromorphic computing, resistive random access memory (RRAM) circuits, and spiking neural networks.
\end{IEEEbiography}

\begin{IEEEbiography}[{% Figure removed}]{Zhaojing Huang} holds an undergraduate Master of Engineering in Engineering with Business Finance from University College London, as well as a Master of Philosophy in Industrial Systems, Manufacturing, and Management from the University of Cambridge. During his academic journey, he conducted research in polymer materials, specifically working on improving actuator efficiency. Additionally, his Master's research revolved around the commercialization of scientific discoveries, aiding researchers in transforming their innovative findings into practical applications. Currently, Zhaojing is dedicated to advancing the field of biosignal processing, particularly in the realm of machine learning technologies applied to electrocardiogram (ECG) data

\end{IEEEbiography}

\begin{IEEEbiography}[{% Figure removed}]{Armin Nikpour} graduated from the Medical University of Sydney in 1990. He completed a two-year fellowship in epilepsy and neurophysiology at the Cleveland Clinic Foundation and another in PET. He holds dual credentials in Neurology and PET. In 2001 he was appointed as the Director of the Comprehensive Epilepsy Service and senior staff specialist in PET, and in 2016, as Head of Neurology at Royal Prince Alfred Hospital. His research interests include the application of PET in epilepsy, EEG signal analysis, the development of dry electrode systems, and the comorbidities of epilepsy in memory and mood disorders. He is the co-founder of a neurotechnology startup.
\end{IEEEbiography}

\begin{IEEEbiography} [{% Figure removed}]{Zhangyu Xu} is a researcher with a multi-disciplinary background. He received a B.Eng. degree in electrical engineering from the People's Public Security University of China in 2006. He received his first M.Eng degree in computer science from Yunnan University, China, in 2014. He worked as a computer network and software engineer for over 13 years. He received his second M.Eng degree in Health Technology Innovation from The University of Sydney, Australia, in 2021, which connected his ICT background to biomedical engineering.  He is currently pursuing a PhD degree in biomedical engineering. His research interests include bio-signal processing, low-power analog and mixed-signal circuit design and machine-learning algorithms for biomedical applications.
\end{IEEEbiography}

\begin{IEEEbiography}[{% Figure removed}]{Omid Kavehei} is an Associate Professor in the Faculty of Engineering at The University of Sydney where he is Deputy Head of School of Biomedical Engineering. Before this position, he was a Research Fellow in Microelectronics at the Centre for Neural Engineering with The University of Melbourne and a continuing academic at the Royal Melbourne Institute of Technology in Melbourne. His research interests include biomedical microsystems, biomedical signal processing, and innovative computational and security approaches based on nanotechnology, micro-/nano-electronics, and data analytics. He was a Visiting Project Scientist in Microelectronics at the University of California, Santa Barbara, in 2014. He was an Australian Government's Endeavor Research Fellow, a SOAR Fellow at the University of Sydney in 2019 and an awardee of the 2021 Ramaciotti Awards for Biomedical Research. In 2021 and 2022, he was awarded the Dean of Engineering and Vice-Chancellor Excellence Awards in Research and Teaching at the University of Sydney, respectively. He is the co-founder and Director of a neurotechnology startup, BrainConnect Pty Ltd, and a quantum sensing startup, deteQt Pty Ltd.
\end{IEEEbiography}
\end{document}
