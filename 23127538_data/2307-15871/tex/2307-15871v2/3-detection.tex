...
\begin{table}[ht]
    ...
    \end{tabular}
    \caption{Our $\cliquedet{k, \ell}$ exponent for various values of $k, \ell$ with the best current bound on $\omega$ and rectangular matrix multiplication \cite{VXXZ24}. See also \cite{van2019dynamic} for a way to bound $\omega(a, b, c)$ for arbitrary $a, b, c > 0$ from values of $\omega(1, x, 1)$. 
