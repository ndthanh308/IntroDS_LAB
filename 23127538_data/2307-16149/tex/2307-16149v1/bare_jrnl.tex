...
In this section, we first give a description of our datasets. Then we evaluate the performance of \textit{LSTMDiff} on the ECF problem. Afterwards, our proposed and baseline ETD methods are introduced. Lastly, we compare the performance of the above methods on the ETD problem. Code and more intuitive figures and experimental results can be found in the supplementary materials$\footnote{\textbf{Supplementary material \textit{(that includes codes, comprehensive results)} can be accessed through the following links:} \url{https://drive.google.com/drive/folders/1N17aPLe5LHqVsZA3gCQXFG9A4G6g0rmg?usp=sharing}}$.
