...
\end{tabular}
\caption{Resulting estimates of causes of changes in fertility rates from real data of Section \ref{section_simulations}. Here, $F$ is a Gaussian distribution.}
