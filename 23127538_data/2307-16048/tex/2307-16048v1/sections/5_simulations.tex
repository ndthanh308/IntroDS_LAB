...
\end{tabular}
\caption{Performance of different algorithms on the three benchmark datasets of Section \ref{Section_benchmarks}. The first number represents the ``percentage of discovered correct causes'', and the second is the ``percentage of no false positives''. }
\label{Table_results}
\end{table}
