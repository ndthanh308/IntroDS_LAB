\section{\boldmath $(\alpha, \beta, \gamma)$-MMS Allocation}\label{sec:or}
...
\textbf{Case 2} $\cdots S_4[S_2]^{t}\cdots$: This case cannot happen because $S_2$ was not feasible when $S_4$ was performed and the set of items in $S_2$ doesn't change after an $S_4$. 
\medskip
