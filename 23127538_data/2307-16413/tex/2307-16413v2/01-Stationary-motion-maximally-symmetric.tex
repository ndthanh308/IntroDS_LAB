...
\end{eqnarray}
where $\zeta\in \{0,-1,1\}$ corresponds to whether the boundary condition specified at infinity is transparent, Dirichlet or Neumann respectively. We will restrict our analysis to transparent boundary conditions for simplicity. In \fig{fig:anti-deSitter-response}, the response rate of an Unruh-de Witt detector in stationary motion with acceleration and torsion with the parameter values chosen for periodicity in geodesic distance when $\tau\to it$ is illustrated. The transition rate do not correspond to the thermal spectrum %with temperature proportional to one of $\{q_-,q_+\}$
due to the presence of complex poles with real parts. 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure environment removed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
