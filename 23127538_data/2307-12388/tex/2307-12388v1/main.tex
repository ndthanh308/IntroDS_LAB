...
\documentclass[letterpaper, 10 pt, review]{ieeeconf}  % Comment this line out
                                                          % if you need a4paper
...
\author{Longchao Da, Hao Mei, Romir Sharma and Hua Wei$^\dagger$% <-this % stops a space
% \thanks{This work was supported by xxxxx}% <-this % stops a space
\thanks{\boldmath$^\dagger$Corresponding author: Hua Wei with Longchao Da, Hao Mei, are at the Department of Informatics, New Jersey Institute of Technology, Newark, New Jersey, USA
        {\tt\small \{hua.wei, ld49, hm467\}@njit.edu}}%
\thanks{Author: Romir Sharma is with the West Windsor-Plainsboro High School South, West Windsor, New Jersey, USA
        {\tt\small sharmaromir@gmail.com}}%
}
