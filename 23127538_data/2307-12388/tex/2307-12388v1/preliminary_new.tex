...
\begin{itemize}
    ...
    \item Transition dynamics $P$: Given current state $s_t \in \mathcal{S}$ and action $a_t \in \mathcal{A}$, the transition dynamics $P(s_{t+1}| s_t, a_t)$ maps $\mathcal{S} \times \mathcal{A} \rightarrow \mathcal{S}$, describing the probability distribution of next state $s_{t+1} \in \mathcal{S}$. In this paper, we use transition dynamics and transition probability distribution interchangeably. 
