...
\usepackage{bm}
\usepackage[maxbibnames=99,doi=false,isbn=false,url=false]{biblatex}
\renewbibmacro{in:}{}
\usepackage{csquotes}
...
\input{Averaging.tex}
\input{Exponential_convergence.tex}
\input{Proof_main_results.tex}
\input{Exit_from_neighborhood_of_critical_points.tex}
