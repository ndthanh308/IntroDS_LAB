...
\begin{prop}The $(w_\theta(\cdot, Y))_{\theta \in \SS^{\dimy-1}}$ are uniformly locally Lipschitz \citep{discrete_sliced_loss} Prop. 2.2.1.\label{prop:w_unif_locLip}\
