...
\title{Gravitational Waves Background (NANOGrav) from Quintessential Inflation}
...
%\cite{eLISA:2013xep}
\bibitem{eLISA:2013xep}
P.~A.~Seoane \textit{et al.} [eLISA],
