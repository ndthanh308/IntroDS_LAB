...
In contrast, our items take up most of the user's mobile screen when presented, and we are able to deduce accurate item-level view labels from logged scrolling behaviour. See e.g.~\cite{Jeunen2023_C3PO} for work dealing with this setting.}
