...
\section{Perspectives going forward}\label{sec:beyond}
...
The main assumption that makes importance sampling work, is that no actions with non-zero probability under the target policy can have zero probability under the logging policy.
