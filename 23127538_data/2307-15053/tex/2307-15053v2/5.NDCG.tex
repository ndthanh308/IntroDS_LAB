...
\subsection{Empirical Evidence on Public Data}
...
\begin{description}    
    \item[\textbf{RQ1}] \textit{Do DCG and normalised DCG disagree when ranking recommendation models in typical offline evaluation setups?}
\end{description}
...
All source code, including hyperparameter ranges, is available 
at \href{https://github.com/olivierjeunen/nDCG-disagreement/}{github.com/olivierjeunen/nDCG-disagreement}.
