...
\begin{description}
    ...
    \item[\textbf{RQ4}] \textit{Are differences in any of the considered offline evaluation metrics predictive of differences in online metrics?}
\end{description}
...
To provide empirical evidence for research questions 1--4, we require access to a \emph{ground truth} online metric.
