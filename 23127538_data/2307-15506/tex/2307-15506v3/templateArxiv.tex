...
A directly proportional relationship is observed between improved image quality and higher views. As shown in \autoref{tab:MSE_SSIIM}, calculated mean MSE values decrease and mean SSIM values increase with more projection views for the internal test set and the external Luna16 dataset. Although mean MSE and SSIM values are marginally better for the internal test set, the model achieves comparable results on the external Luna16 dataset.
