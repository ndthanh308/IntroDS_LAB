...
\begin{table}[t]
    \centering
    \caption{\textbf{Performance comparison with SOTA methods (Avg. over four replicate).} The two best results for each protocol are highlighted in \textbf{bold} and \underline{underlined}. Note that “IN” refers to “ImageNet-Pretrained,” and “e2e” refers to end-to-end training.}  
    %\resizebox{\linewidth}{!}{
    %\resizebox{\textwidth}{!}{ 
\resizebox{\textwidth}{!}{
    ...
    AE & N & Rec.& 66.9 & 66.1 & 55.9& 60.3& 70.0 & \multicolumn{1}{c}{65.4}  \\
    AE-U~\cite{mao2020abnormality} & N & Rec.& \underline{86.7} & \underline{84.7} & 73.8& 72.8&91.0 & \multicolumn{1}{c}{83.2}  \\
    f-AnoGAN~\cite{schlegl2019f}& N & Rec.& 79.8 & 75.6 & \textbf{76.3}& \textbf{74.8}&84.1 & \multicolumn{1}{c}{79.2}  \\
    IGD~\cite{chen2022deep}& N & Rec.& 81.2 & 78.0 & 59.2& 58.7& 85.2 & \multicolumn{1}{c}{80.3}  \\
    
    DRAEM~\cite{zavrtanik2021draem}& N&  Rec.+SSL& 62.3 & 61.6 &  63.0 & 68.3 & 65.5 & \multicolumn{1}{c}{62.4}  \\
    %CutPaste$^{\text{IN}}$~\cite{li2021cutpaste}& N&  SSL+GDE & 79.4 & 74.4 & 70.2 & 69.8 & NN & \multicolumn{1}{c}{NN}  \\
    CutPaste$^{\text{e2e}}$~\cite{schluter2022natural} & N&  SSL & 55.0 & 58.0 & 54.6 & 55.5 & 58.0 & \multicolumn{1}{c}{-}  \\
    AnatPaste~\cite{sato2022anatomy}& N&  SSL & 83.1 & 83.7 & 66.0 & 66.2 & 94.0 & \multicolumn{1}{c}{93.5}  \\
    FPI~\cite{tan2020detecting} & N&  SSL & 47.6 & 55.7& 48.2 & 49.9& 70.5 & \multicolumn{1}{c}{-}\\
    PII~\cite{tan2021detecting} & N&  SSL & 82.9 & 83.6& 65.9 & 65.8& 92.2 & \multicolumn{1}{c}{-}\\
    
   % \midrule
    
    NSA~\cite{schluter2022natural} & N&  SSL & 82.2 & 82.6 & 64.4 & 65.8 & 94.1 & \multicolumn{1}{c}{-}\\
    ...
    \midrule
    CutPaste$^{\text{e2e}}$~\cite{schluter2022natural} & Y&  SSL & 59.8 & 61.7 & 59.2 & 60.0 & \multicolumn{2}{c}{-}  \\
    AnatPaste~\cite{sato2022anatomy}& Y&  SSL & \underline{84.4} & \underline{85.5} & 67.1 & \underline{67.5} & \multicolumn{2}{c}{-}  \\
    FPI~\cite{tan2020detecting} & Y&  SSL & 46.6 & 53.8& 47.4 & 49.4&  \multicolumn{2}{c}{-}\\
    PII~\cite{tan2021detecting} & Y&  SSL & 84.3 & 85.4& 66.8 & 67.2&  \multicolumn{2}{c}{-}\\
    
   % \midrule
    
    NSA~\cite{schluter2022natural} & Y&  SSL & 84.2 & 84.3 & 64.4 & 64.8 &  \multicolumn{2}{c}{-}\\
    DDAD-AE~\cite{cai2022dual} ($\mathcal{A}_{iner}$)   & Y&  Rec. & 81.5 & \multicolumn{1}{c}{-} & \underline{71.0} & \multicolumn{1}{c}{-} & \multicolumn{2}{c}{-}
    \\
    \midrule
...
\textbf{Implementation details.}
 We adopt AdamW~\cite{loshchilov2018decoupled} optimizer and set the learning rate ($lr$) and batch size to $2.5e\text{-}4$ and 16, where we linearly warm up the $lr$ for the first 20 epochs and decay it following a cosine schedule thereafter till 150 epochs. We follow the exact recipe as \cite{xiao2023delving} for other hyperparameters (see \textbf{Supplementary Material}). The number of generated masks $L$ per image is set to 2 and 4 for the adaptation and test stages (see ablation in \textbf{Supplementary Material}). We use PyTorch 1.9~\cite{paszke2019pytorch} and train each model on a single GeForce RTX 2080 Ti GPU. We use the area under the ROC curve (AUC) and average precision (AP) for the evaluation metrics.
