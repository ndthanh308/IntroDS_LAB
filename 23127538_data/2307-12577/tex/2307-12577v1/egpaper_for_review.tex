...
\multirow{2}{*}{Init. Methods}                     & \multicolumn{3}{c}{RSNA}  &  & \multicolumn{3}{c}{SIIM} &  & \multicolumn{3}{c}{CheXpert} \\ \cmidrule(r){2-4} \cmidrule(lr){6-8} \cmidrule(l){10-12} 
  ...
  GLoRIA     \cite{huang2021gloria}                         &84.12 $\pm$  0.47 & 86.83 $\pm$ 0.53 & 89.13 $\pm$ 0.12                    &  &   85.05 $\pm$ 1.62     &   88.51 $\pm$ 0.78     &   92.11 $\pm$ 0.18     &  &       83.61 $\pm$ 0.52   &   87.40 $\pm$ 0.39      &  \textcolor{blue}{88.34 $\pm$ 0.12}       \\
 ...
 %MedCLIP                          & - & 87.78 $\pm$ 0.47$ & 89.41 $\pm$ 0.10  &  & -  & - & 92.34 $\pm$ 0.10 &  &    -  &   -  &  -    \\
...
We compare our method with several widely-used initialization methods, including three image-level SSL methods (MoCo, MoCoV2, SimCLR), four medical VLP methods (ConVIRT, GLoRIA, LoVT, MGCA), and ImageNet pre-training. All SSL and VLP methods are re-trained on the MIMIC-CXR dataset with their official implementations and default hyper-parameters. ConVIRT applies only a global alignment loss, and may not perform well on locality-aware downstream tasks. GLoRIA, LoVT and MGCA are three SOTA VLP methods targeting medical images and reports with well-designed local alignment losses. 
...
\caption{Semantic segmentation results by fine-tuning on SIIM. All methods are trained on different portions of the training set from 1\% to 100\% and evaluated by Dice.}
 ...
 \begin{tabular}{lccc}
  ...
  &     41.72 $\pm$ 0.69
  \\
  GLoRIA       \cite{huang2021gloria}                 &     18.78 $\pm$ 2.85      &  \textcolor{blue}{33.55 $\pm$ 2.14}          & \textcolor{blue}{45.46 $\pm$ 1.69}             \\
...
\begin{table}[t]
  ...
  MGCA                \cite{wang2022multi}          &       \bf{-}   &     \textcolor{blue}{19.10 $\pm$ 1.83}    &       21.33 $\pm$ 1.63      \\
   %MedCLIP         &       -   &     -  &       -      \\
