...
Empirically, we follow \citet{Heimbach2023} and compute impermanent loss for ``symmetric'' positions around the current pool price, that is $p_\ell=p_0 \alpha^{-1}$ and $p_u= p_0\alpha$, with $\alpha>1$. We allow for a time lag of 200 blocks between $p_0$ and $p_1$ (approximately 45 minutes).