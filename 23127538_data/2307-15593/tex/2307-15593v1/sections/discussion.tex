...
The computational complexity of our watermark detection algorithms is linear 
in the length of the watermark key sequence, which is also 
the total number of distortion-free watermarked tokens the LM provider may generate.
In contrast, the complexity of the watermark detection algorithms of both \citet{christ2023undetectable}
and also \citet{aaronson2023openai} and \citet{kirchenbauer2023watermark} is linear in 
...
Whether this apparent trade-off between these desiderata is fundamental is an interesting open question.
...
we caveat this speculation by noting that we did not ever run such large $n$ with our implementation (and we did not take advantage of parallellism).
