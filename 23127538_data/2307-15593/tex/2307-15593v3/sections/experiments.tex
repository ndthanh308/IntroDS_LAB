...
We vary the length $n$ of the watermark key sequence $\xi$ in Figure~\ref{fig:experiment-2-combined}
...
and the effect of larger $n$ on statistical power is mild (as shown in Figure~\ref{fig:experiment-2-combined}),
...
In fact, for Russian the power of both {\gumb} and {\kgwtwo} stagnates (or even diminishes) with increasing text length,
perhaps due to the inherent ambiguity in translating longer texts.
...
\subsection{Case study: instruction following}\label{sec:exp-instruct}
