...
Besides, it should be noticed that the two types of methods, LSS and BEVFormer, cannot be compared directly as they have different network architectures. \uwave{We list these results here for showing the potential of height-based methods.}
