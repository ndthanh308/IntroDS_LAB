...
%
\be
    L=2\ell \log\left[2\sinh\left(\frac{\tau_*}{\ell}\right)\right],
...
%
\be
\alpha=\left[\frac{\sinh\left(\frac{\beta_\Ri}{2\ell}-\frac{\tau_*^{i,X}}{\ell}\right)}{\sinh\left(\frac{\tau_*^{i,X}}{\ell}\right)}\right]^{-2m_i\ell}\left[\frac{\sinh\left(\frac{\beta_\Ri}{2\ell}-\frac{\tau_*^{j,X}}{\ell}\right)}{\sinh\left(\frac{\tau_*^{j,X}}{\ell}\right)}\right]^{-2m_j\ell}.
\ee
%
