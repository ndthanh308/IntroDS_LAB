...
However the \texttt{Unc\_Counterpart} column now contains the radius of the counterpart (rather than its localization uncertainty) whenever the counterpart was treated as extended during the association procedure. $\gamma$-ray point sources associated to extended counterparts can be recognized because they all have \texttt{ASSOC\_PRO\_BAY} = 0.8.
