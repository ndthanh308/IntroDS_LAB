...
\thanks{Yongqi Zhai, Ronggang Wang are with Peng Cheng Laboratory, 518000, Shenzhen, China.}
...
JPEG2000~\cite{maryline1999jpeg2000}, AVC~\cite{schwarz2007overview}, HEVC~\cite{sullivan2012overview}, and VVC~\cite{bross2021vvc}
...
~\cite{wu2021learned,ma2019image,bao2022nonlinear,wang2020ensemble,tang2023joint,fu2023asymmetric,chen2023toward,deng2023masic,guo2021causal,balle2016end,theis2017lossy,balle2018variational,li2018learning,minnen2018joint,hu2020coarse,ma2020iwave}
have emerged, showcasing impressive performance gains.
% Figure environment removed
Notably, certain learned image compression models~\cite{minnen2020channel,cheng2020learned,zou2022the,qian2020learning,liu2023learned,xie2021enhanced,he2022elic,jiang2022mlic,chen2021nic,gao2021neural,chen2022two,koyuncu2022contextformer,duan2023lossy,liu2023learned,jiang2023slic} are already comparable to
...
while maintaining high-quality compression capabilities.
  ...
  Additionally, self-attention~\cite{vas2017attention,liu2021swin,lu2021tic, zou2022the,liu2023learned,tang2023joint,guo2021causal},
...
% \end{lstlisting}
  ...
  When computing BD-rate, VTM-17.0 Intra under YUV444 is employed as anchor. Unofficial weights of ELIC\footnote[2]{\url{https://github.com/VincentChandelier/ELiC-ReImplemetation}} are used to
