...
%                                     \toctitle is used
%
\author{Zachary P. Neal\inst{1} \and Jennifer Watling Neal}
%
\authorrunning{Zachary P. Neal and Jennifer Watling Neal} % abbreviated author list (for running head)
%
%%%% list of authors for the TOC (use if author list has to be modified)
\tocauthor{Zachary P. Neal and Jennifer Watling Neal}
%
...
Burris, V.: Interlocking directorates and political cohesion among corporate
  elites. American journal of sociology  111(1),  249--283 (2005)

\bibitem{godard2022fastball}
Godard, K., Neal, Z.P.: fastball: a fast algorithm to randomly sample bipartite
  graphs with fixed degree sequences. Journal of Complex Networks  10(6),
  cnac049 (2022)
...
Gornik, A.E., Neal, J.W., Lo, S.L., Durbin, C.E.: Connections between
  ...
  preschool setting. Social Development  27(2),  335--350 (2018)
...
Hanish, L.D., Martin, C.L., Fabes, R.A., Leonard, S., Herzog, M.: Exposure to
  ...
  processes. Journal of abnormal child psychology  33,  267--281 (2005)
...
Neal, J.W., Brutzman, B., Durbin, C.E.: The role of full-and half-day preschool
  attendance in the formation of children's social networks. Early Childhood
  Research Quarterly  60,  394--402 (2022)
...
Neal, J.W., Durbin, C.E., Gornik, A.E., Lo, S.L.: Codevelopment of
  ...
  school year. Journal of Personality and Social Psychology  113(4),  627
  (2017)

\bibitem{neal2022inferring}
Neal, J.W., Neal, Z.P., Durbin, C.E.: Inferring signed networks from
  preschoolers’ observed parallel and social play. Social Networks  71,
  80--86 (2022)

\bibitem{neal2014backbone}
Neal, Z.P.: The backbone of bipartite projections: Inferring relationships from
  co-authorship, co-sponsorship, co-attendance and other co-behaviors. Social
...
Neal, Z.P.: backbone: An r package to extract network backbones. PloS one
  17(5),  e0269137 (2022)
...
\bibitem{rsiena}
Ripley, R.M., Snijders, T.A.B., B'{o}da, Z., V"{o}r"{o}s, A., Preciado, P.:
  Manual for {Siena} version 4.0. Tech. rep., Oxford: University of Oxford,
  Department of Statistics; Nuffield College (2023), r package version
  1.3.14.4. https://www.cran.r-project.org/web/packages/RSiena/

\bibitem{saracco2015randomizing}
Saracco, F., Di~Clemente, R., Gabrielli, A., Squartini, T.: Randomizing
  bipartite networks: the case of the world trade web. Scientific reports
  5(1),  1--18 (2015)
...
Saracco, F., Straka, M.J., Di~Clemente, R., Gabrielli, A., Caldarelli, G.,
  ...
  entropy-based approach. New Journal of Physics  19(5),  053022 (2017)

\bibitem{strona2018bi}
Strona, G., Ulrich, W., Gotelli, N.J.: Bi-dimensional null model analysis of
  presence-absence binary matrices. Ecology  99(1),  103–115 (2018)

\bibitem{zweig2011systematic}
Zweig, K.A., Kaufmann, M.: A systematic approach to the one-mode projection of
  bipartite graphs. Social Network Analysis and Mining  1(3),  187–218 (Jul
  2011)
