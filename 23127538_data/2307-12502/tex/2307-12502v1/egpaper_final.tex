...
%%%%%%%%% TITLE
\title{Cross Contrastive Feature Perturbation for Domain Generalization}
...
\begin{algorithm}[t]\label{alg1}
	...
	\renewcommand{\algorithmicensure}{\textbf{Output:}}
        \setstretch{1.1}
	\caption{\textbf{:} Cross Contrasting Feature Perturbation (CCFP)}
	% \label{alg1}
	\begin{algorithmic}
