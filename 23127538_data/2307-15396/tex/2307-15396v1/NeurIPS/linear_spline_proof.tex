...
where $C_p:=2^{p-1}[3^{p-1}((2^{p}+1)+2)+1]$. \qed{\text{ Theorem } \ref{thm:linear-splines}}
...
and the lemma follows. \qed{ Lemma \ref{lem:R_0+R_n-spline}}
...
\begin{proof}[Proof of Lemma \ref{lem:poison-equivalence-splines}]
    ...
    \begin{align*}
        ...
        \\
        &\xrightarrow{\text{a.s.}} 0~. \qed{ \text{ Lemma }\ref{lem:poison-equivalence-splines}}
    \end{align*}
