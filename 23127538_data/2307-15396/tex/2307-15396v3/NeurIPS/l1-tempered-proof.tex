...
$$\lim_{n\rightarrow \infty} \Pr_S \left[ R_0+R_n \leq \gamma \right]=1. $$
\end{proof}
...
\begin{align*}
    ...
    & \leq \frac{2^p}{2-p},
\end{align*} 
where the last inequality follows from Claim \ref{clm:Gamma(z)} and the fact that $1\leq p < 2$. 
\end{proof}
...
$$ \frac{1}{2z} \leq \Gamma(z) \leq \frac{1}{z}.$$
