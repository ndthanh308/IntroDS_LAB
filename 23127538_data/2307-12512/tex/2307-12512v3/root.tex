...
\title{\name: Accurate UWB Localization to Realize XR Deployments}
...
\noindent This paper is accepted by ACM SenSys 2023. The accepted version will be available soon in the ACM Digital Library. The reference of the paper is  {\it Aditya Arun, Shunsuke Saruwatari, Sureel Shah, Dinesh Bharadia, ``XRLoc: Accurate UWB Localization to Realize XR Deployments,'' Proceedings of ACM Conference on Embedded Networked Sensor Systems (ACM SenSys'23), 2023.}
\end{textblock*}

\maketitle

\input{intro/intro17}
\input{background/background9}
\input{design/design10}
\input{implementation/implementation8}
\input{evaluation/eval5}
\input{related_work/related4}
\input{discussion/discussion2}
