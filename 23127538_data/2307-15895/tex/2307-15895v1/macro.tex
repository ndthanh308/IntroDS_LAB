...
% \newcommand{\ryx}[1]{\textcolor{cyan}{(RYX: #1)}}
% \newcommand{\peng}[1]{\textcolor{blue}{(Peng: #1)}}
\newcommand{\fix}[1]{{#1}}
% \newcommand{\review}[1]{\textcolor{red}{(Review: #1)}}
...
\newcommand{\toolname}{\textsc{Nodrop}\xspace}
...
\acrodef{tib}[TIB]{Thread Information Block}
