...
\todo[inline]{Suggestion: Motivation that paves the way to why is it beneficial to have a formal terminology for specification for agent- based model in the field of social computational sciences}. \todo[inline]{An argumentation to sell the proposed terminology from social computational science  agent-based modeling perspective. 
}  
