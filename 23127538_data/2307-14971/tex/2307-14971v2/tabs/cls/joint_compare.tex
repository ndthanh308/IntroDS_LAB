...
PointMLP~\cite{pointmlp} & 12.6 & 85.4$\pm$0.3 & 94.1 \\
...
\midrule[0.6pt]
\multicolumn{4}{c}{\textit{With Pre-trained Image Model}}\\
\midrule[0.6pt]
...
\midrule[0.6pt]
PointMLP (reproduce) & 12.6 & 87.4$^\dagger$ & 93.7$^\dagger$ \\
