...
In this work, we introduce a new architecture to incorporate cross-lingual pretraining into diffusion-based text generation, with a well-designed pre-training task, evaluate the generated text through automatic and human evaluations. We will expand our model into further languages, to build a strong multi-lingual model for more cross-lingual translation tasks.
