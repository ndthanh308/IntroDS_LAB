...
small elliptic weights \eqref{wdef}, for all $s$,
which we refer to as the \textit{elliptic consistency
 relation}
\begin{gather}
w_{aq^2,bq^2;q,p}(s,s) w_{a,c;q,p}(s,s) w_{bq^2,cq^2;q,p}(s,s)=w_{b,c;q,p}(s,s) w_{aq^2,cq^2;q,p}(s,s) w_{a,b;q,p}(s,s).\label{eq:estr}
\end{gather}
