...
\begin{itemize}
    ...
    \item In the context of modified gravity theories, see e.g. \cite{Artymowski2019, Heisenberg2019-II, Benetti2019, Sadeghi2019,Oikonomou2022, Sadeghi2021}.
...
Here we only provide a short succinct summary of the state of the Swampland program, for more details we refer the reader to \cite{Palti2019,vanBeest:2021lhn}.
...
\begin{equation}\label{eq:cqf_perturbed_kg}
    \ddot{\delta \phi} + 3 H \dot{\delta \phi} + \mathfrak{m}_c \dot{\phi} + \left[k^2/a^2 + V''(\phi)\right] \delta\phi = 0~,
\end{equation}
with $\mathfrak{m}_c = - 3 \dot{\varphi}$ in the conformal Newtonian gauge (and $\mathfrak{m}_c = \dot{h}/2$ in the comoving synchronous gauge). Here $V'(\phi)$ and $V''(\phi)$ denote the first and second derivatives of the potential $V(\phi)$ with respect to the field $\phi$. The field density and pressure are given by
