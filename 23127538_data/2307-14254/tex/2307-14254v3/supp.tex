...
% \section{Bilayer model with Tunable vertical coupling}
% Here we plot the results of a model obtained in the similar lines to spin-1 model. In construction, this model is equivalent to spin-1 model with an aim to decipher the role of the vertical coupling between the minispin layers. We find a phase transition in the non-zero vertical coupling with critical point ($g_c$) shifting towards right by 0.2. We show the results for one value of $J_H$ (0.025). 
