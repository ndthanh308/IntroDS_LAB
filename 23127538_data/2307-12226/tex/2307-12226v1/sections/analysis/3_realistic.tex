...
The aim of our active learning approach is to, instead of randomly selecting the next observed class, actively select the next class so as to maximize the total size of the locus---i.e., the number of possible classes that can be output using $\loki$. 
