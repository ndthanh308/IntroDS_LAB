...
\thanks{This project has received funding from the European Union’s Horizon 2020 research and innovation programme under the Marie Skłodowska-Curie grant agreement No 860370-Menelaos\_NT project.}
\end{abstract}
...
Our coding scheme, called gradient-Combinatorial (GComb) \cite{lopezparedes_2}, iteratively adds $[\vec{a}^j]_{j=1}^{n}$, and consists of the following steps:
