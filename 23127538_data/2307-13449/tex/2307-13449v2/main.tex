...
\begin{enumerate}[leftmargin=*]
    ...
    \item The polynomial Lagrangian is invariant under the kind of gauge transformations which can gauge away certain parts of the general solutions of the equations of motion and their combinations (e.g. symmetries \eqref{AB_trans_H12} and \eqref{B_trans_H12} in the case of ${\cal L}_{H12}$), leading to the self-duality relation.
\end{enumerate}
\vspace{-0.5em}
As the polynomial M5-brane Lagrangians meet both the above criteria, they form self-sufficient systems. They have all the essential symmetries and dynamics which characterise an M5-brane Lagrangian.
