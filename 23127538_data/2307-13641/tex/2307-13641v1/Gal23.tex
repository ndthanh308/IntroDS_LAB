...
\section{Introduction}
  ...
  \cite{GLR19}, the authors introduced an 
  the notion of the strict Newtonian capacity inradius for open sets in $\mathbb{R}^2$, with the logarithmic capacity 
...
\subsection{The Poincar\'e inequality}
  ...
  This nomenclature arises as $\lambda_1(D)$ may be interpreted as the smallest eigenvalue of the Dirichlet--Laplacian. In particular, if 
  $\lambda_1(D)$ is attained at $\psi\in H_0^1(D)$, then $\psi$ is a distributional solution to the boundary value problem
  \[ 
    \begin{cases} 
  ...
  in mathematical physics, e.g., it is the fundamental mode of vibration for a membrane of given shape with fixed boundary.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \end{proof}
  Note that, with the hypotheses of \Cref{C:Hormanderlambda}, \Cref{L:Lee} yields $\lambda_1(D)\geq c/(M-\widetilde{m})$ for any 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \end{proof}
%\section{A localized Poincar{\'e} inequality}
