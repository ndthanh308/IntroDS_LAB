...
\nu_{\rm eff} (H) &\simeq \frac{1}{16\pi^2} \Big(\xi - \frac{1}{6}\Big) \, (\kappa^2 \, m^2)\,  \, {\rm ln}\Big(\frac{m^2}{H^2}\Big)  \,
\end{align}
...
Eur.Phys.J.C  \textbf{82} (2022) no.6, 551.
...
Eur.Phys.J.C  \textbf{80} (2020) no.8, 692.
