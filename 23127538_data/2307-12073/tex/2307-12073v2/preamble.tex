...
\usepackage{amsmath}%,exscale,latexsym,float,eucal}
\usepackage{tikz, amssymb,bm,color, amsthm}
...
\newcommand{\XCD}{\pname{\raisebox{1.5pt}{$\chi$}$_{cd}$}}
...
\newcommand{\TETHS}{Further, the problem cannot be solved in time \ensuremath{2^{o(\mid V(G)\mid)}}, unless the ETH fails}
