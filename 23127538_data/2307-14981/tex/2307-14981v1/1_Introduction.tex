...
\begin{itemize}
    ...
    \item We explicitly model the uncertainty in map priors as a parameter and propose an uncertainty tempering scheme to guide the training process of neural radiance field.
...
Our proposed method is easy to implement, can be easily plugged in existing NeRF algorithms, and has the capability of extending to other formats of priors.