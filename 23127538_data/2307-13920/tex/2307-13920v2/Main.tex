...
\begin{eqnarray}\label{eq:mainresult}
    ...
    \begin{aligned}
    &\sqrt{\frac{1}{2}-\frac{k}{4e^{S(E)}}+\frac{\log (e^{\frac{3}{2}}\frac{\Delta E}{a})}{4\pi^2}\frac{k^2}{e^{2S(E)}}}+O(e^{2S(E)}k^{-3})&  (k&<e^{S(E)})\\
    &\sqrt{\frac{e^{2S(E)}}{2k^2}-\frac{e^{3S(E)}}{4k^3}+\frac{\log (e^{\frac{3}{2}}\frac{\Delta E}{a})}{\pi^2}\left(1-\frac{e^{S(E)}}{2k}\right)^2}+O(e^{-S(E)})&  (k&>e^{S(E)}).
    \end{aligned}
    \right.
\end{eqnarray}
...
\begin{equation}\label{eq:ntu}
    \delta S(\rho)^{\text{Ranndom Pure State}}
    =\left\{
    \begin{aligned}
...
\begin{equation}\label{eq:renyifluctuationtubular}
    ...
    \begin{aligned}
    &\log (e^{\frac{3}{2}}\frac{\Delta E}{a})\frac{(n-1)(m-1)}{4\pi^2 e^{4S(E)}k^{n+m-4}}+O(k^{-(n+m+1)})&  (k&<e^{S(E)})\\
...
\begin{equation}\label{eq:entropyfluctuationtubular}
    ...
    \begin{aligned}
    &\sqrt{\log (e^{\frac{3}{2}}\frac{\Delta E}{a})}\frac{k}{2\pi e^{2S(E)}}+O(e^{2S(E)}k^{-4})&  (k&<e^{S(E)})\\
...
\begin{equation}\label{eq:summary2}
    ...
    \begin{aligned}
    &~\,0 ~~ +O(k^{-1})&  (k&<e^{S(E)})\\
    & \frac{1}{\pi}\sqrt{\frac{3}{2}+\log \frac{\Delta E}{a}}+O(e^{-S(E)})&  (k&>e^{S(E)})~.
    \end{aligned}
    \right.
\end{equation}
