...
\end{split},
\end{equation}
these approaches~\citep{hao2022iron,characmpctranformer} focus either on designing approximate protocols for function $\tanh$
or using  existing general MPC protocols of exponentiation and reciprocal for $\mathsf{sigmoid}$. 
