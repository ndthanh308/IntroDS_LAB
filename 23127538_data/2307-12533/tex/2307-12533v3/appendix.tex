...
\section{Details of Experimental Models}\label{models}
...
\begin{itemize}
    ...
    It has approximately $774$ million parameters.
\end{itemize}

%\section{Time in WAN}
%\input{Table/time_wan}

\section{\puma\ for LLaMA-7B}
...
In Figure~\ref{fig:llamaout}, we show the output tokens of LLamA-7B (with fixed randomness) given the prompt: \textit{Q: What is the largest animal?}  It can be seen that our \puma\ outputs the same tokens as LLaMA-7B does in plaintext for generating more than 20 tokens. 
