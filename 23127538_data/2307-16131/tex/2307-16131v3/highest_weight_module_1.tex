...
\end{equation*}
Then the Grothendieck group of projective modules becomes a $\mathbf{U}$-module and there is an isomorphism $[Proj(R^{\Lambda})] \cong {_{\mathcal{A}}L(\Lambda)}.$ The key ingredient of their construction is the following exact sequence (See \cite[Theorem 4.7]{MR2995184} for detials.) 
\begin{equation*}
...
Let $\mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}_{\mathbf{V},\Omega})$ be the  $G_{\mathbf{V}}$-equivariant derived category of constructible sheaves on $\mathbf{E}_{\mathbf{V},\Omega}$. For any $n \in \mathbb{Z}$, we denote by $\mathbf{\Sigma}^{n}$ the shift functor, $(\frac{n}{2}
...
\begin{remark}\label{remarkFD}
	(1) Indeed, the Fourier-Deligne transformation gives equivalence between the bounded derived categories $\mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}_{\mathbf{V},\Omega})$ and $\mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}_{\mathbf{V},\Omega'})$. (See the proof of \cite[Theorem 3.13]{MR3202708}.) 
	
	(2) Similarly as \cite[Proposition 10.4.5]{Achar}, the Fourier-Deligne transformation also commutes with the induction functor   $\mathbf{Ind}^{\mathbf{V}}_{\mathbf{V'},\mathbf{V''}}: \mathcal{D}^{b}_{G_{\mathbf{V}'}}(\mathbf{E}_{\mathbf{V}',\Omega}) \times \mathcal{D}^{b}_{G_{\mathbf{V}''}}(\mathbf{E}_{\mathbf{V}'',\Omega}) \rightarrow \mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}_{\mathbf{V},\Omega})$ between bounded derived categories as in Proposition \ref{FD0}. Indeed, the authour in \cite{Achar} considered varieties over the complex field and Fourier-Laumon transformations, but his proof also works in our case by \cite[\uppercase\expandafter{\romannumeral3}. Theorem 13.2 and 13.3]{MR1855066}.  
\end{remark}
...
\end{equation*}
can be naturally extended to an action on objects of the semisimple category. (But it is not a functor, since it cannot defined on morphisms.)  More precisely, for any direct sum of simple perverse sheaves up to shifts $L=\bigoplus\limits K[n]$, we set
\begin{equation*}
...
\begin{lemma}\label{local}
	For any semisimple complex $L$ on $\mathbf{E}^{0}_{\mathbf{V},\mathbf{W},i}$, there is an isomorphism $(j_{\mathbf{V},i})_{!\ast} (L) \cong (j_{\mathbf{V},i})_{!} (L)$  in $\mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}_{\mathbf{V},\mathbf{W},\hat{\Omega}^{i}})/\mathcal{N}_{\mathbf{V},i}$. 
...
\xymatrix{
	\mathbf{E}^{0}_{\mathbf{V},\mathbf{W},i}\ar[d]_{\phi_{1}} & \mathbf{E}^{',0}_{\mathbf{V}'',\mathbf{W},i} \ar[l]_{\tilde{p}_{1}} \ar[r]^{\tilde{p}_{2}} \ar[d]_{\phi_{2}}& \mathbf{E}^{'',0}_{\mathbf{V}'',\mathbf{W},i}  \ar[r]^{\tilde{p}_{3}} \ar[d]_{\phi_{3}} & \mathbf{E}^{0}_{\mathbf{V}'',\mathbf{W},i}  \ar[d]_{\phi_{4}} \\
	\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\ $\times$\\$\mathbf{Grass}(\nu_{i}, \tilde{\nu}_{i})$}  & Z_{1} \ar[l]_-{q_{1}} \ar[r]^{q_{2}}  & Z_{2} \ar[r]^-{q_{3}}  & \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\ $\times$\\$\mathbf{Grass}(\nu_{i}, \tilde{\nu}_{i}+a_{i,j})$} 
}
\]
...
For $0 \leqslant r \leqslant \nu_{i}$ and $a=0,1$, we take graded spaces $\mathbf{V},\mathbf{V}'$   such that  $|\mathbf{V}'|+i=|\mathbf{V}|$. Fix a decomposition $\mathbf{V}=\mathbf{V}_{r}\oplus\mathbf{U}_{r}$ of $\mathbf{V}$   such that $|\mathbf{U}_{r}|=ri$ and a decomposition $\mathbf{V}'=\mathbf{V}'_{r-a}\oplus\mathbf{U}'_{r-a}$ of $\mathbf{V}'$   such that $|\mathbf{U}'_{r-a}|=(r-a)i$. Since the subset $'F_{r}$ of $\mathbf{E}^{r}_{\mathbf{V},\mathbf{W},i}$ consisting of $x$ such that $\mathbf{U}_{r}$ is $x$-stable is naturally isomorphic to $\mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},i}$, there is a closed embedding  $\iota_{\mathbf{V},r}:\mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},i} \rightarrow \mathbf{E}^{r}_{\mathbf{V},\mathbf{W},i}$.  Let $Q_{r}$ be the stablizer of $\mathbf{U}_{r}$ in $G_{\mathbf{V}}$ and $U_{r}$ be its unipotent radical, then 
$\mathbf{G}_{\mathbf{V}} \times_{Q_{r}} \mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},i} \cong \mathbf{E}^{r}_{\mathbf{V},\mathbf{W},i}$. By \cite[Theorem 6.5.10]{Achar}, there is an indcution equivalence $$(\iota_{\mathbf{V},r})^{\ast}[-{\rm{dim}}(G_{\mathbf{V}}/ Q_{r}) ] \circ \mathbf{For}^{G_{\mathbf{V}}}_{Q_{r}}:\mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}^{r}_{\mathbf{V},\mathbf{W},i} )\rightarrow \mathcal{D}^{b}_{Q_{r}}(\mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},i} ) \cong \mathcal{D}^{b}_{G_{\mathbf{V}_{r}}}(\mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},i} ),$$
where $\mathbf{For}^{G_{\mathbf{V}}}_{Q_{r}}$ is the forgetful functor, and the last equivalence holds by\cite[Theorem 6.6.16]{Achar}, since $Q_{r}/U_{r} \cong G_{\mathbf{V}_{r}} \times G_{\mathbf{U}_{r}}$ and  $U_{r},G_{\mathbf{U}_{r}}$ act trivially on $'F_{r}\cong \mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},i} $. We denote this equivalence by $(\iota_{\mathbf{V},r})^{_\clubsuit}$ and its quasi-inverse by $(\iota_{\mathbf{V},r})_{_\clubsuit}$. Similarly, there is also an indcution equivalence $$(\iota_{\mathbf{V}',r}-a)^{\ast}[-{\rm{dim}}(G_{\mathbf{V}'}/ Q'_{r-a}) ] \circ \mathbf{For}^{G_{\mathbf{V}'}}_{Q'_{r-a}}:\mathcal{D}^{b}_{G_{\mathbf{V}'}}(\mathbf{E}^{r-a}_{\mathbf{V}',\mathbf{W},i} )\rightarrow  \mathcal{D}^{b}_{G_{\mathbf{V}'_{r-a}}}(\mathbf{E}^{0}_{\mathbf{V}'_{r-a},\mathbf{W},i} ).$$
...
\xymatrix{
	...
	& \mathbf{E}^{0}_{\mathbf{V}'_{r-a},\mathbf{W},i} \ar[d]^{\phi_{\mathbf{V}'_{r-a},i}} \ar[u]_{\iota_{\mathbf{V}',r-a}}\\
     \txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\ $\times$\\ $\mathbf{Grass}(\nu_{i}-r, \tilde{\nu}_{i})$}
	&     \txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\ $\times$\\ $\mathbf{Flag}(\nu_{i}-1-r+a,\nu_{i}-r,\tilde{\nu}_{i})$} \ar[r]^-{q_{2,r,a}} \ar[l]_-{q_{1,r,a}}
	&\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\ $\times$\\ $\mathbf{Grass}(\nu_{i}-1-r+a, \tilde{\nu}_{i})$},
}
\]
where $j_{\mathbf{V},r}$ is the natural locally closed embedding and $q_{1,r}$, $q_{2,r-a}$ are natural projections.
\begin{definition}
...
\begin{proof}
	...
	Since $\phi_{\flat}$ and $\phi^{\ast}$ are quasi inverse to each other, we only need to calculate the difference between $(q_{2})_{!}(q_{1})^{\ast} (q_{2})_{!}(q_{1})^{\ast}$ and $(\tilde{q}'_{2})_{!}(\tilde{q}'_{1})^{\ast} (\tilde{q}_{2})_{!}(\tilde{q}_{1})^{\ast}$. 
	...
	\[
	\xymatrix{
		Y_{0} \ar[rr]^{\tilde{\pi}} \ar[dd]_{\tilde{\pi}'} &  & \txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}+1-n, \tilde{\nu}_{i})$} \\
		&  Y_{1} \ar[ul]^{r_{1}} \ar[r]^-{\pi_1} \ar[d]^{\pi'_1} &
		\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}+1-n,\nu_{i}+1,\tilde{\nu}_{i})$}
		\ar[u]_{q_{2}} \ar[d]^{q_{1}}\\
		\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}, \tilde{\nu}_{i})$}  & \txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i},\nu_{i}+1,\tilde{\nu}_{i})$}  \ar[l]_{q'_{1}} \ar[r]^-{q'_{2}} &  \txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}+1, \tilde{\nu}_{i})$} ,
	}
	\]
	where the varieties
	\begin{equation*}
	...
	Notice that when $\mathbf{V}^{2} \nsubseteq \mathbf{V}^{1}$, we have $\mathbf{V}^{0} = \mathbf{V}^{1}\cap\mathbf{V}^{2} , \mathbf{V}^{3}= \mathbf{V}^{1}\cup\mathbf{V}^{2}$, hence we can see that $\tilde{r}^{1}_{a}: Y^1_a\rightarrow Y_0^1$ is an isomorphism. By Lemma \ref{projection formula} and \ref{Lusztig BBD}, we have 
	\begin{equation*}
		\begin{split}
...
\end{lemma}
\begin{proof}
	We assume that $i,j$ are connected by some edges, the other case can be proved by a similar argument.  
	...
	We only need to calculate  $(q_{2})_{!}(q_{1})^{\ast} (q_{3})_{!}(q_{2})_{\flat}(q_{1})^{\ast}$ and $(\tilde{q}_{3}')_{!}(\tilde{q}'_{2})_{\flat}(\tilde{q}'_{1})^{\ast} (\tilde{q}_{2})_{!}(\tilde{q}_{1})^{\ast}$. Notice that  $$\nu_{i}'+n=\nu_{i}=\nu_{i}''=\nu'''_{i}+n,~\tilde{\nu}''_{i}=\tilde{\nu}_{i}+1=\tilde{\nu}'_{i},$$  $$\dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}=\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i},~\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}=\dot{\mathbf{E}}_{\mathbf{V}''',\mathbf{W},i}.$$ Consider the following commutative diagram
	\[
	\xymatrix{
		&  & & \txt{$\dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-n, \tilde{\nu}_{i}+a_{i,j})$}  \\
...
\begin{proof}
	...
	\[
	\xymatrix{
		\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-n,\nu_{i},\tilde{\nu}_{i})$} \ar[rr]^{q''_{2}} \ar[dd]_{q_{1}''} &  & 	\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-n, \tilde{\nu}_{i})$}  \\
		&	\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-n,\nu_{i}-1,\nu_{i},\tilde{\nu}_{i})$}
		\ar[ul]^{r} \ar[r]^-{\pi} \ar[d]^{\pi'} & 	\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-n,\nu_{i}-1,\tilde{\nu}_{i})$}
		\ar[u]_{q_{2}} \ar[d]^{q_{1}}\\
		\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i},\tilde{\nu}_{i})$}
		& 	\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-1,\nu_{i},\tilde{\nu}_{i})$}
		\ar[l]_{q'_{1}} \ar[r]^-{q'_{2}} & 	\txt{$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-1, \tilde{\nu}_{i})$},
	}
	\]
...
For a triangulated $\mathcal{D}$ and a finite set of objects $\mathcal{B}=\{B_{\alpha} \}_{\alpha \in S}$, we say an object $A \in \mathcal{D}$ is generated by objects in $\mathcal{B}$ if $A$ belongs to the thick subcategory generated by objects in $\mathcal{B}$.
...
\end{lemma}
\begin{proof}
	Since $i\neq j$, we can assume that $i$ is a source and $j$ is a sink, then any subspace $W$ of $\mathbf{V}''_{j}$ is automatically $x$-stable for all $x \in \mathbf{E}_{\mathbf{V}'',\mathbf{W},\hat{\Omega}}$.
	
	Let $X_{1,r}$ be the variety $(p_{1})^{-1}(\mathbf{E}^{r}_{\mathbf{V},\mathbf{W},\hat{\Omega}}) \cap  \mathbf{E}^{',0}_{\mathbf{V}'',\mathbf{W},i}$ , $X_{2,r}=p_{2}(X_{1,r})$, $X_{1, \geqslant r}= \bigcup\limits_{r' \geqslant r } X_{1,r'}$ and $X_{2, \geqslant r}= \bigcup\limits_{r' \geqslant r } X_{2,r'}$. More precisely, the variety $X_{2,r}$ consists of $(x,\mathbf{U})$, where $x \in \mathbf{E}^{0}_{\mathbf{V}'',\mathbf{W},i}$ and $\mathbf{U}$ is an $n$-dimensional subspace of $\mathbf{V}''_{j}$ such that ${\rm{Im}}(\bigoplus\limits_{h \in \hat{\Omega}, h'=i}(x_{h})) \cap \mathbf{U}^{\oplus a_{i,j}} $ is an $r$-dimensional subspace of $\bigoplus\limits_{h \in \Omega,h'=i}\mathbf{V}''_{h''} \oplus \mathbf{W}_{\hat{i}}$, here $a_{i,j}$ is the number of arrows between $i$ and $j$. The variety $X_{1,r}$ consists of $(x,\mathbf{U},\rho)$ such that $(x,\mathbf{U}) \in X_{2,r}$ and $\rho: \mathbf{V}''/\mathbf{U} \cong \mathbf{V}$ is a linear isomorphism of graded spaces. Then we have the following commutative diagrams
	\[
	\xymatrix{
		\mathbf{E}_{\mathbf{V},\mathbf{W},\hat{\Omega}} & \mathbf{E}^{'}_{\mathbf{V}'',\mathbf{W},\hat{\Omega}}\ar[l]_{p_{1}} \ar[r]^{p_{2}}& \mathbf{E}^{''}_{\mathbf{V}'',\mathbf{W},\hat{\Omega}} \ar[r]^{p_{3}}& \mathbf{E}_{\mathbf{V}'',\mathbf{W},\hat{\Omega}} \\
	...
	\]
	where those $x_{i,r}$ and $x_{i,\geqslant r},i=1,2,3$ are restrictions of $p_{i},i=1,2,3$ respectively and those $j_{2},j_{3},j_{4}$ and $u_{i,r},u_{i,\geqslant r},i=1,2$ are obvious embedding. Then we have the following isomorphism for any object $A_{1}$ in $\mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}_{\mathbf{V},\mathbf{W},\hat{\Omega}} )$
	\begin{equation*}
			 (j_{4})^{\ast}(p_{3})_{!}(p_{2})_{\flat}(p_{1})^{\ast}(A_{1})
			 \cong (\tilde{p}_{3})_{!}(\tilde{p}_{2})_{\flat}(\tilde{p}_{1})^{\ast}(A_{1}).
	\end{equation*} 
Since the square of $u_{1,r},u_{2,r},x_{2,r}$ and $\tilde{p}_{2}$ are Cartisian, we have
	\begin{equation*}
		\begin{split}
...
\cong & (\tilde{p}_{3})_{!}(\tilde{p}_{2})_{\flat}(u_{1,r})_{!}(x_{1,r})^{\ast}(j_{\mathbf{V},r})^{\ast}(A_{1})\\
	\cong & 	(\tilde{p}_{3})_{!}(u_{2,r})_{!}(x_{1,r})_{\flat}(x_{1,r})^{\ast}(j_{\mathbf{V},r})^{\ast}(A_{1}) \\
...
Recall that $X_{1,0} \cup X_{1,\geqslant 1} =\mathbf{E}^{',0}_{\mathbf{V}'',\mathbf{W},i}$ induces distiguished triangles $$(u_{1,0})_{!}(u_{1,0})^{\ast} \rightarrow \mathbf{Id} \rightarrow (u_{1,\geqslant 1})_{!}(u_{1,\geqslant 1})^{\ast} \xrightarrow{+1},$$
then the complex $(\tilde{p}_{3})_{!}(\tilde{p}_{2})(\tilde{p}_{1})^{\ast}(A)$ admits a triangle $$(x_{3,0})_{!}(x_{2,0})_{\flat}(x_{1,0})^{\ast}(j_{\mathbf{V},0})^{\ast}(A)\rightarrow (\tilde{p}_{3})_{!}(\tilde{p}_{2})(\tilde{p}_{1})^{\ast}(A) \rightarrow (x_{3,\geqslant 1})_{!}(x_{2,\geqslant 1})_{\flat}(x_{1,\geqslant 1})^{\ast}(j_{\mathbf{V},\geqslant 1})^{\ast}(A) \xrightarrow{+1}.$$
Similarly, we have distinguished triangles 
\begin{equation*}
	\begin{split}
		(x_{3,r})_{!}(x_{2,r})_{\flat}(x_{1,r})^{\ast}(j_{\mathbf{V},0})^{\ast}(A_{1})&\rightarrow (x_{3,\geqslant 1})_{!}(x_{2,\geqslant 1})_{\flat}(x_{1,\geqslant 1})^{\ast}(j_{\mathbf{V},\geqslant 1})^{\ast}(A_{1}) \\
		&\rightarrow (x_{3,\geqslant r+1})_{!}(x_{2,\geqslant r+1})_{\flat}(x_{1,\geqslant r+1})^{\ast}(j_{\mathbf{V},\geqslant r+1})^{\ast}(A_{!}) \xrightarrow{+1},
		\end{split}
\end{equation*}
so $(\tilde{p}_{3})_{!}(\tilde{p}_{2})(\tilde{p}_{1})^{\ast}(A_{1})$ is generated by  those $(x_{3,r})_{!}(x_{2,r})_{\flat}(x_{1,r})^{\ast}(j_{\mathbf{V},0})^{\ast}(A_{1})$.

Let $Y_{2,r}\subseteq \dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}\times \mathbf{Grass}(\nu_{i}'',\tilde{\nu}''_{i})\times \mathbf{Grass}(1,\nu''_{j})$ be the variety consists of $(\dot{x},\mathbf{U},\mathbf{U}_{1})$ where $\dot{x} \in \dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$, $\mathbf{U}_{1}$ is an $\nu''_{i}$-dimensional subspace of $\tilde{\mathbf{V}}''_{i}=\bigoplus\limits_{h \in \Omega,h'=i}\mathbf{V}''_{h''} \oplus \mathbf{W}_{\hat{i}}$, and  $\mathbf{U}$ is an $n$-dimensional subspace of $\mathbf{V}''_{j}$ such that $\mathbf{U}_{1} \cap \mathbf{U}^{\oplus a_{i,j}} $ is an $r$-dimensional subspace of $\tilde{\mathbf{V}}''_{i}$. Let $Y_{1,r}$ be the variety consists of $(\dot{x},\mathbf{U},\mathbf{U}_{1},\dot{\rho})$ such that $(\dot{x},\mathbf{U},\mathbf{U}_{1}) \in Y_{2,r}$ and  $\dot{\rho}:\dot{\mathbf{V}}''/\mathbf{U} \cong \dot{\mathbf{V}} $ is a linear isomorphism. Denote $(x_{1,r})^{-1}(	\mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},\hat{\Omega}})$ by $X_{0,r}$, here we identify $	\mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},\hat{\Omega}}$ with $'F_{r}$. Then we have the following commutative diagram
	\[
\xymatrix{
	...
	\\
	&\txt{$\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-r,\tilde{\nu}_{i})$}
   & Y_{1,r} \ar[l]^-{y_{1,r}} \ar[r]_{y_{2,r}}  & Y_{2,r} \ar[r]_-{y_{3,r}}  &\txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}'',\tilde{\nu}''_{i})$},
}
\]
where $\iota'_{\mathbf{V},r}$ is the natural embedding, $x_{0,r}$ is the restriction of $x_{1,r}$, $v_{0,r}$ is the restriction of $v_{1,r}$. Recall that $\dot{\rho}$ also induces $ \dot{\rho}(\tilde{\mathbf{V}}''_{i}/\mathbf{U}^{\oplus a_{i,j}})= \tilde{\mathbf{V}}_{i}= \bigoplus\limits_{h \in \Omega,h'=i}\mathbf{V}_{h''} \oplus \mathbf{W}_{\hat{i}} $, the morphisms $v_{1,r},v_{2,r},y_{1,r},y_{2,r}$ and $y_{3,r}$ are defined by
$$ y_{1,r}( (\dot{x},\mathbf{U},\mathbf{U}_{1},\dot{\rho} ) ) =(\dot{x}, \dot{\rho}(\mathbf{U}_{1}/\mathbf{U}^{\oplus a_{i,j}}) ), $$ 
$$ y_{2,r}( (\dot{x},\mathbf{U},\mathbf{U}_{1},\dot{\rho} ) ) =(\dot{x},\mathbf{U},\mathbf{U}_{1}), $$ 
$$ y_{2,r}( (\dot{x},\mathbf{U},\mathbf{U}_{1} ) ) =(\dot{x},\mathbf{U}_{1}), $$ 
$$ v_{1,r}( (x,\mathbf{U},\rho ) ) =(\dot{x},{\rm{Im}}(\bigoplus\limits_{h \in \hat{\Omega}, h'=i}(x_{h}))  ,\mathbf{U},\dot{\rho}), $$
$$ v_{1,r}( (x,\mathbf{U},\rho ) ) =(\dot{x},{\rm{Im}}(\bigoplus\limits_{h \in \hat{\Omega}, h'=i}(x_{h}))  ,\mathbf{U},\dot{\rho}).$$
...
Let $Z_{2,r}$ be the variety  which  consists of $(\dot{x},\mathbf{U},\mathbf{U}_{2} \subseteq \mathbf{U}_{1})$, where $\dot{x} \in \dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$, $\mathbf{U}_{1}$ is an $\nu''_{i}$-dimensional subspace of $\tilde{\mathbf{V}}''_{i}$, $\mathbf{U}_{2}$ is an $(\nu''_{i}-1)$-dimensional subspace of $\tilde{\mathbf{V}}''_{i}$ , and  $\mathbf{U}$ is an $n$-dimensional subspace of $\mathbf{V}''_{j}$ such that $\mathbf{U}_{1} \cap \mathbf{U}^{\oplus a_{i,j}} $ is an $r$-dimensional subspace of $\tilde{\mathbf{V}}''_{i}$. Let $Z_{1,r}$ be the variety which consists of $(\dot{x},\mathbf{U},\mathbf{U}_{2} \subseteq \mathbf{U}_{1},\dot{\rho})$ such that $(\dot{x},\mathbf{U},\mathbf{U}_{2} \subseteq \mathbf{U}_{1}) \in Z_{2,r}$ and  $\dot{\rho}:\dot{\mathbf{V}}''/\mathbf{U} \cong \dot{\mathbf{V}} $ is a linear isomorphism.  For $i=1,2$ and $a=0,1$, let $Z_{i,r,a}$ be the subset of $Z_{i,r}$ consisting of points such that $\mathbf{U}_{2} \cap \mathbf{U}^{\oplus a_{i,j}} $ is an $(r-a)$-dimensional subspace of $\tilde{\mathbf{V}}''_{i}$. Then we have the following commutative diagrams

	\[
\xymatrix{
\txt{$\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-r,\tilde{\nu}_{i})$} & Y_{1,r} \ar[l]_-{y_{1,r}} \ar[r]^{y_{2,r}}& Y_{2,r} \ar[r]^-{y_{3,r}}& \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}'',\tilde{\nu}''_{i})$} \\
	 & Z_{1,r} \ar[r]^{z_{2,r}} \ar[u]_{w_{1}} & Z_{2,r} \ar[r]^-{z_{3,r}} \ar[u]_{w_{2}} & \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}''-1,\nu_{i}'',\tilde{\nu}''_{i})$} \ar[u]_{q_{1}} 
	\\
	\txt{$\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-1-r+a,\nu_{i}-r,\tilde{\nu}_{i})$} \ar[uu]^{q_{1,r,a}} & Z_{1,r,a} \ar[l]_-{z_{1,r,a}} \ar[r]^{z_{2,r,a}} \ar[u]_{i_{1,r,a}} & Z_{2,r,a} \ar[r]^-{z_{3,r,a}} \ar[u]_{i_{2,r,a}} & \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}''-1,\nu_{i}'',\tilde{\nu}''_{i})$}, \ar@2{-}[u]
}
\]
...
\xymatrix{
	\txt{$\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-r,\tilde{\nu}_{i})$} & Y_{1,r} \ar[l]_-{y_{1,r}} \ar[r]^{y_{2,r}}& Y_{2,r} \ar[r]^-{y_{3,r}}& \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}'',\tilde{\nu}''_{i})$} \\
\txt{$\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-1-r+a,\nu_{i}-r,\tilde{\nu}_{i})$} \ar[u]^-{q_{1,r,a}}	  & Z_{1,r,a} \ar[l]_-{z_{1,r,a}} \ar[r]^{z_{2,r,a}} \ar[u]_{w_{1,a}} & Z_{2,r,a} \ar[r]^-{z_{3,r,a}} \ar[u]_{w_{2,a}} & \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}''-1,\nu_{i}'',\tilde{\nu}''_{i})$}, \ar[u]_-{q_{1}} 
}
\]
where $z_{2,r}$ is defined by forgetting $\dot{\rho}$, $z_{3,r}$ is defined by forgetting $\mathbf{U}$, $w_{1}$ and $w_{2}$ are defined by forgetting $\mathbf{U}_{2}$, $i_{1,r,a}$ and $i_{2,r,a}$ are obvious embeddings, $w_{1,a}$ and $w_{2,a}$ are restriction of $w_{1}$ and $w_{2}$ respectively,  $z_{2,r,a}$ and  $z_{3,r,a}$ are restrictions of $z_{2,r}$ and $z_{3,r}$ respectively, and the morphism $z_{1,r,a}$ is defined by
$$ z_{1,r,a}((\dot{x},\mathbf{U},\mathbf{U}_{2} \subseteq\mathbf{U}_{1},\dot{\rho} )  )=  (\dot{x}, \dot{\rho}(\mathbf{U}_{2}/\mathbf{U}^{\oplus a_{i,j}}) \subseteq \dot{\rho}(\mathbf{U}_{1}/\mathbf{U}^{\oplus a_{i,j}}) ).$$ 
Then $(q'_{1})^{\ast}(y_{3,r})_{!}(y_{2,r})_{\flat}(y_{1,r})^{\ast} \cong (z_{3,r})_{!}(z_{2,r})_{\flat}(w_{1})^{\ast} (y_{1,r})^{\ast}$. Note that there is a distinguished triangle $$(i_{1,r,1})_{!}(i_{1,r,1})^{\ast} \rightarrow \mathbf{Id} \rightarrow (i_{1,r,0})_{!}(i_{1,r,0})^{\ast} \xrightarrow{+1} $$ and the square of $z_{2,r},z_{2,r,a}, i_{1,r,a}$ and $i_{2,r,a}$ is Cartisian, we can see that for any object $A_{3}$ in $\mathcal{D}^{b}_{G_{\mathbf{V}}}(\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}\times \mathbf{Grass}(\nu_{i}-r,\tilde{\nu}_{i}) ) $, the object $(q'_{1})^{\ast}(y_{3,r})_{!}(y_{2,r})_{\flat}(y_{1,r})^{\ast}(A_{3})$ is generated by objects $ (z_{3,r,a})_{!}(z_{2,r,a})_{\flat}(z_{1,r,a})^{\ast}(q_{1})^{\ast}(A_{3})$ with $a=0,1$.

Let $X'_{2,r-a}$  be the variety consisting of $(x,\mathbf{U})$, where $x \in \mathbf{E}^{0}_{\mathbf{V}',\mathbf{W},i}$ and $\mathbf{U}$ is an $n$-dimensional subspace of $\mathbf{V}'_{j}$ such that ${\rm{Im}}(\bigoplus\limits_{h \in \hat{\Omega}, h'=i}(x_{h})) \cap \mathbf{U}^{\oplus a_{i,j}} $ is an $(r-a)$-dimensional subspace of $\tilde{\mathbf{V}}'_{i}=\bigoplus\limits_{h \in \Omega,h'=i}\mathbf{V}'_{h''} \oplus \mathbf{W}_{\hat{i}}$. Let $X'_{1,r-a}$ be the variety consisting of $(x,\mathbf{U},\rho)$ such that $(x,\mathbf{U}) \in X'_{2,r-a}$ and $\rho: \mathbf{V}'/\mathbf{U} \cong \mathbf{V}'''$ is a linear isomorphism of graded spaces. Let $Y'_{2,r-a}\subseteq \dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}\times \mathbf{Grass}(\nu_{i}',\tilde{\nu}'_{i})\times \mathbf{Grass}(1,\nu'_{j})$ be the variety which consists of $(\dot{x},\mathbf{U},\mathbf{U}_{1})$ where $\dot{x} \in \dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}$, $\mathbf{U}_{1}$ is an $\nu'_{i}$-dimensional subspace of $\tilde{\mathbf{V}}'_{i}$, and  $\mathbf{U}$ is an $n$-dimensional subspace of $\mathbf{V}'_{j}$ such that $\mathbf{U}_{1} \cap \mathbf{U}^{\oplus a_{i,j}} $ is an $(r-a)$-dimensional subspace of $\tilde{\mathbf{V}}'_{i}$. Let $Y'_{1,r-a}$ be the variety which consists of $(\dot{x},\mathbf{U},\mathbf{U}_{1},\dot{\rho})$ such that $(\dot{x},\mathbf{U},\mathbf{U}_{1}) \in Y'_{2,r-a}$ and  $\dot{\rho}:\dot{\mathbf{V}}'/\mathbf{U} \cong \dot{\mathbf{V}'''} $ is a linear isomorphism. Define morphisms $u'_{i},v'_{i},w'_{i},i=1,2$ and $x'_{i,r-a}$, $y'_{i,r-a}$ for $r, a=0,1$ and $i=1,2,3$ similarly. Notice that $\tilde{\nu}''_{i}=\tilde{\nu}'_{i}$, $\tilde{\nu}'''_{i}=\tilde{\nu}_{i}$, $\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}=\dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}$ and $$\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i}=\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}=\dot{\mathbf{E}}_{\mathbf{V}'''_{r-a},\mathbf{W},i}=\dot{\mathbf{E}}_{\mathbf{V}''',\mathbf{W},i},$$ we have the following commutative diagrams
	\[
\xymatrix{
	\txt{$\dot{\mathbf{E}}_{\mathbf{V}'''_{r-a},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-1-r+a,\nu_{i}-r,\tilde{\nu}_{i})$} \ar[d]_-{q_{2,r,a}}	  & Z_{1,r,a} \ar[l]_-{z_{1,r,a}} \ar[r]^{z_{2,r,a}} \ar[d]_{w'_{1,a}} & Z_{2,r,a} \ar[r]^-{z_{3,r,a}} \ar[d]_{w'_{2,a}} & \txt{$\dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}''-1,\nu_{i}'',\tilde{\nu}''_{i})$}, \ar[d]^-{q_{2}}  \\
	\txt{$\dot{\mathbf{E}}_{\mathbf{V}'''_{r-a},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-1-r+a,\tilde{\nu}_{i})$} & Y'_{1,r-a} \ar[l]_-{y'_{1,r}} \ar[r]^{y'_{2,r}}& Y'_{2,r-a} \ar[r]^-{y'_{3,r}}& \txt{$\dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}''-1,\tilde{\nu}''_{i})$} 	,
}
\]
	\[
\xymatrix{
...
\begin{equation}\label{equationA5}
	(\phi_{\mathbf{V}',i})^{\ast}(y'_{3,r,a})_{!}(y'_{2,r,a})_{\flat}(y'_{1,r,a})^{\ast}(A_{5}) \cong  (x'_{3,r,a})_{!}(x'_{2,r,a})_{\flat}(x'_{1,r,a})^{\ast}(\iota_{\mathbf{V}''',r-a})_{_\clubsuit}(\phi_{\mathbf{V}'''_{r-a},i})^{\ast}(A_{5}),
\end{equation}
...
\begin{equation}
	\begin{split}
		...
		\cong & (p'_{3})_{!}(p'_{2})_{\flat}(j'_{2})_{!}(u'_{,r-a})_{!} (x'_{1,r,a})^{\ast}(A_{6}) \\
...
Then from the following commutative diagram, for any object $A$, define the following object $$A_{i,r}=  (j_{\mathbf{V}',0})_{!}(\phi_{\mathbf{V}',i})^{\ast}(q_{2})_{!}(q_{1})^{\ast}(\phi_{\mathbf{V}'',i})_{\flat}(x_{3,r})_{!}(x_{2,r})_{\flat}(x_{1,r})^{\ast}(j_{\mathbf{V},r})^{\ast}(A),$$   
$$A_{i,r,a}=  (j_{\mathbf{V}',0})_{!}(\phi_{\mathbf{V}',i})^{\ast}(q_{2})_{!}(z_{3,r})_{!}(z_{2,r})_{\flat}(z_{1,r})^{\ast}(q_{1,r,a})^{\ast}(\phi_{\mathbf{V}_{r},i})_{\flat}(\iota_{\mathbf{V},r})^{_\clubsuit}(j_{\mathbf{V},r})^{\ast}(A).$$
Since $$\mathcal{E}_{i}\mathcal{F}^{(n),\vee}_{j}(A)=  (j_{\mathbf{V}',0})_{!}(\phi_{\mathbf{V}',i})^{\ast}(q_{2})_{!}(q_{1})^{\ast}(\phi_{\mathbf{V}'',i})_{\flat} (j_{\mathbf{V}''})_{0}(p_{3})_{!}(p_{2})_{\flat}(p_{1})^{\ast}(A),$$     
then by using the canonical distinguished triangles induced by the partition $X_{1,\geqslant r}= X_{1,r} \cup X_{1,\geqslant r+1}$,  we can see that $\mathcal{E}_{i}\mathcal{F}^{(n),\vee}_{j}(A)$ is inductively generated by $A_{i,r}, 0 \leqslant r \leqslant \nu_{i}$. Using equations (\ref{equationA2}), (\ref{equationA3}) and the canonical distinguished triangles induced by the partition $Z_{1,r}= Z_{1,r,0} \cup Z_{1,r,1}$, we can see that $A_{i,r}$ is generated by $A_{i,r,a}, a=0,1$. Using equations
...
\xymatrix{
	...
	\txt{$\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-r,\tilde{\nu}_{i})$} & Y_{1,r} \ar[l]_-{y_{1,r}} \ar[r]^{y_{2,r}}& Y_{2,r} \ar[r]^-{y_{3,r}}& \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}'',\tilde{\nu}''_{i})$} \\
	\txt{$\dot{\mathbf{E}}_{\mathbf{V}_{r},\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}-1-r+a,\nu_{i}-r,\tilde{\nu}_{i})$} \ar[u]^-{q_{1,r,a}} \ar[d]_-{q_{2,r,a}}	  & Z_{1,r,a} \ar[l]_-{z_{1,r,a}} \ar[r]^{z_{2,r,a}} \ar[u]_{w_{1,a}} \ar[d]^{w'_{1,r-a}} & Z_{2,r,a} \ar[r]^-{z_{3,r,a}} \ar[u]_{w_{2,a}} \ar[d]^{w'_{2,r-a}} & \txt{$\dot{\mathbf{E}}_{\mathbf{V}'',\mathbf{W},i}$\\$\times$\\ $\mathbf{Flag}(\nu_{i}''-1,\nu_{i}'',\tilde{\nu}''_{i})$} \ar[u]_-{q_{1}} \ar[d]^-{q_{2}}\\
	\txt{$\dot{\mathbf{E}}_{\mathbf{V}'''_{r-a},\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}-1-r+a,\tilde{\nu}_{i})$} & Y'_{1,r-a} \ar[l]_-{y'_{1,r}} \ar[r]^{y'_{2,r}}& Y'_{2,r-a} \ar[r]^-{y'_{3,r}}& \txt{$\dot{\mathbf{E}}_{\mathbf{V}',\mathbf{W},i}$\\$\times$\\ $\mathbf{Grass}(\nu_{i}''-1,\tilde{\nu}''_{i})$} 	\\
...
\begin{lemma}\label{key0}
	For graded space $\mathbf{V}$ and each $1\leqslant r \leqslant \nu_{i}$, we fix a decomposition $\mathbf{V}=\mathbf{V}_{r}\oplus \mathbf{U}_{r}$ of $\mathbf{V}$ such that $|\mathbf{U}_{r}|=rj$. For any object $A$ in $\mathcal{N}_{\mathbf{V},j}$,  we can find some object  $B_{r}$ in $\mathcal{D}^{b}_{G_{\mathbf{V}}}(\mathbf{E}_{\mathbf{V}_{r},\mathbf{W},\hat{\Omega}})$  for each $1\leqslant r \leqslant \nu_{j}$ such that those $\mathcal{F}^{(n),\vee}_{j}(B_{r})$ generate $B$ via distinguished triangles. More precisely, $A$ in $\mathcal{N}_{\mathbf{V},j}$ if and only if $A$ can be generated by finite objects of the form $\mathcal{F}^{(n),\vee}_{j}(B)$.
\end{lemma}
\begin{proof}
	By Remark \ref{remarkFD}, $\mathcal{F}^{(n),\vee}_{j}$ commutes with Fourier-Deligne transformations, we can assume $j$ is a source in $\hat{\Omega}$.
	Let $F_{r}$ be the closed subset of $\mathbf{E}_{\mathbf{V},\mathbf{W},\hat{\Omega}}$ consisting of $x$ such that $\mathbf{U}_{r}$ is $x$-stable, $Q_{r}$ be the stabilzer of $\mathbf{U}_{r}$ in $G_{\mathbf{V}}$ and $U_{r}$ be its unipotent radical. Notice that $E''_{\hat{\Omega}}\cong G_{\mathbf{V}} \times_{Q_{r}} F_{r}$, $E'_{\hat{\Omega}}\cong G_{\mathbf{V}} \times_{U_{r}} F_{r}$,  $F_{r} \cong \mathbf{E}_{\mathbf{V}_{r},\mathbf{W},\hat{\Omega}}$ and $p_{3}$ induces $ G_{\mathbf{V}} \times_{Q_{r}} \mathbf{E}^{0}_{\mathbf{V}_{r},\mathbf{W},j} \cong \mathbf{E}^{r}_{\mathbf{V},\mathbf{W},j}$. 
	...
	\]
	where $i_{r},\iota_{r}$ are the natural embeddings. Then $i_{r}p_{1}=\mathbf{Id}$ implies that the induction functor $\mathcal{F}^{(r),\vee}_{j}$ is isomorphic to $(p_{3})_{!}(\iota_{r})_{_{\clubsuit}}$ up to shifts. Indeed, $(p_{3})_{!}(\iota_{r})_{_{\clubsuit}}$ is exactly the definition of the induction functor  in \cite[10.3.5]{Achar}. Consider the following commutative diagram for $\mathcal{F}^{(r),\vee}_{j}$
	\[
	\xymatrix{
	...
	\]
	where $i_{1},i_{2},i_{3}$ are the obvious embedding and $\iota'_{r}$ is the restriction of $\iota_{r}$. Noctice that the restrcition functor is defined by $(\iota_{r})^{\ast}$ up to shifts, then for any object $C$, we have the following isomorphism 
	$$\mathcal{F}^{(r),\vee}_{j} (i_{1,r})_{!}(i_{1,r})^{\ast} \mathbf{Res}^{\mathbf{V}\oplus\mathbf{W}}_{\mathbf{V}_{r}\oplus \mathbf{W},\mathbf{U}_{r}}(C) \cong (i_{3,r})_{!}(i_{3,r})^{\ast}(C). $$
	(Indeed, similar isomorphisms for semisimple objects have been also used by Lusztig in the proof of  \cite[Proposition 6.6]{MR1088333}.)
	
	Let $B_{1}= \mathcal{F}^{(1),\vee}_{j} (i_{1,1})_{!}(i_{1,1})^{\ast} \mathbf{Res}^{\mathbf{V}\oplus\mathbf{W}}_{\mathbf{V}_{1}\oplus \mathbf{W},\mathbf{U}_{1}}(A) $. Since the support of $A$ is contained in $\mathbf{E}^{\geqslant 1}_{\mathbf{V},\mathbf{W},j}$,  then there is a canonical distinguished triangle induced by $\mathbf{E}^{\geqslant 1}_{\mathbf{V},\mathbf{W},j}=\mathbf{E}^{ 1}_{\mathbf{V},\mathbf{W},j} \cup \mathbf{E}^{\geqslant 2}_{\mathbf{V},\mathbf{W},j}$  
	$$ B_{1} \rightarrow A \rightarrow B_{\geqslant 1} \xrightarrow{+1},$$
	where $B_{\geqslant 1}$ is an object whose support is contained  in $\mathbf{E}^{\geqslant 2}_{\mathbf{V},\mathbf{W},j}$. By a similar argument as in the proof of Lemma \ref{commute4}, we can inductively define $B_{r}$ be the object $ \mathcal{F}^{(r),\vee}_{j} (i_{1,r})_{!}(i_{1,r})^{\ast} \mathbf{Res}^{\mathbf{V}\oplus\mathbf{W}}_{\mathbf{V}_{r}\oplus \mathbf{W},\mathbf{U}_{r}}(B_{\geqslant r}) $ and define $B_{\geqslant r+1}$ be the mapping cone of the  canonical morphism $B_{r} \rightarrow B_{\geqslant r}$  induced by the partition $\mathbf{E}^{\geqslant r}_{\mathbf{V},\mathbf{W},j}=\mathbf{E}^{ r}_{\mathbf{V},\mathbf{W},j} \cup \mathbf{E}^{\geqslant r+1}_{\mathbf{V},\mathbf{W},j}$. When $r > \nu_{j}$, $\mathbf{E}^{\geqslant r}_{\mathbf{V},\mathbf{W},j}$  is empty and  $B_{\geqslant r}$ is zero.   These $B_{r},1\leqslant r \leqslant \nu_{j}$ are exactly what we need. 
\end{proof}
...
\begin{proof}
	Firstly, we prove the statement for $n=1$. Since $\mathcal{N}_{\mathbf{V},j}$ is a thick subcategory generated by objects of the form $\mathcal{F}^{(n),\vee}_{j}(B)$, we only need to check that,  $\mathcal{E}_{i}\mathcal{F}^{(n),\vee}_{j}(B)$ is isomorphic to an object of  $\mathcal{N}_{\mathbf{V}',j}$ in $\mathcal{D}^{b}_{G_{\mathbf{V}'}}(\mathbf{E}_{\mathbf{V}',\mathbf{W},\hat{\Omega}})/\mathcal{N}_{\mathbf{V}',i}$.  However, $\mathcal{E}_{i}\mathcal{F}^{(n),\vee}_{j}(B)$ is generated by those $\mathcal{F}^{(n),\vee}_{j}\mathcal{E}_{i,r,a}(B)$. By Remark \ref{remarkFD}, $\mathcal{F}^{(n),\vee}_{j}$ commutes with Fourier-Deligne transformations,  $\mathcal{F}_{\hat{\Omega}^{i},\hat{\Omega}^{j}}\mathcal{F}^{(n),\vee}_{j}\mathcal{E}_{i,r,a}(B) \cong \mathcal{F}^{(n),\vee}_{j}\mathcal{F}_{\hat{\Omega}^{i},\hat{\Omega}^{j}}\mathcal{E}_{i,r,a}(B)$ belongs to $\mathcal{N}_{\mathbf{V}',j}$. Therefore $\mathcal{F}^{(n),\vee}_{j}\mathcal{E}_{i,r,a}(B)$ belongs to $\mathcal{N}_{\mathbf{V}',j}$ and the statement holds for $n=1$. By Lemma \ref{Lemma 16}, we can inductively prove that $\mathcal{E}^{(n)}_{i}(A)$ is a direct summand of $(\mathcal{E}_{i})^{n}(A)$, hence the statement holds for general $n$. 
\end{proof}
Indeed, one can similarly define $\mathcal{E}^{(n)}_{i,r,a}$ for $0 \leqslant a \leqslant n$ and prove that those $\mathcal{F}^{\vee}_{j}\mathcal{E}^{(n)}_{i,r,a}(A)$ generate $\mathcal{E}_{i}^{(n)}\mathcal{F}^{\vee}_{j}(A)$ as what we have done in the proof of Lemma \ref{commute4}. Then the corollary above holds for general $n$ without using Lemma \ref{Lemma 16}.
...
\begin{proof}	
	...
	Recall that for any objects $A$ in the category $ \mathcal{D}^{b}_{G_{\dot{\mathbf{V}}}}(\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i} \times \mathbf{Grass}(\nu_{i}, \tilde{\nu}_{i}))$ and $B$ in the category $ \mathcal{D}^{b}_{G_{\dot{\mathbf{V}}}}(\dot{\mathbf{E}}_{\mathbf{V},\mathbf{W},i} \times \mathbf{Grass}(\nu_{i}, \tilde{\nu}_{i}))$, 
	\begin{equation*}
		\begin{split}
...
\begin{proof}
	...
	hence
	$F_{i_{n_{1}}}^{(m_{1})}  [L'']$ belongs to $F_{i_{n_{1}}}^{(m_{1}+1)} \mathcal{K}_{0}(\Lambda).$ By Proposition \ref{lt'}, $\{[L]|L\in \mathcal{P}, t_{i_{n_{1}}}(L) \geqslant m_{1}+1  \}$ form a basis of $[L_{i_{n_{1}}^{(m_{1}+1)}}]\ast\mathcal{K}$ in in $\mathcal{K}$. Project this basis to $\mathcal{K}_{0}(\Lambda)$, we can see that the set $$\{[L]|L\in \mathcal{P}, L \notin \mathcal{N}, t_{i_{n_{1}}} \geqslant m_{1}+1  \}$$ forms a basis of $F_{i_{n_{1}}}^{(m_{1}+1)}\ast\mathcal{K}_{0}(\Lambda)$.
	\begin{equation*}
...
J. Fang is supported by National Key R$\&$D Program of China [Grant No. 2020YFE0204200]. Y. Lan is supported by the National Natural Science Foundation of China [Grant No. 1288201]. J. Xiao is supported by Natural Science Foundation of China [Grant No. 12031007].
