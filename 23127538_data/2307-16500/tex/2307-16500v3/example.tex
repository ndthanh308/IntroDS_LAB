...
we have \(q_i\in F_p\) and \(Y(q_i)=\{y\}\) for any \(i=1,2,3,4\), and
...
by first replacing each call of an improper state in the right-hand side
...
Consider an input tree $s=a^5(s)$ consisting of at least five top-most $a$-symbols
...
\<q_2, a(x)>(y_1,y_2) &\to f(y_1,\<q_2,x>(a(y_2)))
\\
\<q_1, b(x)>(y_1) &\to y_1 &
...
\begin{align*}
\<[q_2,p,t_1,2], a(x:(p,\varphi))>(y_1) &\to \<q_1,x>(a(y_1)) \\
...
\<q_1, a(x:(p,\varphi_2,\varphi_4))>(y_1) &\to f(a(y_1),y_1) \\
\<[q_2,p,t_1,2], a(x:(p,\varphi_2,\varphi_3))>(y_1) &\to a(y_1) \\
\<[q_2,p,t_1,2], a(x:(p,\varphi_2,\varphi_4))>(y_1) &\to a(a(y_1)) 
\end{align*}
