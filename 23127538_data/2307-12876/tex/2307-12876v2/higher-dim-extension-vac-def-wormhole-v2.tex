...
\newcommand{\version}{v2} %%true version v1.993
...
This 4D $M$-deformed-vacuum-defect-wormhole metric still
solves the vacuum Einstein equation.
...
&&
\end{eqnarray}
with $b>0$, $M < b/2$, $\delta M =0^{+}$,
and either $M =0$ or $M > 0$, so that the ratio
$M/(M+\delta M)$ takes values $0$ or $1$.
...
\\[0.75mm]  %%FRK: later check again latex vs. math
...
\bibitem{Klinkhamer2023-mirror}  %%FRK
F.R.~Klinkhamer,
...
Comments    : 7 pages, 1 figure, v2: minor changes
