    ...
    \begin{enumit}
        ...
        \begin{description}
            ...
            \item[Case $c = \explet{x}{c_1^{\tycomp{\Sigma}{T_1}{\square}}}{c_2^{\tycomp{\Sigma}{T_2}{\square}}}$:]
                ...
                \end{enumrm}
                Therefore, by \rulename{T-Let} with \lref{ty-c1-2} and \lref{ty-c2-2}, we have
                \[
            ...
            \item[Case $c = \explet{x}{c_1^{\tycomp{\Sigma}{T_1}{\tyctl{x}{C_1}{C_2}}}}{c_2^{\tycomp{\Sigma}{T_2}{\tyctl{z}{C_0}{C_1}}}}$:]
                ...
                \end{enumrm}
                Therefore, by \rulename{T-Let}, we have
                \[
            ...
            \item[{Case $c = \expop[\op^{\rep{\mathit{A}}}]{v}{y^{T_y}}{c^{\tycomp{\Sigma}{T}{\tyctl{z}{C_1}{C_2}}}}$:}]
                \def\currentprefix{cpsbw:op}
                We have $\cps{c} = \Lambda \alpha. \lambda h:\cps{\Sigma}. \lambda k:(z: \cps{T}) \rarr \cps{C_1}.
                    h\#\op~\rep{A}~\cps{v}~(\lambda y:\cps{T_y}. \cps{c}~\nmbullet~h~k)$
                and $y \notin \fv(\Sigma) \cup \fv(T) \cup (\fv(C_1) \setminus \{z\})$~.
                By Lemma \ref{lem:cps:inv-c}, we have
                \begin{enumrm}
                    \item\llabel{ty-body} $\jdty{\Gamma, \alpha, h:\cps{\Sigma}, k:(z: \cps{T}) \rarr \cps{C_1}}
                        {h\#\op~\rep{A}~\cps{v}~(\lambda y:\cps{T_y}. \cps{c}~\nmbullet~h~k)}{\tau'}$ and
                    \item\llabel{sub-t} $\jdsub{\Gamma}{\forall \alpha. \cps{\Sigma} \rarr ((z: \cps{T}) \rarr \cps{C_1}) \rarr \tau'}{\tau}$
                \end{enumrm}
                for some $\tau'$.
                (Below, we write $\Gamma_{\alpha,h,k}$ for $\Gamma, \alpha, h:\cps{\Sigma}, k:(z: \cps{T}) \rarr \cps{C_1}$~.)

                By Lemma \ref{lem:cps:inv} with \lref{ty-body}, we have
                \begin{enumrm}[resume]
                    \item\llabel{ty-fun} $\jdty{\Gamma_{\alpha,h,k}}{\lambda y:\cps{T_y}. \cps{c}~\nmbullet~h~k}{\tau_1}$,
                ...
                By Lemma \ref{lem:cps:inv} with \lref{ty-fun}, we have
                \begin{enumrm}[resume]
                    \item\llabel{ty-fbody} $\jdty{\Gamma_{\alpha,h,k}, y:\cps{T_y}}{\cps{c}~\nmbullet~h~k}{\tau_6}$ and
                    \item\llabel{sub-fun} $\jdsub{\Gamma_{\alpha,h,k}}{(y:\cps{T_y}) \rarr \tau_6}{\tau_1}$~.
                \end{enumrm}
                By Lemma \ref{lem:cps:inv-c-app} with \lref{ty-fbody}, we have
                \begin{enumrm}[resume]
                    \item\llabel{ty-cpsc} $\jdty{\Gamma_{\alpha,h,k}, y:\cps{T_y}}{\cps{c}}{\tau_7}$,
                    \item\llabel{ty-h} $\jdty{\Gamma_{\alpha,h,k}, y:\cps{T_y}}{h}{\tau_8}$, and
                    \item\llabel{ty-k} $\jdty{\Gamma_{\alpha,h,k}, y:\cps{T_y}}{k}{\tau_9}$~.
                \end{enumrm}
                By Lemma \ref{lem:cps:inv}, we have
                \begin{enumrm}[resume]
                    \item\llabel{sub-h} $\jdsub{\Gamma_{\alpha,h,k}, y:\cps{T_y}}{\cps{\Sigma}}{\tau_8}$, and
                    \item\llabel{sub-k} $\jdsub{\Gamma_{\alpha,h,k}, y:\cps{T_y}}{(z: \cps{T}) \rarr \cps{C_1}}{\tau_9}$~.
                \end{enumrm}
                Then, by the second half of Lemma \ref{lem:cps:inv-c-app}, we have
                \begin{enumrm}[resume]
                    \item\llabel{sub-t7} $\jdsub{\Gamma_{\alpha,h,k}, y:\cps{T_y}}
                        {\tau_7}{\forall \beta. \cps{\Sigma} \rarr ((z: \cps{T}) \rarr \cps{C_1}) \rarr \tau_6}$
                \end{enumrm}
                where $\beta$ is fresh.
                
                On the other hand, by inversion of \lref{sub-cpssig}, we have
                \begin{itemize}
                ...
                By Lemma \ref{lem:cps:trans} with \lref{sub-fun} and \lref{sub-t1}, we have
                \begin{itemize}
                    \item $\jdsub{\Gamma_{\alpha,h,k}}
                    {(y:\cps{T_y}) \rarr \tau_6}{(y_{\op}:\cps{T_{\op 2}}[\rep{A/X}][\cps{v}/x]) \rarr \cps{C_{\op 1}}[\rep{A/X}][\cps{v}/x]}$~.
                \end{itemize}
                By inversion, we have
                \begin{enumrm}[resume]
                    \item $y = y_{\op}$,
                    \item\llabel{sub-cpsTop2} $\jdsub{\Gamma_{\alpha,h,k}}
                        {\cps{T_{\op 2}}[\rep{A/X}][\cps{v}/x]}{\cps{T_y}}$
                    \item\llabel{sub-t6} $\jdsub{\Gamma_{\alpha,h,k},y:\cps{T_{\op 2}}[\rep{A/X}][\cps{v}/x]}
                        {\tau_6}{\cps{C_{\op 1}}[\rep{A/X}][\cps{v}/x]}$~.
                \end{enumrm}

                Moreover, by Lemma \ref{lem:cps:rm-nonrfn} with \lref{ty-cpsv} and \lref{ty-cpsc}, we have
                \begin{itemize}
                    \item $\jdty{\Gamma, \alpha}{\cps{v}}{\tau_3}$ and
                    \item $\jdty{\Gamma, \alpha, y:\cps{T_y}}{\cps{c}}{\tau_7}$~.
                \end{itemize}
                By Lemma \ref{lem:cps:narrow} with \lref{sub-cpsTop2}, we have
                \begin{itemize}
                    \item $\jdty{\Gamma, \alpha, y:\cps{T_{\op 2}}[\rep{A/X}][\cps{v}/x]}{\cps{c}}{\tau_7}$~.
                \end{itemize}
                Then, by the IHs, we have
                \begin{enumrm}[resume]
                    \item\llabel{ty-v} $\jdty{\cpsinv{\Gamma}}{v}{T_v}$,
                    \item\llabel{ty-c} $\jdty{\cpsinv{\Gamma}, y:T_{\op 2}[\rep{A/X}][v/x]}{c}{C_0}$,
                    \item\llabel{sub-cpsTv} $\jdsub{\Gamma, \alpha}{\cps{T_v}}{\tau_3}$, and
                    \item\llabel{sub-cpsC0} $\jdsub{\Gamma, \alpha, y:\cps{T_{\op 2}}[\rep{A/X}][\cps{v}/x]}{\cps{C_0}}{\tau_7}$
                \end{enumrm}
                for some $T_v$ and $C_0$.
                By Lemma \ref{lem:cps:trans} with ``\lref{sub-t3} and \lref{sub-cpsTv}'', and
                ``\lref{sub-t7} and \lref{sub-cpsC0}'' respectively
                (using Lemma \ref{lem:cps:rm-nonrfn}), we have
                \begin{itemize}
                    \item $\jdsub{\Gamma, \alpha}{\cps{T_v}}{\cps{T_{\op 1}}[\rep{A/X}]}$ and
                    \item $\jdsub{\Gamma, \alpha, y:\cps{T_{\op 2}}[\rep{A/X}][\cps{v}/x]}{\cps{C_0}}{\forall \beta. \cps{\Sigma} \rarr ((z: \cps{T}) \rarr \cps{C_1}) \rarr \tau_6}$~.
                \end{itemize}
                By subsumption with \lref{sub-t6}, we have
                \begin{itemize}
                    \item $\jdsub{\Gamma, \alpha, y:\cps{T_{\op 2}}[\rep{A/X}][\cps{v}/x]}{\cps{C_0}}
                        {\forall \beta. \cps{\Sigma} \rarr ((z: \cps{T}) \rarr \cps{C_1}) \rarr \cps{C_{\op 1}}[\rep{A/X}][\cps{v}/x]}$~.
                \end{itemize}
                Then, by Lemma \ref{lem:cps:cpsinv-sub}, we have
                \begin{itemize}
                    \item $\jdsub{\cpsinv{\Gamma}}{T_v}{T_{\op 1}[\rep{A/X}]}$ and
                    \item $\jdsub{\cpsinv{\Gamma}, y:T_{\op 2}[\rep{A/X}][v/x]}{C_0}{\tycomp{\Sigma}{T}{\tyctl{z}{C_1}{C_{\op 1}[\rep{A/X}][v/x]}}}$~.
                \end{itemize}
                Thus, by \rulename{T-VSub} with \lref{ty-v} and \rulename{T-CSub} with \lref{ty-c} respectively, we have
                \begin{itemize}
                    \item $\jdty{\cpsinv{\Gamma}}{v}{T_{\op 1}[\rep{A/X}]}$ and
                    \item $\jdty{\cpsinv{\Gamma}, y:T_{\op 2}[\rep{A/X}][v/x]}{c}{\tycomp{\Sigma}{T}{\tyctl{z}{C_1}{C_{\op 1}[\rep{A/X}][v/x]}}}$~.
                \end{itemize}
                Therefore, by \rulename{T-Op}, we have
                \[
                    \jdty{\cpsinv{\Gamma}}{\expop{v}{y}{c}}{\tycomp{\Sigma}{T}{\tyctl{z}{C_1}{C_{\op 2}[\rep{A/X}][v/x]}}}~.
                \]

                On the other hand, by \rulename{Sc-Fun} with \lref{sub-cpsCop2}, we have
                \begin{itemize}
                    \item $\jdsub{\Gamma}
                        {\forall \alpha. \cps{\Sigma} \rarr ((z: \cps{T}) \rarr \cps{C_1}) \rarr \cps{C_{\op 2}}[\rep{A/X}][\cps{v}/x]}
                        {\forall \alpha. \cps{\Sigma} \rarr ((z: \cps{T}) \rarr \cps{C_1}) \rarr \tau'}$~.
                \end{itemize}
                ...
                that is,
                \[
                    \jdsub{\Gamma}{\cps{\tycomp{\Sigma}{T}{\tyctl{z}{C_1}{C_{\op 2}[\rep{A/X}][v/x]}}}}{\tau}~.
                \]
                Now we have the conclusion with $C = \tycomp{\Sigma}{T}{\tyctl{z}{C_1}{C_{\op 2}[\rep{A/X}][v/x]}}$~.
            \item[Case $c = \expwith{h}{c}$:]
