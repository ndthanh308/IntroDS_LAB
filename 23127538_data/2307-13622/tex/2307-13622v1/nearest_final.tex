...
$\omega$$^{b}$&deg&Argument of periapsis&$84.41_{-9.94}^{+9.36}$&$130.60_{-12.62}^{+9.53}$ & Uniform&0&2$\pi$\\
$I$&deg&Inclination&$98.73_{-11.46}^{+9.46}$&$166.48_{-6.66}^{+6.63}$ & CosI-Uniform&0&1\\
...
corresponding epochs with a similar periodicity. In previous studies where Gaussian process is not employed in RV modeling, high eccentricities have typically been estimated, such as $0.608\pm 0.041$\citep{hatzes00}, $0.25\pm0.23$
  ...
  $166.48_{-6.66}^{+6.63}$\deg. This is equivalent to an inclination of $13.52_{-6.63}^{+6.66}$\deg, which is calculated in the absence of knowledge regarding the longitude of the ascending node. This value
