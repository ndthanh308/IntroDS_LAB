...
\newcommand{\forgetfulness}{\emph{Forgetfulness}}
...
\author{Roi Cohen$^1$~~~~Eden Biran$^1$~~~~Ori Yoran$^1$~~~~Amir Globerson$^{1,2}$~~~~Mor Geva$^3$ \vspace{3pt}\\
$^1$Blavatnik School of Computer Science, Tel Aviv University\vspace{3pt}\\$^2$Google Research~~~$^3$Google DeepMind\\
\small{\texttt{\{roi1, edenbiran, oriy\}@mail.tau.ac.il, gamir@tauex.tau.ac.il, pipek@google.com}}\\
}
