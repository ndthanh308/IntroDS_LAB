...
As a consequence, we obtain the following identities for the geometric quantities:
			...
			\begin{lem}\label{kawalki}
				...
				LD acknowledges that this work is part of the project Graph Algebras partially supported by EU grant HORIZON-MSCA-SE-2021 Project 101086394 and
				was partially supported the University of Warsaw Thematic Research Programme "Quantum Symmetries".
				
				AS and PZ acknowledge that this work is supported by the Polish National Science Centre grant 2020/37/B/ST1/01540.				
