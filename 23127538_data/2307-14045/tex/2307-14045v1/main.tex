...
\begin{keyword}
Physics-Informed \sep Partial Differential Equation \sep  Deep Learning
\end{keyword}
...
\cite{Mao.2020, Jagtap.2020, Jagtap.2020}. 
...
which use artificial dissipation to approximately solve conservation laws. Recently, Coutinho~et~al.~\cite{Coutinho.2023}
have proposed multiple methods to locally or globally choose artificial viscosity values and demontrate the efficacy of
their method on different one dimensional systems.\par
...
dissipation later, we obtain non dissipative solutions while ensuring convergence during training. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
We choose a fully connected neural network of constant layer width with hyperbolic tangent activation functions.
...
Therefore, we continue to use standard hyperbolic tangent activations.\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
activations. The loss term weights are $\beta=1$ and $\gamma=5$. A detailed overview of training parameters is 
shown in \ref{tab:training_parameters_oblique}. Again, no additional data of the solution is incorporated into the loss, 
besides the boundary conditions and we are solving strictly the forward problem.\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
within a one degree neighborhood of the analytical solution. Fig.~\ref{fig:obliqueTrainHistory}~(a) shows how the 
...
thus higher than for the subsonic test case.
...
The hyperparameters are not optimized and higher accuracies may be possible when employing hyperparameter optimization 
e.g. on the network shape and learning rate. Compared to the subsonic problem \ref{sec:parametric_cylinder}, we see 
slightly increased errors but within the same order of magnitude. The bounds of the error are higher, mainly due to
...
\begin{table}
	...
	%\captionof{table}{Comparison of relative errors for different field variables.}
	\centering
	\caption{Comparison of relative errors for different field variables.}
	\label{tab:errors}
	\begin{tabular}{lcc}
		\hline
		...
		\makecell[c]{\textbf{\ref{sec:parametric_oblique}. Parametric Oblique}\\ 
			\textbf{Shock}} \\
		\hline
		$C_\mathrm{p}$& $(0.23\pm0.06)\%$ &  $(0.7\pm 0.7)\%$\\
		\hline
		$M$& $(1.0\pm0.1)\%$& $(1.3\pm 0.9)\%$\\
		\hline
		$\rho$ & $(0.33\pm0.06)\%$& $(0.62\pm 0.62)\%$\\
	\end{tabular}
\end{table} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusion}
...
supersonic test case with parametric Mach number. 
...
for data, clustered points or domain decomposition based the solution). Thus, the presented method may open up new 
...
tests indicate that this methodology is not sufficient to stabilize our analyzed problems on its own.\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The presented approach of parametric boundary conditions can, in theory, be extended to multiple parameters (e.g. 
...
This exact forward problem has been solved with PINNs in~\cite{Mao.2020} and cPINNs in \cite{Jagtap.2020}. 
...
\begin{center}
    \captionsetup{type=tabular}
    \captionof{table}{Summary of PINN parameters for flow around ellipse.}
    ...
    \begin{tabular}{lcc}
        ...
        \hline
        \rule[-1ex]{0pt}{2.5ex} activation  & $\tanh$ & $\tanh$ \\
        \hline
...
\begin{center}
	\captionsetup{type=tabular}
	\captionof{table}{Summary of PINN parameters for oblique shock problem.}
