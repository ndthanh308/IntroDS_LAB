...
We conduct a thorough evaluation of our mixed precision training routines using the Navier-Stokes and Darcy flow equations, resulting in up to a 58\% improvement in training throughput and a 50\% reduction in GPU memory usage with little or no reduction in accuracy.
...
\item We show that our final mixed-precision training routine substantially decreases memory usage (up to 50\%), with little or no reduction in accuracy, on the Navier-Stokes  and Darcy flow equations.
