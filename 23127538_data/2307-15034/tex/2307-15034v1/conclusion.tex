...
We show that with these modifications, running FNO in half precision results in up to a 34\% reduction in runtime and memory, with little to no decrease in accuracy, on the Navier Stokes and Darcy flow equations.
%
