...
%\author{Zihan Li\inst{1,2}, Yuan Zheng\inst{1}, Xiangde Luo\inst{3}, Dandan Shan\inst{1},  Qingqi Hong\inst{1,4*}}
...
\email{zhanli@uw.edu}
\affiliation{%
  \institution{Xiamen University, \\University of Washington}
  \city{Seattle}
  \country{USA}
  \postcode{98101}}
...
\affiliation{%
  \institution{Xiamen University, COCHE}
  \city{Xiamen}
  \country{China}
  \postcode{361005}}
...
\setlength{\abovecaptionskip}{0mm}
  ...
  \resizebox{0.98\columnwidth}{!}{%
    ...
    % CycleMix$_S$ & scribbles & .883 & .798 & .863 & .848 \\
...
\setlength{\abovecaptionskip}{0mm}
    ...
    \toprule
        ...
        %gatedCRF & 0.7226 & 0.8502 & 0.7864 \\ 
        %CPS.model1 & 0.7235 & 0.861 & 0.7923  \\ 
        %CPS.model2 & 0.7415 & 0.8527 & 0.7971  \\ 
...
\setlength{\abovecaptionskip}{0mm}
  ...
  {%
    ...
    % \midrule
    % multicolumn{1}{c|}{CycleMix$^+_S$}  & \multicolumn{1}{c|}{70 scribbles} & .880  & .825  & \multicolumn{1}{c|}{.860}  & .855 \\
    \bottomrule
    \end{tabular}%
    }}
  \label{sensitivity}%
