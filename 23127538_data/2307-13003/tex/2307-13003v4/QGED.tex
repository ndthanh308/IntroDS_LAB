...
Owing to the two keywords, \textit{Yang--Mills theory} and \textit{gravity}, we are afraid that one may recall, so-called, the \textit{double copy} method[13] inspired by the string theory.
