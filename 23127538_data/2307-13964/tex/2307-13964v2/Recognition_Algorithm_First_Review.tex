...
\subsection{Recognition of chordal C-I graphs}
	In this section, we design an algorithm for recognizing chordal C-I graphs. For this, we use the clique tree representation of a chordal graph.
