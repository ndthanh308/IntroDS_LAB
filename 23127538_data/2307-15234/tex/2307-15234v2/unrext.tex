...
One of our key local results is the relevant fundamental lemma, which states that, for a place $v$ of $F$,
\begin{align*}
...
our sets of double coset representatives, once we identify
$H_1(F) \bs G'(F) / H_2(F)$ with the
$\sigma$-conjugacy classes of $\GL_n(E)$. Our strategy
is to choose the representatives globally so that at all inert places 
...
in Zhang's work \cite{MR4250392} on the arithmetic fundamental lemma, and
in general by Zhang \cite{zhang2021maximal}.
Note that the properties we require of $\gamma$ and $\zeta$ 
in order to make this reduction are essentially the same as 
those in \cite[Lemma~8.8]{MR564478}.
...
There is also a refined version of the twisted GGP conjecture, formulated in \cite{MR4622393}.
