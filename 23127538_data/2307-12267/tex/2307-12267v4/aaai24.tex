...
\begin{itemize}
    ...
    \item \textbf{Degrading Effect}: If the authorship of $s_{i+k}$ is different from that of the existing sentences, $s_{i+k}$ is considered as noise because the prototype calculated based on hybrid content can represent neither AI content nor human-written content, i.e., quality of the prototype is degraded.
\end{itemize}  
