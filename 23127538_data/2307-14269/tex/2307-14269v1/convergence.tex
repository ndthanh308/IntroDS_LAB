...
In contrast, we note that the new Lobatto method has virtually the same accuracy as the methods of Gauss and Radau with regards to the state and control solutions.
