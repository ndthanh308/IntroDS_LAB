...
here is the presence of superfluous assumptions in the published
version of the theorem and how we discovered that fact just by using
\Coq for the formalization: we formulated Theorem 4.7 with our notion
...
%
However, once
the proof of Theorem 4.7 was given, its application for Lemma 4.8 did
no longer type-check, the simple reason being that \Coq had identified
unused assumptions in the proof of Theorem 4.7, which were hence no
