...
where relevant information can be found in this survey.
...
With these three stages, clear protocol and process definitions are established prior to conducting the review, limiting
possible reviewer bias and additionally enhancing reproducibility. The initial stage consists of planning the review,
which includes establishing the need for this certain review and developing the review protocol. The protocol
encompasses the inclusion and exclusion criteria, as well as research question definition, and the establishment of the
review process. Based on an established protocol we conduct the review, establish the selection of studies to evaluate,
and proceed to extract and analyze the studies. Lastly, with all collected data on selected studies, we format this
literature study to present the review in a comprehensible manner.
