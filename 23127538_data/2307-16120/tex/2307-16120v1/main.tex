...
\thanks{Submitted to the editors 2023-07-xx.
...
\hypersetup{
  ...
  pdfauthor={Qingping Zhou, Junqi Tang, Jinglai Li}
}
\fi
% \let\nofiles\relax  
...
First we report that five of the ten runs of the LPGD approach fail to converge within 20 epochs in both cases and as such we omit the results of the method
in the tables. 
...
dWe believe this approach is more helpful in cases where we have little training data. Besides LPGD and LPGD-MA methods, all other approaches yield higher-quality reconstructions in MSE when trained using more training data. 
