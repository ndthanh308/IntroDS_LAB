...
\title{ProtoFL: Unsupervised Federated Learning via Prototypical Distillation\vspace{-2.5ex}}
...
\affil[ ]{\small{\texttt{\{hans.kim,vivaan.yjkwak,william.shin\}@lab.kakaobank.com},
\texttt{\{yjk.kwak,changick\}@kaist.ac.kr}},
\texttt{minyoung.jung@keti.re.kr},
\texttt{y.kim@inha.ac.kr}}
\vspace{-3.5ex}
