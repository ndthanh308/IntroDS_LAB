...
\begin{align*}
    \text{number of outer while-loop} = \text{selection with 3 more bases} + \text{selections with 1 more bases}.
\end{align*}
...
\begin{align*}
    \mathbb{E}[\text{total number of selections}] = \text{number of outer while-loop} \times \mathbb{E}[\textup{number of selections}] \geq d^2 / 9.
\end{align*}
...
\textbf{Proof of Theorem~\ref{thm:initialization-method}.}
Consider the following two orthogonal decompositions of $\widehat{\bm{v}}_{\textup{soft}}$ in Algorithm~\ref{alg:initialization}, 
\begin{align*}
    & ~ \widehat{\bm{v}}_{\textup{soft}} = \alpha_{\textup{soft}} \bm{v}_* + \beta_{\textup{soft}} \bm{v}_{\bot}, & \alpha_{\textup{soft}}^2 + \beta_{\textup{soft}}^2 = 1, ~ \langle \bm{v}_*, ~\bm{v}_{\bot} \rangle = 0, ~ \|\bm{v}_*\|_2 = \|\bm{v}_{\bot}\|_2 = 1, \\
    & ~ \widehat{\bm{v}}_{\textup{soft}} = \alpha_{\textup{soft}}' \bm{v}_0 +  \beta_{\textup{soft}}' \bm{v}_{\bot}', & (\alpha_{\textup{soft}}')^2 + (\beta_{\textup{soft}}')^2 = 1, ~ \langle \bm{v}_0, ~\bm{v}_{\bot}' \rangle = 0, ~ \|\bm{v}_0\|_2 = \|\bm{v}_{\bot}'\|_2 = 1.
\end{align*}
...
\begin{align*}
    \langle \bm{v}_0, ~ \bm{v}_* \rangle = & ~ \frac{1}{\alpha_{\textup{soft}} \alpha_{\textup{soft}}'} \left( 1 - \alpha_{\textup{soft}} \beta_{\textup{soft}}' \langle \bm{v}_*, ~ \bm{v}_{\bot}' \rangle - \beta_{\textup{soft}} \alpha_{\textup{soft}}' \langle \bm{v}_{\bot}, ~ \bm{v}_{0}' \rangle - \beta_{\textup{soft}} \beta_{\textup{soft}}' \langle \bm{v}_{\bot}, ~ \bm{v}_{\bot}' \rangle \right) \\
    = & ~ \frac{1}{\alpha_{\textup{soft}} \alpha_{\textup{soft}}'} - \frac{\beta_{\textup{soft}}'}{\alpha_{\textup{soft}}'} \langle \bm{v}_*, ~ \bm{v}_{\bot}' \rangle - \frac{\beta_{\textup{soft}}}{\alpha_{\textup{soft}}} \langle \bm{v}_{\bot}, ~ \bm{v}_{0}' \rangle - \frac{\beta_{\textup{soft}} \beta_{\textup{soft}}'}{\alpha_{\textup{soft}} \alpha_{\textup{soft}}'} \langle \bm{v}_{\bot}, ~ \bm{v}_{\bot}' \rangle \\
...
\begin{align*}
    1 - \frac{\beta_{\textup{soft}}'}{\alpha_{\textup{soft}}'} - \frac{\beta_{\textup{soft}}}{\alpha_{\textup{soft}}} - \frac{\beta_{\textup{soft}} \beta_{\textup{soft}}'}{\alpha_{\textup{soft}} \alpha_{\textup{soft}}'} \geq & ~ 1 - 3 \frac{\beta_{\textup{soft}}}{\alpha_{\textup{soft}}} \geq 1 - 3 \frac{\sqrt{2 \textup{dis}_{\textup{soft}}(n) - \textup{dis}_{\textup{soft}}^2(n)}}{1 - \textup{dis}_{\textup{soft}}(n)} \geq c_{0}.
\end{align*}
