...
\begin{abstract}
We study a principal component analysis problem under the spiked Wishart model in which the structure in the signal is captured by a class of union-of-subspace models. This general class includes vanilla sparse PCA as well as its variants with graph sparsity.
...
%\gwcomment{TODO: Update notation for all $\bm{v}_*, \bm{v}_{\star}, \tau_*, \tau_{\star}, F^*, F^{\star}$.}
\end{abstract}
\end{center}

% The following is to import multiple files, each of which contains a section. Uncomment things
% accordingly. Alternatively, you can just use this file for everything.
...
\input{example-path-SPCA}

\input{example-tree-SPCA}

\input{discussion}

\small
\subsection*{Acknowledgments}
GW was supported by the National University of Singapore under AcRF Tier-1 grant (A-
8000607-00-00) 22-5539-A0001. ML and AP were supported in part by the NSF under grants CCF-2107455 and DMS-2210734 and by research awards/gifts from Adobe, Amazon, and Mathworks. We are grateful to the Simons Institute for the Theory of Computing for their hospitality, where part of this work was performed. We thank Enric Boix-Adsera, Matthew Brennan, and Guy Bresler for helpful discussions. 


\bibliographystyle{abbrvnat}
\bibliography{reference-template}

% If you have an appendix, uncomment below
\normalsize
\appendix
