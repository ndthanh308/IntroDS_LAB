...
\end{equation}
 ...
 Although there is an inconsistency between the noise models used for training and testing, this discrepancy is not significant as long as we adhere to the signal-dependency property, which allows for optimal or near-optimal solutions.
