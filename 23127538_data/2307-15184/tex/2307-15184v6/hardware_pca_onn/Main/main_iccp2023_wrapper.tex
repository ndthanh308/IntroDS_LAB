\newcommand{\homedir}{..}
\makeatletter
\def\input@path{{\homedir/stys_2023/}}
\makeatother
...
\author{Paper ID \paperID\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem This paper is under review for ICCP 2023 and the PAMI special issue on computational photography. Do not distribute.}}
\markboth{Anonymous ICCP 2023 submission ID \paperID}%
{}
\fi
...
file'' for ICCP 2023 submissions produced under
