...
\noisy{\B{y}} = \B{Mx} + \B{\epsilon},
 ...
 where $\B{\epsilon} \sim \AGN(\B{0}, \sigma^2\B{I})$, and $\sigma$ is the standard deviation. The other noise model is Poisson noise or shot noise, which arises from the statistical nature of photons \cite{boyat2015review}. The measurement equation for this noise model is:
\begin{equation}
