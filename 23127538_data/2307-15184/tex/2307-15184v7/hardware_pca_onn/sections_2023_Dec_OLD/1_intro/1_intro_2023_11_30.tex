...
{In this project, we use the popular single pixel camera design to analyze and design effective coding models under Poisson noise. Similar to the conclusion of Cossairt et al., Harwid et. al., and Swift et. al., and Willett et. al. we find that general prior free  coding provides no benefit over a trivial raster scanning approach using a diagonal matrix $\B{M}$ \YLnote{\cite{cossairt2012does, harwit1979hadamard, swift1976hadamard, willet2009CSPoisson, scotte2022photon_noise, wuttig2005optimal, schumann2002SNR_poisson, larson1974hadamard_poisson, streeter2009optical_poisson}}.
