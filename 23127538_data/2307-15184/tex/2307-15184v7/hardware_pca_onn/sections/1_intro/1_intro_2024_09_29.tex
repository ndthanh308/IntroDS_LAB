...
For instance, although single-pixel cameras with random masks provide performance advantages under AGN, but do not offer improvements over a simple sequential scan when dealing with  Poisson noise \cite{harwit1979hadamard, swift1976hadamard, willet2009CSPoisson, scotte2022photon_noise, vanden2019various}.
