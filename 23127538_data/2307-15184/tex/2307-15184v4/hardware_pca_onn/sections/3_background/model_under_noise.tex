...
{This project investigates two noise models. The first one is the AGN \Xpolish{or read noise}{related to dark current or read noise from imperfect sensor materials}, which mainly originates from thermal vibrations of atoms at sensors. In this noise model, Eq. \ref{eqn:NoiselessMeasurement} becomes:
\Xequa{
