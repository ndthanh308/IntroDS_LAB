...
\section{Introduction}\label{sec:1_intro}
\input{\homedir/sections/1_intro}


\section{Related Work}
\label{sec:2_related}
\input{\homedir/sections/2_related}

% \section{Single-Pixel Image Formation Model}
\section{Background}
\label{sec:3_background}
\input{\homedir/sections/3_background}

\section{Methods}
\label{sec:4_methods}
\input{\homedir/sections/4_methods}


\section{Results}
% \label{sec:5_results}
\input{\homedir/sections/5_results}

\section{Discussion and Limitations}
\label{sec:6_discussion}
\input{\homedir/sections/6_discussion}
...
%% BIOGRAPHY
% \input{\homedir/sections/biography}
