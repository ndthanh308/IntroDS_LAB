...
\begin{proof}[Proof of \cref{lem:comm-protocol}]
	...
	During a recursive iteration, they first write $\ms$ in the form
		...
		In one execution of the protocol, there are at most $\log r$-many 0's and at most $O\left(\frac{- \log |S|}{\log(1-\delta)}\right) = O(\frac{r}{\delta} \log(\Delta+1))$-many 1's from the recursive process,
