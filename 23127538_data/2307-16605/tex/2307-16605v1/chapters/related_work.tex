...
By introducing a text-shape paired dataset based on ShapeNet~\citep{ShapeNet15} that includes chair and table categories, \citet{2019text2shape} pioneered another line of single-category text-conditioned shape generation.
...
SJC~\citep{sjc22} and ProlificDreamer~\citep{ProlificDreamer23} achieve astonishing generation results by optimizing the distillation loss function of diffusion.