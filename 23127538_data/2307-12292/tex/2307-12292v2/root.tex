...
\AddToShipoutPictureBG*{%
  \AtPageUpperLeft{%
    ...
    \put(-9.5,-9){\makebox(\paperwidth,0)[c]{\parbox{0.9\textwidth}{2023 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS), pp. 800-806}}}
  }
}
...
\AddToShipoutPictureBG*{%
  \AtPageUpperLeft{%
    \setlength{\unitlength}{1mm}%
    \put(-9.5,-14){\makebox(\paperwidth,0)[c]{\parbox{0.9\textwidth}{DOI: \href{https://ieeexplore.ieee.org/document/10342440}{10.1109/IROS55552.2023.10342440}}}}
  }
}
