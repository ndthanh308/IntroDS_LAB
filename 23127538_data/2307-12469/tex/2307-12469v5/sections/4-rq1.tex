...
For gpt-4-0613, temperature 2.0 results were incomplete due to the services' slow response time in extreme temperature settings~\cite{fuzz-drvier-study-website}.
% \footnote{OpenAI and Azure gpt-4-0613 API frequently raise timeout for requests with high temperature setting. Temperature 2.0 results will be updated at~\cite{fuzz-drvier-study-website} once completed.}.
