...
%%% by Cen Zhang, Yaowen Zheng, Mingqiang Bai, Yeting Li, Wei Ma, Xiaofei Xie, Yuekang Li, Limin Sun, and Yang Liu.
%%%
% \setcopyright{rightsretained}
% \acmDOI{10.1145/3650212.3680355}
% \acmYear{2024}
% \copyrightyear{2024}
...
% \acmSubmissionID{issta24main-p791-p}
% \received{2024-04-12}
...
\authornote{Yaowen Zheng is the corresponding author.}
% \email{%
% yaowen.zheng@ntu.edu.sg
% }

\author{Mingqiang Bai}
\orcid{0009-0002-9197-2069}
\affiliation{%
\institution{IIE, CAS; Sch of Cyber Security, UCAS}
\city{Beijing}
\country{China}
}
% \email{%
% baimingqiang22@mails.ucas.ac.cn
% }
...
\input{sections/4-rq1}
\input{sections/5-rq2}
\input{sections/6-rq3}
\input{sections/7-rq4}
\input{sections/8-discussion}
\input{sections/9-related-work}
\input{sections/10-conclusion}
% \input{sections/10-appendix}
% \input{sections/full-results-table}
