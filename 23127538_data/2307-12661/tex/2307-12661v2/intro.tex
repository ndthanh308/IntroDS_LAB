...
Nonlinear systems arise in a vast plethora of engineering applications ranging from classical mechanics through mathematical finance and are one of the key driving engines behind the success of today's popular optimization algorithms. A nonlinear system is described by an ordinary differential equation
\begin{equation}
