...
$\infty_+$, $\infty_-$, are in $C(\Q_p)$. Recall that for each $i\geq 0$,
we denote
$\omega_i\colonequals \frac{x^idx}{y}$; then  $\omega_0,\ldots,\omega_{g-1}$ form a  basis of
...
$\alpha=\sum_{0\leq i< 2g}f_{0,i}\eta_i+dv$ and Lemma~\ref{L:psi} implies
