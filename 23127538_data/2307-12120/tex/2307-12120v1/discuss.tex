...
\begin{itemize}
	...
	\item {\bf Efficiently Recognizable:} There is a QPT procedure ${\sf Recog}$ which recognizes elements in $\Xs_\lambda$. That is, ${\sf Recog}(1^\lambda,\cdot)$ projects onto the span of the states in $\Xs_\rangle$.
