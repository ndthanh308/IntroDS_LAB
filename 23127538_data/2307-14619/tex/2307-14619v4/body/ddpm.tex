...
% \end{remark}
Critically, the guarantee of the quality of our DDPM is not in TV, but rather an optimal transport distance tailored to the problem at hand.  As discussed in \Cref{rem:eps_0}, it is precisely this weaker guarantee that makes the problem challenging.
