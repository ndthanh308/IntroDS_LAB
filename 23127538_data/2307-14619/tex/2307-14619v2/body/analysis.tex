...
Our analysis abstracts away the vector-valued dynamics into a deterministic MDP -- the \bfemph{composite MDP} -- with \bfemph{composite-states} $\seqs \in \cS$ and \bfemph{composite-actions} $\seqa \in \cA$, with dynamics
\begin{align}
