...
% \textbf{Date:}                                                 &     Tue, 24 Jan 2023     & \textbf{  Prob (F-statistic):} &  1.07e-88   \\
% \textbf{Time:}                                                 &         12:09:16         & \textbf{  Log-Likelihood:    } &   -1356.6   \\
\textbf{No. Observations:}                                     &            1112          & \\%\textbf{  AIC:               } &     2733.   \\
% \textbf{Df Residuals:}                                         &            1102          & \textbf{  BIC:               } &     2783.   \\
...
\end{tabular}
% \begin{tabular}{lclc}
% \textbf{Omnibus:}       & 92.017 & \textbf{  Durbin-Watson:     } &    1.978  \\
% \textbf{Prob(Omnibus):} &  0.000 & \textbf{  Jarque-Bera (JB):  } &  141.557  \\
% \textbf{Skew:}          &  0.618 & \textbf{  Prob(JB):          } & 1.82e-31  \\
% \textbf{Kurtosis:}      &  4.236 & \textbf{  Cond. No.          } &     3.26  \\
% \bottomrule
% \end{tabular}
