...
% \textbf{Time:}                                               &      12:09:16      & \textbf{  Log-Likelihood:    } &   -27073.   \\
\textbf{No. Observations:}                                   &        31692       & \\%\textbf{  AIC:               } & 5.417e+04   \\
% \textbf{Df Residuals:}                                       &        31681       & \textbf{  BIC:               } & 5.426e+04   \\
...
\end{tabular}
% \begin{tabular}{lclc}
% \textbf{Omnibus:}       & 2423.765 & \textbf{  Durbin-Watson:     } &    2.009  \\
% \textbf{Prob(Omnibus):} &   0.000  & \textbf{  Jarque-Bera (JB):  } & 3012.584  \\
% \textbf{Skew:}          &   0.739  & \textbf{  Prob(JB):          } &     0.00  \\
% \textbf{Kurtosis:}      &   3.309  & \textbf{  Cond. No.          } &     5.96  \\
% \bottomrule
% \end{tabular}
