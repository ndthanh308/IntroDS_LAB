...
{To reduce the dimensionality of the covariance matrix $\sigma_{\phi}^2$ and simplify its optimization, a diagnoal matirx~\citep{dalca2019unsupervised} or a sum of a diagnoal and a low rank matrices~\citep{grzech2020image, grzech2022variational} are used.}
