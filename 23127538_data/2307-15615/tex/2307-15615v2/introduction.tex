...
Then in the testing phase, the trained network is directly applied to each image pair with fixed network weights, resulting in a significant speedup compared to traditional methods.
Initially, ResNet-like network architectures~\citep{he2016deep}, which consist of a convolutional encoder and a multilayer perceptron~\citep{wu2013unsupervised, miao2016cnn}, were explored.
