...
Given the promising results GANs have demonstrated in image translation, i.e., synthesizing one image modality into another, researchers have made efforts to leverage their capabilities in addressing multi-modal image registration.
...
To date, only \citet{kim2022diffusemorph} have used a diffusion model in medical image registration.
