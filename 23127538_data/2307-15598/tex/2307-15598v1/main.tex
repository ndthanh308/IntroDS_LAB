...
This work elucidates how heterogeneous environments influence the balance between quantum mechanical proton transfer and excited electron dynamics. 
...
Non-equilibrium dynamics of electrons in response to external stimuli can be studied by simulating the time evolution of the quantum state with a time-dependent perturbation in the system’s Hamiltonian.\cite{goings2018real,li2020real,shepard2021simulating,kononov2022electron}
In the last few decades, the real-time propagation approach to time-dependent density functional theory (RT-TDDFT) has gained popularity as a particularly practical computational methodology for investigating nonlinear electronic responses in complex matter because of the appealing balance between accuracy and efficiency. 
RT-TDDFT simulations have been increasingly employed to address various scientific questions associated with non-equilibrium electronic dynamical phenomena.\cite{tateyama2006real,li2007ab,yao2019k,yost2019first,shepard2023electronic}
At the same time, the nuclear electronic orbital (NEO) method developed by Hammes-Schiffer and co-workers has emerged as an appealing computational method for treating atomic nuclei quantum mechanically in various electronic structure methods.\cite{webb2002multiconfigurational,chakraborty2008development,chakraborty2008inclusion}
Recently, the NEO method has been combined with RT-TDDFT simulations (RT-NEO-TDDFT) for studying the coupled quantum dynamics of protons and electrons in molecular systems.\cite{zhao2020real,zhao2020nuclear,zhao2021excited,li2022semiclassical,li2023electronic}
This RT-NEO-TDDFT method is formally based on the multicomponent DFT formalism,\cite{capitani1982non,kreibich2001multicomponent,pavošević2020multicomponent} and it does not rely on the usual Born-Oppenheimer approximation between electrons and protons. 

In recent work, we extended the NEO method for periodic electronic structure calculations.\cite{xu2022nuclear}
Herein, we integrate this formulation with our periodic RT-TDDFT implementation\cite{hekele2021all} for studying the non-Born-Oppenheimer, nuclear-electronic quantum dynamics of extended systems.
...
This electron-proton correlation (EPC) is important for accurately describing several proton properties such as the proton densities and zero-point energy in previous works.\cite{pavošević2020multicomponent,tao2021analytical} 
Technical implementation details of the periodic RT-NEO-TDDFT implementation in the all-electron FHI-aims code\cite{blum2009ab} are available in the Supplemental Material.
Using the newly developed periodic RT-NEO-TDDFT method, we elucidate the competing kinetics between excited electron dynamics and quantum mechanical proton transfer in heterogeneous environments.
...
Our RT-NEO-TDDFT simulations employ the PBE\cite{perdew1996generalized} generalized-gradient approximation to the exchange-correlation (XC) functional with the Tier 2 numeric atom-centered orbitals (NAO)\cite{blum2009ab} basis set for modeling electrons. The protons were modeled with the Hartree-Fock approximation and an sp Gaussian-type basis with the fixed proton basis function center method, following Ref. \cite{zhao2020real}.
The epc17-2 electron-proton correlation functional\cite{yang2017development,brorsen2017multicomponent}, which was developed based on an extension of the Colle-Salvetti formulation, was used for approximating the EPC. 
Additional computational details are provided in the Supplemental Material.
...
The transferring proton in the oHBA molecule and the nearest protons of the surrounding H$_2$O molecules that are hydrogen-bonded to the two oxygen atoms of the oHBA molecule were quantized. 
...
When solvated by the water molecules, the quantum proton does not reach as close to the accepting oxygen as in vacuum, possibly because the proton momentum is damped by the surrounding water molecules.
...
In addition, no proton transfer between water molecules and the oHBA molecule was observed. 
...
Upon adsorption onto the semiconductor surface, the HOMO and LUMO states of the oHBA molecule hybridize with the electronic states of the semiconductor surface.
...
The results are compared to those for the molecule in vacuum (shown with open circles). 
...
With the presence of the linker group, however, the probability amplitudes show different behavior. 
...
This work is supported by the Center for Hybrid Approaches in Solar Energy to Liquid Fuels, CHASE, an Energy Innovation Hub funded by the U.S. Department of Energy, Office of Basic Energy Sciences, Office of Science, under award number DE-SC0021173. This research used resources of the National Energy Research
Scientific Computing Center, a DOE Office of Science User Facility
supported by the Office of Science of the U.S. Department of Energy
under Contract No. DE-AC02-05CH11231 using NERSC award BES-ERCAP0024831.
\end{acknowledgments}
...
\bibitem [{\citenamefont {Li}\ and\ \citenamefont {Tully}(2007)}]{li2007ab}%
  ...
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Chemical physics
...
\bibitem [{\citenamefont {Yost}\ \emph {et~al.}(2019)\citenamefont {Yost},
  \citenamefont {Yao},\ and\ \citenamefont {Kanai}}]{yost2019first}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {D.~C.}\ \bibnamefont
  {Yost}}, \bibinfo {author} {\bibfnamefont {Y.}~\bibnamefont {Yao}},\ and\
  \bibinfo {author} {\bibfnamefont {Y.}~\bibnamefont {Kanai}},\ }\href@noop {}
  {\bibfield  {journal} {\bibinfo  {journal} {J. Phys. Chem. Lett.}\ }\textbf
  {\bibinfo {volume} {11}},\ \bibinfo {pages} {229} (\bibinfo {year}
  {2019})}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Chakraborty}\ \emph
  {et~al.}(2008{\natexlab{a}})\citenamefont {Chakraborty}, \citenamefont
  {Pak},\ and\ \citenamefont {Hammes-Schiffer}}]{chakraborty2008development}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {A.}~\bibnamefont
  ...
  {pages} {153001} (\bibinfo {year} {2008}{\natexlab{a}})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Chakraborty}\ \emph
  {et~al.}(2008{\natexlab{b}})\citenamefont {Chakraborty}, \citenamefont
  {Pak},\ and\ \citenamefont {Hammes-Schiffer}}]{chakraborty2008inclusion}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {A.}~\bibnamefont
  {Chakraborty}}, \bibinfo {author} {\bibfnamefont {M.~V.}\ \bibnamefont
  {Pak}},\ and\ \bibinfo {author} {\bibfnamefont {S.}~\bibnamefont
  ...
  {pages} {014101} (\bibinfo {year} {2008}{\natexlab{b}})}\BibitemShut
  {NoStop}%
...
\bibitem [{\citenamefont {Li}\ \emph {et~al.}(2022)\citenamefont {Li},
  \citenamefont {Tao},\ and\ \citenamefont
...
\bibitem [{\citenamefont {Li}\ and\ \citenamefont
  ...
  {Hammes-Schiffer}},\ }\href {https://doi.org/10.1063/5.0142007} {\bibfield
  {journal} {\bibinfo  {journal} {J. Chem. Phys.}\ }\textbf {\bibinfo {volume}
  {158}} (\bibinfo {year} {2023})},\ \bibinfo {note} {114118}\BibitemShut
  {NoStop}%
...
\bibitem [{\citenamefont {Pavosevic}\ \emph {et~al.}(2020)\citenamefont
  ...
  {Hammes-Schiffer}}]{pavošević2020multicomponent}%
  \BibitemOpen
