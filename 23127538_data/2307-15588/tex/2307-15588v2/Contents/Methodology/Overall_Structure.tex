...
Note that one of our crucial designs is \emph{all sub-aperture information is fed into each stage}, which allows our network to consider all the sub-aperture images {throughout the entire process effectively}. The pyramidal features $f_1, f_2, f_3, f_4$ are obtained via the four-stage encoder in a dimension of $\{64,128,320,512\}$. Afterward, the multi-stage features are further fed into MLP Decoder~\cite{xie2021segformer} for final prediction.
