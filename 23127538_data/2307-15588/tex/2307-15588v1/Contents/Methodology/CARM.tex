...
To eliminate information asymmetry, the CARM is a crucial design to achieve rectification of spatial and angular features and meanwhile rearrange the feature captured by different viewpoints. As shown in Fig.~\ref{fig:Rectification}, two features from different transformer blocks are fed into CARM, which includes Horizontal Operation and Vertical Operation. Since Horizontal Operation and Vertical Operation are symmetric, only Horizontal Operation is introduced in detail. 
%
