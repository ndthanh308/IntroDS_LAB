...
ChatGPT's performance is measured with zero-shot pass-rate (\textit{pass@1}), which measures whether the model produces a correct solution (i.e., passes all the test cases) on the first attempt.
