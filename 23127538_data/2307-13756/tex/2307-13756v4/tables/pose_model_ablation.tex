...
\resizebox{0.9\linewidth}{!}{ 
    ...
    \toprule
        ...
        \midrule
        % $\checkmark$& $\checkmark$ & 4 &\textbf{0.24}  & \textbf{0.46}  & \textbf{88.8\%}  & \textbf{76.5\%}   &   \textbf{42.5\%} &  \textbf{4.41}  & 17.41  &  \textbf{87.5\%}  &   \textbf{83.8\% } &  \textbf{78.7\%}\\
        
        % % $\checkmark$& $\checkmark$ & 4 & $\checkmark$& \textbf{0.24}  & \textbf{0.46}  & 88.3\%  &  76.4\% &  \textbf{43.4\%} & \textbf{4.36}  & 18.64  &  86.7\%  &  \textbf{83.9\%}  &  \textbf{78.8\%} \\
        
        %   & $\checkmark$ & 4 & 0.27 & 0.50 & 87.4\% & 71.8\% & 36.9\% & 5.24  &  17.9 &  85.8\%&  80.3\%&  73.1\% \\
        % $\checkmark$&  & 4 &  0.25 & 0.47 & 88.0\% & 75.1\% & 41.2\% & 4.62  & \textbf{17.40} & 87.2\%  & 83.6\% & 78.3\% \\
        % $\checkmark$& $\checkmark$ & 1 &  0.29 & 0.52 & 86.3\% & 70.2 \% & 34.6 \% & 5.51  & 20.24  &  82.5\% & 76.3\% & 69.0\% \\
       ...
       $\checkmark$& 1 & 4 &  \textbf{0.39}  & \textbf{0.86}  & \textbf{77.6\%}  & \textbf{58.5\%}   &  \textbf{24.3\%} & \textbf{2.60}  & \textbf{21.19}  &  \textbf{84.6\%} &  \textbf{81.2\%}  & \textbf{78.2\%} \\
        % $\checkmark$& $\checkmark$ & 4 & $\checkmark$& \textbf{0.38}  & \textbf{0.85}  & \textbf{78.3\%}  &  \textbf{60.1\%}  &  \textbf{26.0\%} & \textbf{2.43}  & \textbf{20.33}  &  \textbf{85.2\%}  &  \textbf{82.2\%}  &  \textbf{79.8\%}  \\
