...
\par
Finally, the interaction length is increased due to the double-pass configuration and can enable the miniaturization of the sensor by reducing the optical temperature and its associated spin-exchange relaxation. 
\par
This work opens the door for a simple and robust sub-pT portable sensor in Earth field\,\cite{patentHE}. 
\begin{acknowledgments}
We would like to thank Yonathan Japha and Tetyana Kuzmenko for their useful discussions. This work is funded in part by the Israeli Science Foundation Grant Nos 1314/19, 3515/20, and by the Israel Innovation Authority Grant No. 74482.
\end{acknowledgments}
