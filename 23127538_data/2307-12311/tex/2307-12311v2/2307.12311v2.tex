...
In \cite{Chen1}, Chen asked that whether there are infinitely many odd (resp. even) numbers in the sequence $\{R_m\}_{m=1}^{\infty}$. He called it a basic problem on Ruzsa's number. To end up this note, we make the following conjecture which seems to be of interest.
