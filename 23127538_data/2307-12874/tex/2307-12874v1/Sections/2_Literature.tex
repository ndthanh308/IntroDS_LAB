...
The overall security and vulnerability of blockchain systems are studied in various literature such as \cite{chen2020survey, li2020survey, guo2022survey, zamani2020security, Urien2021}. Homoliak et al. \cite{homoliak2018air} analyze attacks on crypto-wallet applications and propose defense mechanisms to limit wallet vulnerabilities. The study suggests the implementation of air-gapped hardware wallet solutions as a defense mechanism.

Bui et al. \cite{bui2019pitfalls} focus on wallet attack scenarios and defense mechanisms on the server side, specifically addressing man-in-the-middle attacks. Phishing attacks, another type of wallet attack, are discussed in another study with proposed prevention mechanisms \cite{andryukhin2019phishing}. Chen et al. \cite{chen2020survey} focus on the vulnerabilities, attacks, and security mechanisms on the Ethereum blockchain. This study contributes to existing literature by highlighting vulnerabilities and attacks on each blockchain layer with a number of wallet attacks addressed in the application layer.

\input{Exhibits/1.1.5_GapsInLiterature-Table-1.tex}
