...
We consider perturbations on the static, spherically symmetric background in the following form
\begin{equation}
    \begin{aligned}
        g_{\mu\nu}(v,z,\theta)&=g_{\mu\nu}^{(0)}(z)+\delta g_{\mu\nu}(v,z,\theta),\\
