...
application of the Cauchy-Schwarz inequality for
...
$\frac{1}{2}\, \left( \varphi_\re^\truc(\cdot,s) +
  \varphi_\re^\truc(\cdot,s^*) \right)$ in this inner product satisfies, for all $s_0 \in \Sset$,
\begin{equation*}
...
\end{equation*}
Hence, it is an element of~$H$, which proves that the real evaluation
