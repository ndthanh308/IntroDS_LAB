...
\ifpdf
\hypersetup{
  pdftitle={Rational kernel-based interpolation for complex-valued frequency response functions},
  pdfauthor={N. Georg, J. Bect, U. Römer and S. Schöps}
}
\fi
...
kernel (see, e.g.,~\cite{rasmussen:2006:gpml, sollich:2004:using}),
also called \emph{generalized inverse multiquadric} kernel (see,
e.g.,~\cite{hu:1998:collocation, bozzini:2013:generalized}).
