...
%%Research highlights
%\begin{highlights}
%\item Establish asymptotically unbiased parameter inference for highly degenerate SDEs
% 
%\item Model class we consider includes a notable case of generalised Langevin equations 
% 
%\item Develop a discretisation scheme that is applicable in general observations regime
% 
%\item Numerical study shows unbiased estimation under partial observations regime 
%\end{highlights}
...
\end{aligned}
\end{align} 
where $U : \mathbb{R} \to \mathbb{R}$, $\gamma > 0$ and $\sigma > 0$. We write $x = (q, p) \in \mathbb{R}^2$ and $\theta = (\gamma, \sigma) \in \Theta$. We have: 
% 
\begin{align*}
...
\inf_{(\Delta, x, \theta) \in (0, \infty) \times \mathbb{R}^N \times \Theta} 
