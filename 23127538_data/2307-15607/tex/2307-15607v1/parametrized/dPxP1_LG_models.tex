...
\[
  x + y + a_1 x^{-1} y^{-1} + z + a_2 z^{-1}
\]
(see Subsubsection~\ref{subsubsection:dP_09}). It is a parametrized Minkowski polynomial \textnumero5 (see~\cite[Appendix~B: bucket~10]{akhtar2012minkowski}). After the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
    0 & 0 & 1 \\
    0 & 1 & 0 \\
...
\]
It coincides with the Laurent polynomial from Subsection~\ref{subsection:02-34} after the specialization \(a_i = 1\).

\subsubsection{Family \textnumero3.27}\label{subsubsection:dPxP1_03-27}

The toric Landau--Ginzburg model for this family is given by the Laurent polynomial
\[
  x + a_1 x^{-1} + y + a_2 y^{-1} + z + a_3 z^{-1}.
\]
(see Subsubsection~\ref{subsubsection:dP_quadric}). It is a parametrized Minkowski polynomial \textnumero31 (see~\cite[Appendix~B: bucket~45]{akhtar2012minkowski}). After the specialization \(a_i = 1\) it coincides with the Laurent polynomial from Subsection~\ref{subsection:03-27}.

\subsubsection{Family \textnumero3.28}\label{subsubsection:dPxP1_03-28}

The toric Landau--Ginzburg model for this family is given by the Laurent polynomial
\[
  x + y + a_1 x^{-1} y^{-1} + a_1 a_2 x^{-1} + z + a_3 z^{-1}.
\]
(see Subsubsection~\ref{subsubsection:dP_08}). It is a parametrized Minkowski polynomial \textnumero30 (see~\cite[Appendix~B: bucket~28]{akhtar2012minkowski}). After the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
...
we obtain the Laurent polynomial
\begin{gather*}
  (a_1 a_2) x + y + z + a_1 x z^{-1} + a_3 y^{-1} + x^{-1}.
\end{gather*}
After the specialization \(a_i = 1\) it coincides with the Laurent polynomial from Subsection~\ref{subsection:03-28}.

\subsubsection{Family \textnumero4.11}\label{subsubsection:dPxP1_04-11}

The toric Landau--Ginzburg model for this family is given by the Laurent polynomial
\[
  x + y + a_1 x^{-1} y^{-1} + a_1 a_2 x^{-1} + a_1 a_3 y^{-1} + z + a_4 z^{-1}.
\]
(see Subsubsection~\ref{subsubsection:dP_07}). It is a parametrized Minkowski polynomial \textnumero85 (see~\cite[Appendix~B: bucket~48]{akhtar2012minkowski}).  After the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
...
\end{gather*}
After the specialization \(a_i = 1\) it coincides with the Laurent polynomial from Subsection~\ref{subsection:04-11}.
...
\[
  ...
  z + a_5^{-1}.
\]
(see Subsubsection~\ref{subsubsection:dP_06}). It is a parametrized Minkowski polynomial \textnumero219 (see~\cite[Appendix~B: bucket~76]{akhtar2012minkowski}). After the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
...
we obtain the Laurent polynomial
\[
  x + (a_1 a_2) y + z + a_1 y z^{-1} + a_4 y^{-1} z + (a_1 a_3) z^{-1} +
  y^{-1} + a_5 x^{-1}.
\]
After the specialization \(a_i = 1\) it coincides with the Laurent polynomial from Subsection~\ref{subsection:05-03}.
...
\]
(see Subsubsection~\ref{subsubsection:dP_05}). It is a parametrized Minkowski polynomial \textnumero357 from~\cite[Appendix~B: bucket~107]{akhtar2012minkowski}. Let us apply the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
  ...
  \end{pmatrix},
\]  
to obtain the Laurent polynomial
\[
...
\[
  ...
  \begin{pmatrix}
    ...
    0 & 1 & -1
  \end{pmatrix}, \quad
  f = x (a_4 y + 1) (a_1 a_2 a_5 + y) + y^2, \quad
  N =
  \begin{pmatrix}
    -1 & 1 & -1 \\
    0 & 1 & 0 \\
  ...
  \end{pmatrix},
\]
to obtain the parametrized Minkowski polynomial \textnumero1353 from~\cite[Appendix~B: bucket~107]{akhtar2012minkowski}:
\begin{gather*}
...
\[
  ...
  \begin{pmatrix}
    ...
    -1 & 0 & 1
  \end{pmatrix}, \quad
  f = (a_4 x y + 1) (a_1 a_2 a_5 + x y), \quad
  N =
  \begin{pmatrix}
    1 & 1 & 0 \\
    -1 & 0 & 0 \\
  ...
  \end{pmatrix},
\]
to obtain the parametrized Minkowski polynomial \textnumero1231 from~\cite[Appendix~B: bucket~107]{akhtar2012minkowski}:
\begin{gather*}
...
\[
  ...
  \end{pmatrix},
\]
to obtain the parametrized Minkowski polynomial \textnumero284 from~\cite[Appendix~B: bucket~107]{akhtar2012minkowski}:
\begin{gather*}
...
Finally, after the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
...
\end{gather*}
After the specialization \(a_i = 1\) it coincides with the Laurent polynomial from Subsection~\ref{subsection:06-01}.
...
\end{gather*}
(see Subsubsection~\ref{subsubsection:dP_04}). It is a parametrized Minkowski polynomial \textnumero506 (see~\cite[Appendix~B: bucket~136]{akhtar2012minkowski}). After the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
...
\end{gather*}
After the specialization \(a_i = 1\) it coincides with the Laurent polynomial from Subsection~\ref{subsection:07-01}.
...
\end{gather*}
(see Subsubsection~\ref{subsubsection:dP_03}). It is a parametrized Minkowski polynomial \textnumero769 (see~\cite[Appendix~B: bucket~155]{akhtar2012minkowski}). After the monomial change of variables
\[
  (x, y, z) \mapsto (x, y, z)^M, \quad
  M =
  \begin{pmatrix}
...
\end{gather*}
After the specialization \(a_i = 1\) it coincides with the Laurent polynomial from Subsection~\ref{subsection:08-01}.
