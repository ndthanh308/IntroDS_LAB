\subsection{Family \textnumero4.10}\label{subsection:04-10}

The pencil \(\mathcal{S}\) is defined by the equation
\begin{gather*}
  X^{2} Y Z + X Y^{2} Z + X Y Z^{2} + Y^{2} Z T + X Y T^{2} + X Z T^{2} + Y Z T^{2} = \lambda X Y Z T.
\end{gather*}
...
\begin{gather*}
  ...
  \end{pmatrix} \cdot
  \begin{pmatrix}
    [C_{1}] & [C_{3}] & [C_{5}] & [C_{6}] & [H_{\mathcal{S}}]
  \end{pmatrix}^T.
\end{gather*}
