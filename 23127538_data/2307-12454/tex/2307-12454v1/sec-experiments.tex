%% Since our programming language is a sublanguage of Haskell,  
...
%\HT{The full code is available in 
%from \cite{githubUB}.}   



First, we define the domain $D$ as a Haskell data type: % as follows.
%
\begin{verbatim}
...
that phase.
%% the Phase I denotational semantics.  
...
with the speed of computation of each digit ($-1$ and $1$) be controlled.  
Then, apply it to \verb|gtos| and then to \verb|ed| to obtain expected results. % :   
