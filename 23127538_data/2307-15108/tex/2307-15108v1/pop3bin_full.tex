...
\citep[e.g.,][hereafter
H16]{Omukai:2002aa,McKee:2008aa,Hosokawa:2011aa,Hosokawa:2016aa}.
...
waves (e.g., \citealp{Kinugawa:2014aa,Hartwig:2016aa,Abbott:2016aa}, but
see also \citealp{Belczynski:2017aa}) or the first X-ray binaries, which
is important heating sources of the intergalactic medium and should be
constrained by future 21cm line observations
...
extensions]{Sadanari:2021aa,Sadanari:2023vd,Kimura:2023vu}.
...
the radiation to avoid artificial enhancement of radiative feedback. The
radiation transfer model is described in the next section.
...
\citep[see][]{Kimura:2023vu}, are valuable in addressing this matter.
...
binary orbits is $r_{12}=2\times10^3-2\times10^4\,\mr{au}$ at the end of
...
the circum-binary disk (Figs.~\ref{fig:evolution_faceon_2d}, center) and
around the member stars circum-stellar disks are formed.  Eventually,
...
central region, as seen in Section~\ref{sec:reason}.  At the same time,
numerous low-mass stars may persist after being ejected from the center.
Whether or not such stars exist or remain in the system anyway would
hardly affect the evolution of massive protostars.  Nevertheless, their
formation and survival are of substantial interest from observational
perspectives as current observations have already ruled out the cases
where excessive number of low-mass stars survive until the present
\citep{Hartwig:2015ac, Ishiyama:2016aa}.
...
underway \citep[see][]{Kimura:2023vu}.  Nevertheless, we expect our
...
with current gravitational wave detectors if they merge \citep[see,
e.g.,][]{Kinugawa:2014aa}.  While a wide-orbit multiple-star system
predominantly forms in each cloud, inheriting the large angular momentum
of the parent cloud, our simulations also suggest that mini-binaries
embedded in such a wide system may have a separation short enough
($\lesssim 1\,\mr{au}$) for the remnant BHs to merge within the age of
the present Universe. In any case, we need to treat explicitly by
resolving such close binaries to clarify the origin of gravitational
wave events.
...
\bibitem[{{Kimura} {et~al.}(2023){Kimura}, {Hosokawa}, {Sugimura}, \&
  {Fukushima}}]{Kimura:2023vu}
{Kimura}, K., {Hosokawa}, T., {Sugimura}, K., \& {Fukushima}, H. 2023, arXiv
  e-prints, arXiv:2303.12100
