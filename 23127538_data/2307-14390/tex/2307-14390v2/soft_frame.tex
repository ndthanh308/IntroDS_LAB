...
\title{Soft $g$-frames in soft Hilbert spaces} % Sets article title
\author{Sayyed Mehrab Ramezani \\ Department of Mathematics, Yasouj University, Yasouj, Iran.\\
m.ramezani@yu.ac.ir} % Sets authors name
% The preamble ends with the command \begin{document}
\begin{document} % All begin commands must be paired with an end command somewhere
    \maketitle % creates title using information in preamble (title, author)
