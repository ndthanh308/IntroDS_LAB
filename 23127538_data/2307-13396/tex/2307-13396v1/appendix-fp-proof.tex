...
It was recently shown in \cite{banerjee2022fast} that the winning region $\We$ for \Even in an \Odd-fair parity game $\mathcal{G}^\ell$ with least even upperbound priority $l\geq 0$ can be computed by the fixed-point algorithm 
% 
...
\begin{proposition}
    Given an \Odd-fair parity game $\mathcal{G}^\ell = (\ltup{V, \Ve, \Vo, E, \chi}, E^\ell)$ with least even upperbound $l\geq 0$ and
