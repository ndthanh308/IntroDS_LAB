...
\title{\boldmath General relativistic 
bubble growth in cosmological 
phase transitions }
...
\begin{equation}
    E_b = \int_0^{R_w}  4\pi e_s R^2 dR = \frac{t}{3}\Omega_F(\xi_w)\xi_w,
\end{equation}
where $e_s$ is the homogeneous and isotropic energy density of the outer FLRW Universe. 
