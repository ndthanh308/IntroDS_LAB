...
In this section we will be focus on  $I(C_k\times K_n)$, and for this we will need the homotopy type of the independence complex of various graphs,
such as $P_k\times K_n$ (Theorem \ref{homopkkn}). 

The case $C_5\times K_2$ allows us to find a counterexample showing that the homotopy type 
...
In this section we will prove one of the main results of the paper, Theorem \ref{teomod3}, which tells us the homotopy type of the 
...
\end{itemize}
Then the union $st((1,1,1))\cap SC((1,1,1))$ archive the hypothesis of Proposition \ref{homocolimpegadoesferas}. Now 
